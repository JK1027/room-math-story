var SPREADSHEET_ID = "1mfpPXwYO4XP3pJbwWAcV8EinFRwdHEA0huNXVaCUFAI";

function doGet(e) {
  var unit = (e && e.parameter && e.parameter.unit) || "m3_01";
...
function initSheets() {
  var ss = SpreadsheetApp.openById(SPREADSHEET_ID);
  var units = ["m3_01", "m3_02", "m3_03", "m3_04", "m3_05", "m3_06", "m3_07"];
