...
from src.serializers.game_serializer import GameSerializer
from scripts.config import paths

class GameBuilder(Builder):
    """
    [Game TemplateRenderer] chapterXX.md 도메인을 직렬화하여
    apps/templates/game.html 공통 템플릿에 GAME_DATA JSON을 바인딩 렌더링하는 
    프로젝트 유일 게임 컴파일러입니다.
    """
    ...
    def build(self, chapter: Chapter, grade_str: str, unit_code: str) -> bool:
        ...
        # 1. 단일 공통 템플릿 로드
        template_path = paths.APPS_DIR / "templates" / "game.html"
