...
qs = [
    {'qnum': 1, "options": ["닮음", "합동", "대칭", "닮음비"], 'title': '닮음의 문양 계측', 'story': '[붉은-여왕]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 거울 나라의 성문이 잠겼습니다. 한 도형을 축소 또는 확대해서 다른 도형과 완벽히 포개질 때의 기하학적 관계 명칭을 해독 장치에 입력해 작동시키세요.\\"', 'qtext': '<strong>Q1.</strong> 한 도형을 일정한 비율로 확대하거나 축소한 도형이 다른 도형과 합동이 될 때, 두 도형은 서로 ( ? )인 관계에 있다고 한다.', 'placeholder': '두 글자 입력', 'error': '틀렸습니다. 대칭과 축소의 기본 관계 단어입니다.', 'ans_check': "ans === '닮음'"},
    {'qnum': 2, "options": ["닮음", "합동", "대칭", "닮음비"], 'title': '축소의 배율', 'story': '[붉은-여왕]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 해독 광선이 우리의 원래 크기와 축소된 장난감 크기 사이의 대응하는 선분의 길이의 비율을 파악하려 합니다. 이 비율의 이름을 무엇이라 합니까?\\"', 'qtext': '<strong>Q2.</strong> 서로 닮은 두 평면도형에서 대응하는 선분의 길이의 비를 무엇이라 하는가?', 'placeholder': '세 글자 입력', 'error': '틀렸습니다. 닮음인 두 도형의 선분 길이의 비입니다.', 'ans_check': "ans === '닮음비'"},
    {'qnum': 3, "options": ["O", "X"], 'title': '원형 거울의 굴절', 'story': '[붉은-여왕]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 거울 성 벽면의 크고 작은 원형 거울들은 크기와 상관없이 항상 완벽하게 형태가 닮아 있는 도형입니까? O 또는 X로 입력해 답하세요.\\"', 'qtext': '<strong>Q3.</strong> 두 원은 항상 닮은 도형인가? ( O / X )', 'placeholder': 'O 또는 X 입력', 'error': '틀렸습니다. 모든 원은 중심에서 테두리까지 비율이 균일합니다.', 'ans_check': "ans === 'O' || ans === '오'"},
    ...
    {'qnum': 5, "options": ["O", "X"], 'title': '체스판 타일의 닮음', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[앨리스-Q]: \\"치지직... 들리십니까...? 붉은-여왕의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q5.</strong> 모든 정사각형은 항상 서로 닮은 도형인가? ( O / X )', 'placeholder': 'O 또는 X 입력', 'error': '틀렸습니다. 정사각형은 네 변의 길이가 같고 네 각이 90도로 고정되어 있습니다.', 'ans_check': "ans === 'O' || ans === '오'"},
    {'qnum': 6, "options": ["SSS", "SAS", "AA", "ASA"], 'title': '세 변의 닮음 조건', 'story': '[붉은-여왕]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 제 2구역: 잃어버린 각도입니다. 거울 톱니바퀴의 세 쌍의 변의 길이 비율이 동일함을 사용해 닮음을 확정 짓는 삼각형 닮음 조건 기호(영문 3글자)를 입력하세요.\\"', 'qtext': '<strong>Q6.</strong> 삼각형의 세 쌍의 대응하는 변의 길이의 비가 같을 때의 닮음 조건을 쓰시오. (기호로)', 'placeholder': '영문 세 글자 입력 (예: SSS)', 'error': '기호가 올바르지 않습니다. Side-Side-Side의 약자입니다.', 'ans_check': "ans === 'SSS'"},
    {'qnum': 7, "options": ["SSS", "SAS", "AA", "ASA"], 'title': '변과 사잇각의 조건', 'story': '[붉은-여왕]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 두 변의 길이비가 일정하고 그 사이에 위치하는 끼인각의 크기가 같을 때 성립하는 삼각형 닮음 판정 기호(영문 3글자)를 입력하여 락을 푸십시오.\\"', 'qtext': '<strong>Q7.</strong> 삼각형의 두 쌍의 대응하는 변의 길이의 비가 같고, 그 끼인각의 크기가 같을 때의 닮음 조건을 쓰시오.', 'placeholder': '영문 세 글자 입력 (예: SAS)', 'error': '기호가 올바르지 않습니다. Side-Angle-Side의 약자입니다.', 'ans_check': "ans === 'SAS'"},
    {'qnum': 8, "options": ["SSS", "SAS", "AA", "ASA"], 'title': '두 각의 닮음 조건', 'story': '[붉은-여왕]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 길이를 알 필요 없이 오직 두 모퉁이 각도가 서로 같으면 성립하는 가장 유용하고 보편적인 닮음 조건 기호(영문 2글자)를 타이핑하세요.\\"', 'qtext': '<strong>Q8.</strong> 삼각형의 두 쌍의 대응하는 각의 크기가 같을 때의 닮음 조건을 쓰시오.', 'placeholder': '영문 두 글자 입력 (예: AA)', 'error': '기호가 올바르지 않습니다. Angle-Angle의 약자입니다.', 'ans_check': "ans === 'AA'"},
    {'qnum': 9, "options": ["SSS", "SAS", "AA", "ASA"], 'title': '정삼각형의 정합비', 'story': '[붉은-여왕]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 한 각이 60도인 두 정삼각형은 무조건 어떤 닮음 조건에 의해 닮음이 성립되는지 한글을 포함해 정확히 입력창에 전송하세요.\\"', 'qtext': '<strong>Q9.</strong> 한 각이 60도인 두 정삼각형은 무조건 어떤 닮음 조건에 의해 닮음인가?', 'placeholder': '예: AA닮음', 'error': '조건이 틀렸습니다. 세 각의 크기가 모두 60도로 동일하게 되는 성질을 생각하세요.', 'ans_check': "ans === 'AA' || ans === 'AA닮음'"},
