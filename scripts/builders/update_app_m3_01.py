...
qs = [
    ...
    {'qnum': 10, 'title': '스테이지 10', 'story': '🚨 <strong>[비상 경보: 강제 자폭 시스템 작동]</strong> 🚨<br><br>[이단자-X]: \\"더는 참을 수 없군! 모든 데이터를 자폭 폭파하겠다! 5분 내로 전부 잿더미로 만들어주지!\\"<br><br>[피타고라스-P]: \\"경고! 시스템 온도 상승 중! 제가 방화벽을 전개할 동안 긴급 수치 입력을 끝내십시오!\\"', 'qtext': '<strong>Q10.</strong> 수직선 위에서 2와 √5 중 더 우측에 있는 수를 쓰시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '√5'", 'hint': '자연수를 제곱근 기호를 씌운 형태로 바꾸어 두 제곱근 수치의 근호 안 크기를 대조하여 수직선 우측(큰 수)을 선별하게 합니다.'},
    ...
    {'qnum': 20, 'title': '스테이지 20', 'story': '🔮 <strong>[최종 방화벽 락다운 해제]</strong> 🔮<br><br>[피타고라스-P]: \\"제 모든 에너지를 출구 개방에 전념하겠습니다. 당신이라면 저 장벽을 해독해 낼 것입니다. 마지막 답을 입력하세요!\\"<br><br>[이단자-X]: \\"안 돼... 내 제어권이... 소멸한다아아!\\"', 'qtext': '<strong>Q20.</strong> \\frac{√3}{√2} + \\frac{√2}{√3} 을 계산하여 분모를 유리화한 값을 구하시오. (예: 5√6/6)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '5√6/6'", 'hint': '통분을 진행할 때 두 분모의 곱으로 분모를 단일화하고 분자를 각각 곱해 더한 후 최종적으로 분모를 유리화하도록 가이드합니다.'}
]
