...
qs = [
    {'qnum': 1, "options": ["±3", "±3 아님", "알 수 없음", "해 없음"], 'title': '스테이지 1', 'story': '[이단자-X]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q1.</strong> 9의 제곱근을 구하시오. (단, 답이 2개인 경우 ± 기호를 사용해 나타내시오. 예: ±3)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '±3' || ans === '+-3' || ans === '3,-3' || ans === '-3,3'", 'hint': '어떤 수 x를 제곱하여 a가 될 때, x를 a의 제곱근이라고 합니다. 양수의 제곱근은 항상 양과 음의 부호를 모두 가져야 함을 주지시킵니다.'},
    {'qnum': 2, "options": ["4", "6", "2", "8"], 'title': '스테이지 2', 'story': '[이단자-X]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q2.</strong> √16의 값을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '4'", 'hint': '주어진 수가 어떤 자연수의 제곱수인지 파악하여 근호(√)를 벗겨내도록 유도합니다.'},
    {'qnum': 3, "options": ["10", "3", "7", "5"], 'title': '스테이지 3', 'story': '[이단자-X]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q3.</strong> 제곱근 25의 값을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '5'", 'hint': '제곱근 a는 양의 제곱근인 √a만을 가리킨다는 개념상의 차이를 상기시킵니다.'},
    {'qnum': 4, "options": ["6", "1", "3", "5"], 'title': '스테이지 4', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[피타고라스-P]: \\"치지직... 들리십니까...? 이단자-X의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q4.</strong> (-3)²의 제곱근 중 양수인 것을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '3'", 'hint': '거듭제곱 식을 먼저 계산한 뒤, 얻어지는 양수 값의 두 제곱근 중 플러스 부호를 가진 것을 찾도록 안내합니다.'},
    ...
    {'qnum': 6, "options": ["√3", "√3 아님", "알 수 없음", "해 없음"], 'title': '스테이지 6', 'story': '[이단자-X]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q6.</strong> 두 실수 √2와 √3 중 더 큰 수를 쓰시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '√3'", 'hint': '근호 안의 숫자가 클수록 실제 값도 큽니다. 두 수의 크기를 비교해 봅니다.'},
    {'qnum': 7, "options": ["4", "2", "0", "10"], 'title': '스테이지 7', 'story': '[이단자-X]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q7.</strong> √5의 정수 부분을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '2'", 'hint': '주어진 루트 값이 어떤 연속하는 두 자연수 사이에 존재하는지 파악하여 정수 부분을 추출하도록 합니다.'},
    {'qnum': 8, "options": ["√5-2", "√5-2 아님", "알 수 없음", "해 없음"], 'title': '스테이지 8', 'story': '[이단자-X]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q8.</strong> √5의 소수 부분을 구하시오. (루트 기호를 사용하여 식으로 나타내시오. 예: √5-2)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '√5-2'", 'hint': '무리수의 소수 부분은 전체 무리수 식에서 그 정수 부분을 뺀 수식으로 구성됨을 원리로 설명합니다.'},
    {'qnum': 9, "options": ["10", "3", "7", "5"], 'title': '스테이지 9', 'story': '[이단자-X]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q9.</strong> √12를 a√b 꼴로 나타낼 때, 자연수 a, b에 대하여 a+b의 값을 구하시오. (단, b는 가장 작은 자연수)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '5'", 'hint': '근호 안의 수치를 소인수분해하여 제곱인 인수를 찾아 근호 밖으로 꺼내는 a√b 형태의 변형을 안내합니다.'},
    {'qnum': 10, "options": ["√5", "√5 아님", "알 수 없음", "해 없음"], 'title': '스테이지 10', 'story': '🚨 <strong>[비상 경보: 강제 자폭 시스템 작동]</strong> 🚨<br><br>[이단자-X]: \\"더는 참을 수 없군! 모든 데이터를 시스템을 포맷하겠다! 5분 내로 전부 초기화 시켜주지!\\"<br><br>[피타고라스-P]: \\"경고! 시스템 온도 상승 중! 제가 방화벽을 전개할 동안 긴급 수치 입력을 끝내십시오!\\"', 'qtext': '<strong>Q10.</strong> 수직선 위에서 2와 √5 중 더 우측에 있는 수를 쓰시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '√5'", 'hint': '자연수를 제곱근 기호를 씌운 형태로 바꾸어 두 제곱근 수치의 근호 안 크기를 대조하여 수직선 우측(큰 수)을 선별하게 합니다.', "extra_class": "glitch-bg"},
    {'qnum': 11, "options": ["√15", "√15 아님", "알 수 없음", "해 없음"], 'title': '스테이지 11', 'story': '[피타고라스-P]: \\"방어막 출력 한계 도달 중! 코드를 지속적으로 갱신해야 폭발을 유예할 수 있습니다! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q11.</strong> √3 × √5 의 값을 구하시오. (식으로 표현하시오. 예: √15)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '√15'", 'hint': '근호가 있는 식의 곱셈은 근호 안의 숫자끼리 곱하여 하나의 근호 속에 넣고 정리하게 합니다.'},
