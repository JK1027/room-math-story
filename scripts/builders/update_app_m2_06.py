...
qs = [
    {'qnum': 1, "options": ["이등변삼각형", "이등변삼각형 아님", "알 수 없음", "해 없음"], 'title': '설계도의 기본 뼈대', 'story': '[도굴꾼-G]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 가장 먼저 임호텝의 설계도 기초를 분석해야 합니다. 두 기둥의 길이가 같은 기초적인 삼각 골조의 이름을 규정하여 암호 다이얼을 정렬하세요.\\"', 'qtext': '<strong>Q1.</strong> 두 변의 길이가 같은 삼각형을 무엇이라 하는가?', 'placeholder': '이등변삼각형 입력', 'error': '삼각형의 명칭이 올바르지 않습니다.', 'ans_check': "ans === '이등변삼각형'"},
    {'qnum': 2, "options": ["밑각", "밑각 아님", "알 수 없음", "해 없음"], 'title': '대칭의 각도', 'story': '[도굴꾼-G]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 삼각형의 기단이 대칭 균형을 잡기 위해선 두 변이 만나는 밑부분의 두 각의 크기가 완벽히 같아야 합니다. 빈칸에 들어갈 알맞은 말을 구하십시오.\\"', 'qtext': '<strong>Q2.</strong> 이등변삼각형의 두 ( ? )의 크기는 같다.', 'placeholder': '두 글자 입력', 'error': '틀렸습니다. 밑변에 접하는 두 각의 이름입니다.', 'ans_check': "ans === '밑각'"},
    {'qnum': 3, "options": ["70", "72", "140", "68"], 'title': '기단의 경사각 계산', 'story': '[도굴꾼-G]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 설계도의 꼭대기 각인 꼭지각이 40도로 계측되었습니다. 양쪽 대칭 경사면의 하단 각도가 몇 도여야 완벽한 평형이 맞을까요?\\"', 'qtext': '<strong>Q3.</strong> 꼭지각이 40도인 이등변삼각형의 한 밑각의 크기를 구하시오.', 'placeholder': "단위 생략하고 숫자만 또는 '70도' 형태로 입력", 'error': '틀렸습니다. 삼각형 내각의 합(180도)과 꼭지각의 차를 2로 나누어보세요.', 'ans_check': "ans === '70' || ans === '70도'"},
    {'qnum': 4, "options": ["RHS", "RHA", "SSS", "SAS", "ASA"], 'title': '직각 기둥의 대칭 조건', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[임호텝-H]: \\"치지직... 들리십니까...? 도굴꾼-G의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q4.</strong> 직각삼각형의 합동 조건 두 가지를 영어 기호로 쓰시오. (예: RHS, RHA)', 'placeholder': '예: RHS, RHA', 'error': '합동 조건 기호가 올바르지 않습니다. (RHS, RHA 확인)', 'ans_check': "ans.includes('RHS') && ans.includes('RHA')"},
    {'qnum': 5, "options": ["RHS", "RHA", "SSS", "SAS", "ASA"], 'title': '예각의 합동 판정', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[임호텝-H]: \\"치지직... 들리십니까...? 도굴꾼-G의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q5.</strong> 빗변의 길이와 한 예각의 크기가 같은 두 직각삼각형은 서로 합동이다. 이 조건을 무엇이라 하는가?', 'placeholder': '알파벳 기호 입력', 'error': '틀렸습니다. R...?', 'ans_check': "ans.includes('RHA')"},
    {'qnum': 6, "options": ["외심", "내심", "무게중심", "수심"], 'title': '세 꼭짓점의 외접원', 'story': '[도굴꾼-G]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 제 2구역: 신성한 중심점입니다. 세 꼭짓점을 모두 관통하여 감싸 안는 외접원의 핵심 동력원인 중심 명칭을 규명해야 다음 구역의 문이 열립니다.\\"', 'qtext': '<strong>Q6.</strong> 삼각형의 세 꼭짓점을 지나는 원을 외접원이라 하고, 그 중심을 무엇이라 하는가?', 'placeholder': '두 글자 입력', 'error': '올바른 명칭이 아닙니다. 바깥쪽 원의 중심입니다.', 'ans_check': "ans === '외심'"},
    ...
    {'qnum': 9, "options": ["외심", "내심", "무게중심", "수심"], 'title': '세 내각의 분할점', 'story': '[도굴꾼-G]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 내부 방들의 세 모퉁이 각도를 정확하게 반씩 쪼개어 모은 중심점을 찾아 설계도 파편을 회수해야 합니다.\\"', 'qtext': '<strong>Q9.</strong> 삼각형의 세 내각의 이등분선이 만나는 점을 무엇이라 하는가?', 'placeholder': '두 글자 입력', 'error': '틀렸습니다. 안쪽 원의 중심입니다.', 'ans_check': "ans === '내심'"},
    ...
    {'qnum': 11, "options": ["평행사변형", "평행사변형 아님", "알 수 없음", "해 없음"], 'title': '평행 회랑의 정의', 'story': '[임호텝-H]: \\"방어막 출력 한계 도달 중! 코드를 지속적으로 갱신해야 폭발을 유예할 수 있습니다! 제 3구역: 대칭의 돌림판입니다. 마주 보는 두 쌍의 변이 나란히 영원히 만나지 않고 뻗어 나가는 기본 사각형의 종류를 입력해 락을 해제하세요.\\"', 'qtext': '<strong>Q11.</strong> 마주 보는 두 쌍의 대변이 각각 평행한 사각형을 무엇이라 하는가?', 'placeholder': '다섯 글자 입력', 'error': '올바른 명칭이 아닙니다.', 'ans_check': "ans === '평행사변형'"},
    ...
    {'qnum': 19, "options": ["O", "X"], 'title': '수직 교차의 법칙', 'story': '[도굴꾼-G]: \\"아직 끝나지 않았다! 내 최고의 방해 암호를 해독해 보아라! 마름모틀을 관통하는 대각선 축들의 교차가 직각을 이루는지 판별하십시오. 직교 법칙이 맞으면 알파벳 대문자 O, 아니면 X를 전송하세요.\\"', 'qtext': '<strong>Q19.</strong> 마름모의 두 대각선은 서로 수직으로 만난다. ( O / X )', 'placeholder': 'O 또는 X 입력', 'error': '틀렸습니다. 마름모 대각선의 직교 성질을 생각해 보세요.', 'ans_check': "ans === 'O' || ans === '오' || ans === 'TRUE'"},
