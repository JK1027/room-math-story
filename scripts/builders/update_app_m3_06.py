...
qs = [
    {'qnum': 1, 'title': '스테이지 1', 'story': '[원탁의 기사 마네킹 랜슬롯-M]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q1.</strong> 원의 중심에서 현에 내린 수선은 그 현을 어떻게 하는가? (세 글자 한글로 쓰시오. 예: 이등분)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '이등분'", 'hint': '원의 중심에서 현에 그은 수선은 그 현을 똑같은 두 부분으로 쪼개는 성질을 네 글자 한글로 대답하게 합니다.'},
    {'qnum': 2, 'title': '스테이지 2', 'story': '[원탁의 기사 마네킹 랜슬롯-M]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q2.</strong> 원 O 의 반지름의 길이가 5 이고, 원의 중심에서 현 AB 까지의 거리가 3 일 때, 현 AB 의 길이를 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '8'", 'hint': '직각삼각형 피타고라스 정리를 이용해 현의 절반 길이를 구한 뒤, 현 전체 길이는 그 절반의 2배임을 이용하도록 가이드합니다.'},
    {'qnum': 3, 'title': '스테이지 3', 'story': '[원탁의 기사 마네킹 랜슬롯-M]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q3.</strong> 한 원에서 중심으로부터 같은 거리에 있는 두 현의 길이는 서로 어떠한가? (두 글자 한글로 쓰시오. 예: 같다)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '같다'", 'hint': '한 원에서 중심으로부터 거리가 동일한 두 현의 길이는 동일합니다.'},
    {'qnum': 4, 'title': '스테이지 4', 'story': '[원탁의 기사 마네킹 랜슬롯-M]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q4.</strong> 원 O 에서 현 AB 의 길이가 6 이고 현 CD 의 길이도 6 이다. 원의 중심에서 현 AB 까지의 거리가 4 일 때, 중심에서 현 CD 까지의 거리를 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '4'", 'hint': '중심에서 두 현까지의 거리가 같으면 두 현의 길이도 서로 같음을 이용하게 합니다.'},
    {'qnum': 5, 'title': '스테이지 5', 'story': '[원탁의 기사 마네킹 랜슬롯-M]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q5.</strong> 원 O 의 중심에서 현 AB 에 내린 수선의 발을 M 이라 할 때, 선분 AM 의 길이가 5 이다. 현 AB 의 길이를 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '10'", 'hint': '중심에서 내린 수선은 현을 수직이등분하므로, 전체 현의 길이는 절반에 해당하는 선분 길이의 2배임을 이용합니다.'},
    {'qnum': 6, 'title': '스테이지 6', 'story': '[원탁의 기사 마네킹 랜슬롯-M]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q6.</strong> 원 밖의 한 점에서 그 원에 그은 두 접선의 길이는 서로 어떠한가? (두 글자 한글로 쓰시오. 예: 같다)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '같다'", 'hint': '원 밖의 한 점에서 원에 그은 두 접선의 길이는 접점까지 동일한 거리를 가집니다.'},
    {'qnum': 7, 'title': '스테이지 7', 'story': '[원탁의 기사 마네킹 랜슬롯-M]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q7.</strong> 원 O 의 반지름의 길이가 6 이고, 원 밖의 한 점 P 에서 원에 그은 접선 PT 의 접점 T 에 대하여 선분 OP 의 길이가 10 일 때, 접선의 길이 PT 를 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '8'", 'hint': '접선과 반지름이 만나는 점의 각도는 직각(90도)이므로 피타고라스 정리를 이용해 접선의 길이를 구하도록 유도합니다.'},
    {'qnum': 8, 'title': '스테이지 8', 'story': '[원탁의 기사 마네킹 랜슬롯-M]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q8.</strong> 원 밖의 점 P 에서 두 접점 A, B 에 접선을 그어 형성된 각 ∠ APB = 50° 일 때, 사각형 AOBP 의 내부각 ∠ AOB 의 크기(도)를 구하시오. (숫자만 적으시오.)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '130'", 'hint': '접선과 반지름이 만나는 두 각(각각 90도)을 제외한 사각형 두 대각의 크기의 합이 180도임을 활용해 문제를 풀게 합니다.'},
    {'qnum': 9, 'title': '스테이지 9', 'story': '[원탁의 기사 마네킹 랜슬롯-M]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q9.</strong> 원에 외접하는 사각형의 마주 보는 두 쌍의 대변의 길이의 합은 서로 어떠한가? (두 글자 한글로 쓰시오. 예: 같다)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '같다'", 'hint': '외접사각형의 마주 보는 두 대변의 길이의 합이 서로 같다는 성질을 적용하게 안내합니다.'},
    {'qnum': 10, 'title': '스테이지 10', 'story': '[원탁의 기사 마네킹 랜슬롯-M]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q10.</strong> 한 호에 대한 원주각의 크기는 그 호에 대한 중심각의 크기의 몇 배인가? (슬래시를 사용해 분수로 쓰시오. 예: 1/2)', 'placeholder': '수식 입력 (예: 1/2 또는 8:27=10:x)', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '1/2' || ans === '0.5'", 'hint': '동일한 호에 대한 원주각의 크기는 항상 그 호의 중심각의 절반(1/2)입니다.'},
    {'qnum': 11, 'title': '스테이지 11', 'story': '[원탁의 기사 마네킹 랜슬롯-M]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q11.</strong> 한 호에 대한 원주각들의 크기는 위치에 관계없이 모두 어떠한가? (두 글자 한글로 쓰시오. 예: 같다)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '같다'", 'hint': '한 호에 대한 원주각들의 크기는 원둘레 위의 위치가 어디든지 관계없이 모두 크기가 같습니다.'},
    {'qnum': 12, 'title': '스테이지 12', 'story': '[원탁의 기사 마네킹 랜슬롯-M]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q12.</strong> 반원(지름)에 대한 원주각의 크기(도)는 몇 도인가?', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '90'", 'hint': '반원에 대한 원주각(지름의 두 끝점과 원 위의 한 점이 이루는 각)은 항상 직각(90도)입니다.'},
    {'qnum': 13, 'title': '스테이지 13', 'story': '[원탁의 기사 마네킹 랜슬롯-M]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q13.</strong> 원 O 에서 호 AB 에 대한 중심각의 크기가 80° 일 때, 원주각 ∠ APB 의 크기(도)를 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '40'", 'hint': '동일 호에 대한 원주각은 그 호의 중심각 크기의 절반임을 이용해 나눗셈 연산을 하도록 지도합니다.'},
    {'qnum': 14, 'title': '스테이지 14', 'story': '[원탁의 기사 마네킹 랜슬롯-M]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q14.</strong> 원 O 에서 한 호에 대한 원주각의 크기가 35° 일 때, 동일한 호에 대한 중심각의 크기(도)를 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '70'", 'hint': '동일 호에 대한 중심각은 그 호의 원주각 크기의 2배임을 활용해 곱셈하도록 가이드합니다.'},
    {'qnum': 15, 'title': '스테이지 15', 'story': '[원탁의 기사 마네킹 랜슬롯-M]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q15.</strong> 지름 AB 를 지나는 원주각 ∠ ACB 가 형성되어 있는 원 O 에서, ∠ A = 50° 일 때, 각 ∠ B 의 크기(도)를 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '40'", 'hint': '반원(지름)에 대한 원주각이 직각(90도)이 됨을 이용해, 직각삼각형 내부각의 덧뺄셈으로 구하도록 안내합니다.'},
    {'qnum': 16, 'title': '스테이지 16', 'story': '[원탁의 기사 마네킹 랜슬롯-M]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q16.</strong> 원에 내접하는 사각형에서 한 쌍의 대각의 크기의 합은 몇 도인가?', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '180'", 'hint': '원에 내접하는 사각형의 성질 중, 서로 마주 보는 두 대각의 합이 180도임을 설명합니다.'},
    {'qnum': 17, 'title': '스테이지 17', 'story': '[원탁의 기사 마네킹 랜슬롯-M]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q17.</strong> 원에 내접하는 사각형 ABCD 에서 각 ∠ A = 75° 일 때, 마주 보는 대각 ∠ C 의 크기(도)를 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '105'", 'hint': '내접하는 사각형의 마주 보는 두 대각의 합이 180도임을 활용해 뺄셈합니다.'},
    {'qnum': 18, 'title': '스테이지 18', 'story': '[원탁의 기사 마네킹 랜슬롯-M]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q18.</strong> 원에 내접하는 사각형 ABCD 의 한 외각의 크기가 85° 일 때, 이와 이웃하지 않는 대각(내대각)의 크기(도)를 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '85'", 'hint': '내접하는 사각형의 한 외각의 크기는 그 내대각(이웃하지 않는 대각)의 크기와 같다는 원리를 적용하도록 힌트를 줍니다.'},
    {'qnum': 19, 'title': '스테이지 19', 'story': '[원탁의 기사 마네킹 랜슬롯-M]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q19.</strong> 원 O 의 접선 PT 에 대하여 접점 T 를 지나는 현 TA 가 만드는 각 ∠ ATP = 60° 일 때, 그 현에 대한 원주각의 크기(도)를 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '60'", 'hint': '접선과 현이 이루는 각의 성질에 따라, 접선과 현이 이루는 각의 크기는 그 각 내부에 있는 호에 대한 원주각의 크기와 같음을 이용합니다.'},
    {'qnum': 20, 'title': '스테이지 20', 'story': '[원탁의 기사 마네킹 랜슬롯-M]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q20.</strong> 원 O 에서 길이가 서로 같은 두 호에 대한 두 원주각의 크기의 비율은 몇 대 몇인지 수치 비율로 적으시오. (예: 1)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '1'", 'hint': '한 원에서 호의 길이가 같으면 그에 대한 원주각의 크기도 같으므로 두 각의 비율을 파악해 봅니다.'}
]
