...
qs = [
    {'qnum': 1, "options": ["대푯값", "대푯값 아님", "알 수 없음", "해 없음"], 'title': '스테이지 1', 'story': '[안티-매터]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q1.</strong> 자료 전체의 특징을 대표적으로 나타내는 값을 통틀어 무엇이라 부르는가? (한글로 쓰시오. 예: 대푯값)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '대푯값'", 'hint': "자료 전체의 특징을 대표적으로 표현하는 통계적인 용어인 세 글자 '대푯값'을 떠올립니다."},
    {'qnum': 2, "options": ["평균", "평균 아님", "알 수 없음", "해 없음"], 'title': '스테이지 2', 'story': '[안티-매터]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q2.</strong> 자료의 값을 모두 더하여 자료의 개수로 나눈 값을 구하시오. (두 글자 한글로 쓰시오. 예: 평균)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '평균'", 'hint': '모든 수치 자료의 값들을 더해서 전체 개수로 나눈 기본 가치(평균)를 한글 두 글자로 대답하게 합니다.'},
    {'qnum': 3, "options": ["중앙값", "중앙값 아님", "알 수 없음", "해 없음"], 'title': '스테이지 3', 'story': '[안티-매터]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q3.</strong> 자료의 값을 크기순으로 나열했을 때 가장 한가운데에 위치하는 값을 무엇이라 하는가? (세 글자 한글로 쓰시오. 예: 중앙값)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '중앙값'", 'hint': "자료를 크기 순서대로 줄 세웠을 때 정중앙에 위치하는 값인 세 글자 '중앙값'을 구하게 합니다."},
    {'qnum': 4, "options": ["최빈값", "최빈값 아님", "알 수 없음", "해 없음"], 'title': '스테이지 4', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[갤럭시-G]: \\"치지직... 들리십니까...? 안티-매터의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q4.</strong> 자료의 값 중 가장 자주 나타나는 값을 무엇이라 하는가? (세 글자 한글로 쓰시오. 예: 최빈값)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '최빈값'", 'hint': "전체 변량 수치 중 가장 빈번하게 나타나는 값인 세 글자 '최빈값'을 떠올리게 유도합니다."},
    {'qnum': 5, "options": ["10", "3", "7", "5"], 'title': '스테이지 5', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[갤럭시-G]: \\"치지직... 들리십니까...? 안티-매터의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q5.</strong> 다섯 개의 우주 변량 데이터 1, 3, 5, 7, 9 의 평균을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '5'", 'hint': '전체 자료의 합을 구한 뒤, 자료의 개수로 나누어 평균을 산출하도록 지도합니다.'},
    {'qnum': 6, "options": ["5", "14", "7", "9"], 'title': '스테이지 6', 'story': '[안티-매터]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q6.</strong> 여섯 개의 우주 데이터 2, 4, 6, 8, 10, 12 의 중앙값을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '7'", 'hint': '자료의 개수가 짝수개인 경우, 크기순으로 나열했을 때 가장 가운데에 위치하는 두 값의 평균을 구하도록 가이드합니다.'},
    {'qnum': 7, "options": ["16", "6", "8", "10"], 'title': '스테이지 7', 'story': '[안티-매터]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q7.</strong> 데이터 3, 5, 5, 7, 8, 8, 8 의 최빈값을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '8'", 'hint': '제시된 데이터 중 출현 빈도가 가장 높은(가장 많이 나타나는) 수치를 최빈값으로 선별하게 합니다.'},
    {'qnum': 8, "options": ["중앙값", "중앙값 아님", "알 수 없음", "해 없음"], 'title': '스테이지 8', 'story': '[안티-매터]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q8.</strong> 대푯값 중 극단적인 값(아주 크거나 아주 작은 값)에 영향을 가장 적게 받아, 치우친 자료에 유용한 대푯값을 쓰시오. (세 글자 한글로 쓰시오. 예: 중앙값)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '중앙값'", 'hint': '극단치(아주 큰 수치)가 섞여 있을 때 평균은 왜곡되기 쉬우므로, 크기순으로 줄을 세운 중앙값을 대푯값으로 쓰는 이유를 설명합니다.'},
    {'qnum': 9, "options": ["편차", "편차 아님", "알 수 없음", "해 없음"], 'title': '스테이지 9', 'story': '[안티-매터]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q9.</strong> 변량들이 평균으로부터 떨어져 있는 차이(즉, 변량 - 평균)를 무엇이라 부르는가? (두 글자 한글로 쓰시오. 예: 편차)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '편차'", 'hint': '편차를 구하는 수학 공식인 (변량 - 평균)을 상기시킵니다.'},
    {'qnum': 10, "options": ["-1", "1", "0", "2"], 'title': '스테이지 10', 'story': '🚨 <strong>[비상 경보: 강제 자폭 시스템 작동]</strong> 🚨<br><br>[안티-매터]: \\"더는 참을 수 없군! 모든 데이터를 시스템을 포맷하겠다! 5분 내로 전부 초기화 시켜주지!\\"<br><br>[갤럭시-G]: \\"경고! 시스템 온도 상승 중! 제가 방화벽을 전개할 동안 긴급 수치 입력을 끝내십시오!\\"', 'qtext': '<strong>Q10.</strong> 변량들의 편차의 총합은 항상 얼마인가? (숫자로 적으시오.)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '0'", 'hint': '각 변량의 편차(변량 - 평균)들의 총합은 통계학적 성질에 의해 항상 일정한 상수 값이 됨을 주지시킵니다.', "extra_class": "glitch-bg"},
    {'qnum': 11, 'title': '스테이지 11', 'story': '[갤럭시-G]: \\"방어막 출력 한계 도달 중! 코드를 지속적으로 갱신해야 폭발을 유예할 수 있습니다! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q11.</strong> 편차의 제곱의 평균을 구하여 산포도를 나타내는 통계 값을 무엇이라 부르는가? (두 글자 한글로 쓰시오. 예: 분산)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '분산'", 'hint': '분산의 정의인 (편차의 제곱들의 평균)을 지칭하는 두 글자 단어를 쓰게 합니다.'},
    {'qnum': 12, 'title': '스테이지 12', 'story': '[갤럭시-G]: \\"방어막 출력 한계 도달 중! 코드를 지속적으로 갱신해야 폭발을 유예할 수 있습니다! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q12.</strong> 분산의 음이 아닌 양의 제곱근 값을 구하여 실제 변량과 단위를 맞춘 산포도 값을 무엇이라 하는가? (네 글자 한글로 쓰시오. 예: 표준편차)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '표준편차'", 'hint': '분산의 양의 제곱근 값을 구하여 실제 변량과 단위를 일치시키는 4글자 용어입니다.'},
    {'qnum': 13, 'title': '스테이지 13', 'story': '[갤럭시-G]: \\"방어막 출력 한계 도달 중! 코드를 지속적으로 갱신해야 폭발을 유예할 수 있습니다! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q13.</strong> 자료들의 흩어진 정도를 나타내는 하나의 수치를 통틀어 무엇이라 하는가? (삼항 구조의 세 글자 한글로 쓰시오. 예: 산포도)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '산포도'", 'hint': '자료들이 흩어져 있는 정도를 나타내는 통계적 수치의 총칭인 3글자 단어를 상기시킵니다.'},
    {'qnum': 14, 'title': '스테이지 14', 'story': '[갤럭시-G]: \\"방어막 출력 한계 도달 중! 코드를 지속적으로 갱신해야 폭발을 유예할 수 있습니다! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q14.</strong> 세 변량 3, 5, 7 의 분산을 구하시오. (슬래시를 사용해 분수로 나타내시오. 예: 8/3)', 'placeholder': '수식 입력 (예: 1/2 또는 8:27=10:x)', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '8/3'", 'hint': '자료의 평균을 먼저 구한 뒤, 각 변량의 편차의 제곱들을 구하여 이들의 평균(분산)을 도출하게 안내합니다.'},
    {'qnum': 15, 'title': '스테이지 15', 'story': '✨ <strong><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[조력자 시스템 권한 100% 완전 복구]</span></span></span></strong> ✨<br><br>[갤럭시-G]: \\"연산 데이터 대조 성공! 이제 시스템 통제권을 제가 절반 확보했습니다. 가자, 복수의 시간입니다!\\"<br><br>[안티-매터]: \\"크으으윽... 하찮은 인간 녀석들이 내 서버까지 잠식해 들어오다니!\\"', 'qtext': '<strong>Q15.</strong> 네 변량 1, 3, 5, 7 의 표준편차를 구하시오. (루트 기호를 사용하여 나타내시오. 예: √5)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '√5'", 'hint': '표준편차는 분산의 양의 제곱근이 됨을 활용해 루트 기호를 사용하여 표기하게 합니다.', "extra_class": "glitch-bg"},
    {'qnum': 16, 'title': '스테이지 16', 'story': '[안티-매터]: \\"아직 끝나지 않았다! 내 최고의 방해 암호를 해독해 보아라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q16.</strong> 두 변량의 상관관계를 한눈에 알아보기 위해 좌표평면 위에 점으로 나타낸 그림을 무엇이라 하는가? (세 글자 한글로 쓰시오. 예: 산점도)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '산점도'", 'hint': "두 변량 사이의 상관관계를 시각적으로 한눈에 파악하기 위해 점들로 나타낸 그림인 '산점도'를 답하게 합니다."},
    {'qnum': 17, 'title': '스테이지 17', 'story': '[안티-매터]: \\"아직 끝나지 않았다! 내 최고의 방해 암호를 해독해 보아라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q17.</strong> 한 변량 x의 값이 증가할 때, 다른 변량 y의 값도 대체로 증가하는 관계를 무슨 상관관계라 하는가? (칠글자 한글로 쓰시오. 예: 양의 상관관계)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '양의상관관계'", 'hint': 'x가 증가할 때 y도 우상향하여 증가하는 경향을 나타내는 7글자 용어(양의 상관관계)를 쓰게 합니다.'},
    {'qnum': 18, 'title': '스테이지 18', 'story': '[안티-매터]: \\"아직 끝나지 않았다! 내 최고의 방해 암호를 해독해 보아라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q18.</strong> 한 변량 x의 값이 증가할 때, 다른 변량 y의 값은 대체로 감소하는 관계를 무슨 상관관계라 하는가? (칠글자 한글로 쓰시오. 예: 음의 상관관계)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '음의상관관계'", 'hint': 'x가 증가할 때 y는 우하향하여 감소하는 경향을 보이는 7글자 용어(음의 상관관계)를 쓰게 합니다.'},
    {'qnum': 19, 'title': '스테이지 19', 'story': '[안티-매터]: \\"아직 끝나지 않았다! 내 최고의 방해 암호를 해독해 보아라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q19.</strong> "사람들의 키와 지능지수(IQ) 사이의 상관관계"는 어떤 관계가 있는지 쓰시오. (한글 세 글자로 쓰시오. 예: 없다)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '없다'", 'hint': "두 변량 사이에 아무런 선형 관계나 경향성이 보이지 않을 때 상관관계가 '없다'라고 답하게 지도합니다."},
    {'qnum': 20, 'title': '스테이지 20', 'story': '🔮 <strong>[최종 방화벽 락다운 해제]</strong> 🔮<br><br>[갤럭시-G]: \\"제 모든 에너지를 출구 개방에 전념하겠습니다. 당신이라면 저 장벽을 해독해 낼 것입니다. 마지막 답을 입력하세요!\\"<br><br>[안티-매터]: \\"안 돼... 내 제어권이... 정지한다아아!\\"', 'qtext': '<strong>Q20.</strong> "겨울철 실외 평균 기온과 각 가정의 가스 난방비 사이의 상관관계"는 어떤 관계가 있는지 쓰시오. (칠글자 한글로 쓰시오. 예: 음의 상관관계)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '음의상관관계'", 'hint': '한 요인이 증가할 때 다른 요인이 대체로 감소하는 관계인 7글자 상관관계 용어를 찾아 작성하게 안내합니다.', "extra_class": "glitch-bg"}
]
