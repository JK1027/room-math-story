...
<body>
    ...
    <div class="container">
        ...
        <div id="intro" class="glass-panel active">
            ...
            <div class="story-box">
                <div class="story-text">우주 은하연합의 거대한 중앙 통계 분석실 '산포도 데이터베이스'에 도착했습니다. 이곳의 방대한 우주선 궤도 예측 자료와 기후 데이터는 통계 수치 결계로 암호화되어 있어 시스템 조작이 불가능합니다. 우주선 통계 변량들의 대푯값과 흩어진 정도를 나타내는 산포도를 계산하여 제한시간 45분 내에 시스템 락을 해제하고 무사히 궤도를 복구하여 귀환하십시오!</div>
            </div>
            <div class="btn-group">
        ...
        <div id="outro" class="glass-panel">
            ...
            <div class="story-box">
                <div class="story-text">은하 연합의 거대한 홀로그램 맵에 안정적인 우주선 궤도선들이 다시 한 번 안전한 선으로 점등됩니다. 통계 데이터 분석실의 비상 잠금장치가 모두 해제되며 우주 귀환선의 해치가 열립니다. 데이터를 마스터한 통계 분석관의 귀환을 환영합니다!</div>
            </div>
            <div class="btn-group">
...
qs = [
    {
        ...
        "qtext": "<strong>Q1.</strong> 자료 전체의 특징을 대표적으로 나타내는 값을 통틀어 무엇이라 부르는가? (한글로 쓰시오. 예: 대푯값)",
        "placeholder": "정답 입력",
        "error": "정답이 올바르지 않습니다. 다시 계산해보세요.",
        "ans_check": "ans === '대푯값'",
        "hint": "자료 전체의 특징을 대표적으로 표현하는 통계적인 용어인 세 글자 '대푯값'을 떠올립니다."
    },
    {
        "qnum": 2,
        "title": "스테이지 2",
        "story": "주어진 단서를 해결하여 방의 봉인을 해제하세요.",
        "qtext": "<strong>Q2.</strong> 자료의 값을 모두 더하여 자료의 개수로 나눈 값을 구하시오. (두 글자 한글로 쓰시오. 예: 평균)",
        "placeholder": "정답 입력",
        "error": "정답이 올바르지 않습니다. 다시 계산해보세요.",
        "ans_check": "ans === '평균'",
        "hint": "모든 수치 자료의 값들을 더해서 전체 개수로 나눈 기본 가치(평균)를 한글 두 글자로 대답하게 합니다."
    },
    {
        "qnum": 3,
        "title": "스테이지 3",
        "story": "주어진 단서를 해결하여 방의 봉인을 해제하세요.",
        "qtext": "<strong>Q3.</strong> 자료의 값을 크기순으로 나열했을 때 가장 한가운데에 위치하는 값을 무엇이라 하는가? (세 글자 한글로 쓰시오. 예: 중앙값)",
        "placeholder": "정답 입력",
        "error": "정답이 올바르지 않습니다. 다시 계산해보세요.",
        "ans_check": "ans === '중앙값'",
        "hint": "자료를 크기 순서대로 줄 세웠을 때 정중앙에 위치하는 값인 세 글자 '중앙값'을 구하게 합니다."
    },
    {
        "qnum": 4,
        "title": "스테이지 4",
        "story": "주어진 단서를 해결하여 방의 봉인을 해제하세요.",
        "qtext": "<strong>Q4.</strong> 자료의 값 중 가장 자주 나타나는 값을 무엇이라 하는가? (세 글자 한글로 쓰시오. 예: 최빈값)",
        "placeholder": "정답 입력",
        "error": "정답이 올바르지 않습니다. 다시 계산해보세요.",
        "ans_check": "ans === '최빈값'",
        "hint": "전체 변량 수치 중 가장 빈번하게 나타나는 값인 세 글자 '최빈값'을 떠올리게 유도합니다."
    },
    {
        "qnum": 5,
        "title": "스테이지 5",
        "story": "주어진 단서를 해결하여 방의 봉인을 해제하세요.",
        "qtext": "<strong>Q5.</strong> 다섯 개의 우주 변량 데이터 1, 3, 5, 7, 9 의 평균을 구하시오.",
        "placeholder": "정답 입력",
        "error": "정답이 올바르지 않습니다. 다시 계산해보세요.",
        "ans_check": "ans === '5'",
        "hint": "전체 자료의 합을 구한 뒤, 자료의 개수로 나누어 평균을 산출하도록 지도합니다."
    },
    {
        "qnum": 6,
        "title": "스테이지 6",
        "story": "주어진 단서를 해결하여 방의 봉인을 해제하세요.",
        "qtext": "<strong>Q6.</strong> 여섯 개의 우주 데이터 2, 4, 6, 8, 10, 12 의 중앙값을 구하시오.",
        "placeholder": "정답 입력",
        "error": "정답이 올바르지 않습니다. 다시 계산해보세요.",
        "ans_check": "ans === '7'",
        "hint": "자료의 개수가 짝수개인 경우, 크기순으로 나열했을 때 가장 가운데에 위치하는 두 값의 평균을 구하도록 가이드합니다."
    },
    {
        "qnum": 7,
        "title": "스테이지 7",
        "story": "주어진 단서를 해결하여 방의 봉인을 해제하세요.",
        "qtext": "<strong>Q7.</strong> 데이터 3, 5, 5, 7, 8, 8, 8 의 최빈값을 구하시오.",
        "placeholder": "정답 입력",
        "error": "정답이 올바르지 않습니다. 다시 계산해보세요.",
        "ans_check": "ans === '8'",
        "hint": "제시된 데이터 중 출현 빈도가 가장 높은(가장 많이 나타나는) 수치를 최빈값으로 선별하게 합니다."
    },
    {
        "qnum": 8,
        "title": "스테이지 8",
        "story": "주어진 단서를 해결하여 방의 봉인을 해제하세요.",
        "qtext": "<strong>Q8.</strong> 대푯값 중 극단적인 값(아주 크거나 아주 작은 값)에 영향을 가장 적게 받아, 치우친 자료에 유용한 대푯값을 쓰시오. (세 글자 한글로 쓰시오. 예: 중앙값)",
        "placeholder": "정답 입력",
        "error": "정답이 올바르지 않습니다. 다시 계산해보세요.",
        "ans_check": "ans === '중앙값'",
        "hint": "극단치(아주 큰 수치)가 섞여 있을 때 평균은 왜곡되기 쉬우므로, 크기순으로 줄을 세운 중앙값을 대푯값으로 쓰는 이유를 설명합니다."
    },
    {
        "qnum": 9,
        "title": "스테이지 9",
        "story": "주어진 단서를 해결하여 방의 봉인을 해제하세요.",
        "qtext": "<strong>Q9.</strong> 변량들이 평균으로부터 떨어져 있는 차이(즉, 변량 - 평균)를 무엇이라 부르는가? (두 글자 한글로 쓰시오. 예: 편차)",
        "placeholder": "정답 입력",
        "error": "정답이 올바르지 않습니다. 다시 계산해보세요.",
        "ans_check": "ans === '편차'",
        "hint": "편차를 구하는 수학 공식인 (변량 - 평균)을 상기시킵니다."
    },
    {
        "qnum": 10,
        "title": "스테이지 10",
        "story": "주어진 단서를 해결하여 방의 봉인을 해제하세요.",
        "qtext": "<strong>Q10.</strong> 변량들의 편차의 총합은 항상 얼마인가? (숫자로 적으시오.)",
        "placeholder": "정답 입력",
        "error": "정답이 올바르지 않습니다. 다시 계산해보세요.",
        "ans_check": "ans === '0'",
        "hint": "각 변량의 편차(변량 - 평균)들의 총합은 통계학적 성질에 의해 항상 일정한 상수 값이 됨을 주지시킵니다."
    },
    {
        "qnum": 11,
        "title": "스테이지 11",
        "story": "주어진 단서를 해결하여 방의 봉인을 해제하세요.",
        "qtext": "<strong>Q11.</strong> 편차의 제곱의 평균을 구하여 산포도를 나타내는 통계 값을 무엇이라 부르는가? (두 글자 한글로 쓰시오. 예: 분산)",
        "placeholder": "정답 입력",
        "error": "정답이 올바르지 않습니다. 다시 계산해보세요.",
        "ans_check": "ans === '분산'",
        "hint": "분산의 정의인 (편차의 제곱들의 평균)을 지칭하는 두 글자 단어를 쓰게 합니다."
    },
    {
        "qnum": 12,
        "title": "스테이지 12",
        "story": "주어진 단서를 해결하여 방의 봉인을 해제하세요.",
        "qtext": "<strong>Q12.</strong> 분산의 음이 아닌 양의 제곱근 값을 구하여 실제 변량과 단위를 맞춘 산포도 값을 무엇이라 하는가? (네 글자 한글로 쓰시오. 예: 표준편차)",
        "placeholder": "정답 입력",
        "error": "정답이 올바르지 않습니다. 다시 계산해보세요.",
        "ans_check": "ans === '표준편차'",
        "hint": "분산의 양의 제곱근 값을 구하여 실제 변량과 단위를 일치시키는 4글자 용어입니다."
    },
    {
        "qnum": 13,
        "title": "스테이지 13",
        "story": "주어진 단서를 해결하여 방의 봉인을 해제하세요.",
        "qtext": "<strong>Q13.</strong> 자료들의 흩어진 정도를 나타내는 하나의 수치를 통틀어 무엇이라 하는가? (삼항 구조의 세 글자 한글로 쓰시오. 예: 산포도)",
        "placeholder": "정답 입력",
        "error": "정답이 올바르지 않습니다. 다시 계산해보세요.",
        "ans_check": "ans === '산포도'",
        "hint": "자료들이 흩어져 있는 정도를 나타내는 통계적 수치의 총칭인 3글자 단어를 상기시킵니다."
    },
    {
        "qnum": 14,
        "title": "스테이지 14",
        "story": "주어진 단서를 해결하여 방의 봉인을 해제하세요.",
        "qtext": "<strong>Q14.</strong> 세 변량 3, 5, 7 의 분산을 구하시오. (슬래시를 사용해 분수로 나타내시오. 예: 8/3)",
        "placeholder": "수식 입력 (예: 1/2 또는 8:27=10:x)",
        "error": "정답이 올바르지 않습니다. 다시 계산해보세요.",
        "ans_check": "ans === '8/3'",
        "hint": "자료의 평균을 먼저 구한 뒤, 각 변량의 편차의 제곱들을 구하여 이들의 평균(분산)을 도출하게 안내합니다."
    },
    {
        "qnum": 15,
        "title": "스테이지 15",
        "story": "주어진 단서를 해결하여 방의 봉인을 해제하세요.",
        "qtext": "<strong>Q15.</strong> 네 변량 1, 3, 5, 7 의 표준편차를 구하시오. (루트 기호를 사용하여 나타내시오. 예: √5)",
        "placeholder": "정답 입력",
        "error": "정답이 올바르지 않습니다. 다시 계산해보세요.",
        "ans_check": "ans === '√5'",
        "hint": "표준편차는 분산의 양의 제곱근이 됨을 활용해 루트 기호를 사용하여 표기하게 합니다."
    },
    {
        "qnum": 16,
        "title": "스테이지 16",
        "story": "주어진 단서를 해결하여 방의 봉인을 해제하세요.",
        "qtext": "<strong>Q16.</strong> 두 변량의 상관관계를 한눈에 알아보기 위해 좌표평면 위에 점으로 나타낸 그림을 무엇이라 하는가? (세 글자 한글로 쓰시오. 예: 산점도)",
        "placeholder": "정답 입력",
        "error": "정답이 올바르지 않습니다. 다시 계산해보세요.",
        "ans_check": "ans === '산점도'",
        "hint": "두 변량 사이의 상관관계를 시각적으로 한눈에 파악하기 위해 점들로 나타낸 그림인 '산점도'를 답하게 합니다."
    },
    {
        "qnum": 17,
        "title": "스테이지 17",
        "story": "주어진 단서를 해결하여 방의 봉인을 해제하세요.",
        "qtext": "<strong>Q17.</strong> 한 변량 x의 값이 증가할 때, 다른 변량 y의 값도 대체로 증가하는 관계를 무슨 상관관계라 하는가? (칠글자 한글로 쓰시오. 예: 양의 상관관계)",
        "placeholder": "정답 입력",
        "error": "정답이 올바르지 않습니다. 다시 계산해보세요.",
        "ans_check": "ans === '양의상관관계'",
        "hint": "x가 증가할 때 y도 우상향하여 증가하는 경향을 나타내는 7글자 용어(양의 상관관계)를 쓰게 합니다."
    },
    {
        "qnum": 18,
        "title": "스테이지 18",
        "story": "주어진 단서를 해결하여 방의 봉인을 해제하세요.",
        "qtext": "<strong>Q18.</strong> 한 변량 x의 값이 증가할 때, 다른 변량 y의 값은 대체로 감소하는 관계를 무슨 상관관계라 하는가? (칠글자 한글로 쓰시오. 예: 음의 상관관계)",
        "placeholder": "정답 입력",
        "error": "정답이 올바르지 않습니다. 다시 계산해보세요.",
        "ans_check": "ans === '음의상관관계'",
        "hint": "x가 증가할 때 y는 우하향하여 감소하는 경향을 보이는 7글자 용어(음의 상관관계)를 쓰게 합니다."
    },
    {
        "qnum": 19,
        "title": "스테이지 19",
        "story": "주어진 단서를 해결하여 방의 봉인을 해제하세요.",
        "qtext": "<strong>Q19.</strong> \"사람들의 키와 지능지수(IQ) 사이의 상관관계\"는 어떤 관계가 있는지 쓰시오. (한글 세 글자로 쓰시오. 예: 없다)",
        "placeholder": "정답 입력",
        "error": "정답이 올바르지 않습니다. 다시 계산해보세요.",
        "ans_check": "ans === '없다'",
        "hint": "두 변량 사이에 아무런 선형 관계나 경향성이 보이지 않을 때 상관관계가 '없다'라고 답하게 지도합니다."
    },
    {
        "qnum": 20,
        "title": "스테이지 20",
        "story": "주어진 단서를 해결하여 방의 봉인을 해제하세요.",
        "qtext": "<strong>Q20.</strong> \"겨울철 실외 평균 기온과 각 가정의 가스 난방비 사이의 상관관계\"는 어떤 관계가 있는지 쓰시오. (칠글자 한글로 쓰시오. 예: 음의 상관관계)",
        "placeholder": "정답 입력",
        "error": "정답이 올바르지 않습니다. 다시 계산해보세요.",
        "ans_check": "ans === '음의상관관계'",
        "hint": "한 요인이 증가할 때 다른 요인이 대체로 감소하는 관계인 7글자 상관관계 용어를 찾아 작성하게 안내합니다."
    }
]
