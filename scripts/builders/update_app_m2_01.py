...
qs = [
    ...
    {'qnum': 4, "options": ["유한소수", "순환소수", "순환하지 않는 무한소수", "정수"], 'title': '두 갈래 길 선택', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[스피드-N]: \\"치지직... 들리십니까...? 해커-Z의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q4. [유한소수 판별 1]</strong><br>$\\frac{7}{20}$ 은 유한소수인가, 무한소수인가?', 'placeholder': '유한소수 또는 무한소수 입력', 'error': '함정 트랙으로 진입했습니다! 조종 불능!', 'ans_check': "ans === '유한소수'"},
    {'qnum': 5, "options": ["무한소수", "무한소수 아님", "알 수 없음", "해 없음"], 'title': '급커브 코스 감속', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[스피드-N]: \\"치지직... 들리십니까...? 해커-Z의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q5. [유한소수 판별 2]</strong><br>$\\frac{13}{30}$ 은 유한소수인가, 무한소수인가?', 'placeholder': '유한소수 또는 무한소수 입력', 'error': '오버스티어 발생! 차량이 트랙 밖으로 밀려납니다.', 'ans_check': "ans === '무한소수'"},
    {'qnum': 6, "options": ["유한소수", "순환소수", "순환하지 않는 무한소수", "정수"], 'title': '무한 루프 진입', 'story': '[해커-Z]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 🔄 <strong>[루프의 늪]</strong><br><br>[레이싱 내비게이션 스피드-N]: \\"제 2구역 무한 루프 구간에 도달했습니다. 일정한 숫자의 배열이 끝없이 되풀이되는 무한소수의 정확한 이름을 입력하여 동기화하십시오.\\"\\"', 'qtext': '<strong>Q6. [순환소수의 뜻]</strong><br>무한소수 중 일정한 숫자의 배열이 끝없이 되풀이되는 소수를 무엇이라 하는가?', 'placeholder': '네 글자 입력', 'error': '동기화 실패! 무한 루프에 영원히 갇힙니다.', 'ans_check': "ans === '순환소수'"},
    {'qnum': 7, "options": ["0.[3]", "0.[3] 아님", "알 수 없음", "해 없음"], 'title': '순환마디 락 해제', 'story': '[해커-Z]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 🔄 <strong>[기본 코드 해독]</strong><br><br>[레이싱 내비게이션 스피드-N]: \\"순환소수 0.3333... 의 무한 루프를 끄기 위해 순환마디 점을 찍은 간략화 코드로 해독하십시오. (대괄호 `[]`로 순환마디를 감싸서 입력하세요. 예: 0.[3])\\"\\"', 'qtext': '<strong>Q7. [순환소수 표현 1]</strong><br>0.3333... 을 순환마디에 점을 찍어 간단히 나타낸 기호를 대괄호 형식을 사용하여 쓰시오.', 'placeholder': '예: 0.[3] 또는 0.(3)', 'error': '해독 코드 불일치! 루프 차단막이 강해집니다.', 'ans_check': "ans === '0.[3]' || ans === '0.(3)' || ans === '0.3'"},
    {'qnum': 8, "options": ["27", "50", "25", "23"], 'title': '트랙 코어 해킹', 'story': '[해커-Z]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 🔄 <strong>[코어 패턴 인식]</strong><br><br>[레이싱 내비게이션 스피드-N]: \\"두 번째 루프 코어입니다. 소수 1.252525... 에서 무한히 반복되는 패턴(순환마디) 자체의 값을 찾아내어 입력하십시오.\\"\\"', 'qtext': '<strong>Q8. [순환마디 구하기 1]</strong><br>1.252525... 의 순환마디를 구하시오.', 'placeholder': '예: 25', 'error': '패턴 인식 오류! 코어가 응답하지 않습니다.', 'ans_check': "ans === '25'"},
    {'qnum': 9, "options": ["0.4[56]", "0.4[56] 아님", "알 수 없음", "해 없음"], 'title': '복합 루프 우회', 'story': '[해커-Z]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 🔄 <strong>[비대칭 패턴 분석]</strong><br><br>[레이싱 내비게이션 스피드-N]: \\"순환하지 않는 소수점 자리가 포함된 복합 루프입니다. 0.4565656... 을 대괄호 `[]` 규칙을 적용해 압축 코드로 우회하십시오. (예: 0.4[56])\\"\\"', 'qtext': '<strong>Q9. [순환소수 표현 2]</strong><br>0.4565656... 을 대괄호 형식을 사용하여 간단히 나타내시오.', 'placeholder': '예: 0.4[56]', 'error': '우회 실패! 백신 프로그램에 발각되었습니다.', 'ans_check': "ans === '0.4[56]' || ans === '0.4(56)' || ans === '0.456'"},
    {'qnum': 10, 'title': '루프 마디 압축', 'story': '🚨 <strong>[비상 경보: 강제 자폭 시스템 작동]</strong> 🚨<br><br>[해커-Z]: \\"더는 참을 수 없군! 모든 데이터를 시스템을 포맷하겠다! 5분 내로 전부 초기화 시켜주지!\\"<br><br>[스피드-N]: \\"경고! 시스템 온도 상승 중! 제가 방화벽을 전개할 동안 긴급 수치 입력을 끝내십시오!\\"', 'qtext': '<strong>Q10. [순환마디 구하기 2]</strong><br>분수 $\\frac{1, "extra_class": "glitch-bg"}{3}$ 을 소수로 나타낼 때, 순환마디는 무엇인가?', 'placeholder': '숫자만 입력', 'error': '압축기 오작동! 기어 압력이 급상승합니다.', 'ans_check': "ans === '3'"},
    ...
    {'qnum': 19, "options": ["O", "X"], 'title': '부스터 잠금 해제', 'story': '[해커-Z]: \\"아직 끝나지 않았다! 내 최고의 방해 암호를 해독해 보아라! 🏁 <strong>[참과 거짓 판정]</strong><br><br>[레이싱 내비게이션 스피드-N]: \\"마지막 관문 진입 직전입니다. \'모든 순환소수는 유리수이다.\' 명제의 진위를 가려 회로를 해제하십시오.\\"\\"', 'qtext': '<strong>Q19. [유리수의 정의]</strong><br>모든 순환소수는 유리수이다. ( O / X )', 'placeholder': 'O 또는 X 입력', 'error': '회로 단선! 스파크가 발생합니다!', 'ans_check': "ans === 'O' || ans === 'o' || ans === '오'"},
    {'qnum': 20, 'title': '골인 레이저 가동', 'story': '🔮 <strong>[최종 방화벽 락다운 해제]</strong> 🔮<br><br>[스피드-N]: \\"제 모든 에너지를 출구 개방에 전념하겠습니다. 당신이라면 저 장벽을 해독해 낼 것입니다. 마지막 답을 입력하세요!\\"<br><br>[해커-Z]: \\"안 돼... 내 제어권이... 정지한다아아!\\"', 'qtext': '<strong>Q20. [순환소수의 극한]</strong><br>$0.\\dot{9, "extra_class": "glitch-bg"}$ 를 분수로 나타내면 얼마인가?', 'placeholder': '숫자만 입력', 'error': '조준 실패! 결승선 돌파 기회를 놓칩니다!', 'ans_check': "ans === '1'"}
]
