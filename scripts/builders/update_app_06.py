...
qs = [
    {
        "qnum": 1,
        "title": "거울 열 배분",
        "story": "[아누비스-A]: \"한 꼭짓점에서 5개의 대각선을 그을 수 있는 다각형 이름을 입력해 첫 장벽을 해제해라!\"",
        "qtext": "<strong>Q1. [다각형의 대각선 1]</strong><br>한 꼭짓점에서 그을 수 있는 대각선의 개수가 5개인 다각형의 이름을 구하시오.",
        "placeholder": "예: 육각형",
        "error": "기둥 조작 오류!",
        "ans_check": "ans === '팔각형'",
        "hint": "n각형의 한 꼭짓점에서 그을 수 있는 대각선의 개수 공식은 n-3 입니다."
    },
    {
        "qnum": 2,
        "title": "기둥 교차망",
        "story": "[아누비스-A]: \"십각형 모양의 기둥 배치에서 모든 기둥끼리 서로 빛을 교차 연결할 때, 총 대각선 수는 몇 개인가?\"",
        "qtext": "<strong>Q2. [다각형의 대각선 2]</strong><br>십각형 모양의 기둥 배치에서 모든 기둥끼리 서로 빛을 교차 연결하려고 한다. 총 대각선의 개수를 구하시오.",
        "placeholder": "숫자만 입력",
        "error": "계산 오류!",
        "ans_check": "ans === '35'",
        "hint": "n각형의 총 대각선 수 공식인 n(n-3)/2 에 10을 대입하여 계산합니다."
    },
    {
        "qnum": 3,
        "title": "빛의 반사각",
        "story": "[아누비스-A]: \"삼각형 반사판에서 두 내각이 각각 45도, 60도일 때, 나머지 한 내각의 외각 크기를 대라!\"",
        "qtext": "<strong>Q3. [삼각형의 외각 1]</strong><br>삼각형 반사판에서 두 내각이 각각 45도, 60도일 때, 나머지 한 내각의 외각의 크기를 구하시오.",
        "placeholder": "숫자만 입력",
        "error": "각도 오류!",
        "ans_check": "ans === '105'",
        "hint": "삼각형의 한 외각의 크기는 그와 이웃하지 않는 두 내각의 크기의 합과 같습니다."
    },
    {
        "qnum": 4,
        "title": "외각의 배분",
        "story": "[아누비스-A]: \"삼각형의 세 외각의 비가 2:3:4일 때, 가장 큰 외각의 크기는 얼마인가?\"",
        "qtext": "<strong>Q4. [삼각형의 외각 2]</strong><br>삼각형의 세 외각의 비가 2:3:4일 때, 가장 큰 외각의 크기를 구하시오.",
        "placeholder": "숫자만 입력",
        "error": "비율 오류!",
        "ans_check": "ans === '160'",
        "hint": "다각형의 외각의 총합은 항상 360도입니다. 비례배분을 이용하여 가장 큰 비율(4)을 차지하는 외각을 구합니다."
    },
    {
        "qnum": 5,
        "title": "신전 내각 다이얼",
        "story": "[아누비스-A]: \"내각의 크기의 합이 900도인 다각형의 꼭짓점 개수를 숫자로만 알아 맞춰라!\"",
        "qtext": "<strong>Q5. [다각형의 내각]</strong><br>내각의 크기의 합이 900도인 다각형의 꼭짓점의 개수를 구하시오.",
        "placeholder": "숫자만 입력",
        "error": "다각형 모양 오류!",
        "ans_check": "ans === '7'",
        "hint": "n각형의 내각의 총합 공식은 180 * (n-2) 입니다. 이 값이 900이 되는 n을 찾습니다."
    },
    {
        "qnum": 6,
        "title": "외각의 법칙",
        "story": "[아누비스-A]: \"제2구역 암호 다이얼이다. 다각형의 외각의 총합은 예외 없이 항상 몇 도로 약속되어 있는가?\"",
        "qtext": "<strong>Q6. [다각형의 외각의 합]</strong><br>모든 다각형의 외각의 크기의 합은 항상 일정합니다. 그 크기는 몇 도인가?",
        "placeholder": "숫자만 입력",
        "error": "회전판이 멈췄습니다!",
        "ans_check": "ans === '360'",
        "hint": "다각형이 몇 각형이든 상관없이 모든 외각의 크기의 총합은 항상 360도입니다."
    },
    {
        "qnum": 7,
        "title": "정다각형의 추적",
        "story": "[아누비스-A]: \"한 외각의 크기가 36도인 정다각형을 찾아 그 이름을 다이얼 암호판에 입력해라!\"",
        "qtext": "<strong>Q7. [정다각형의 외각]</strong><br>한 외각의 크기가 36도인 정다각형의 이름을 구하시오.",
        "placeholder": "예: 정오각형",
        "error": "다이얼 문양 오류!",
        "ans_check": "ans === '정십각형'",
        "hint": "정n각형의 한 외각 크기는 360 / n 입니다. 이 값이 36이 되는 n을 구해 정다각형 이름을 적습니다."
    },
    {
        "qnum": 8,
        "title": "블록 설계도",
        "story": "[아누비스-A]: \"정팔각형 모양의 거울 블록 한 내각의 각도는 몇 도로 설계되었겠나?\"",
        "qtext": "<strong>Q8. [정다각형의 내각 1]</strong><br>정팔각형의 한 내각의 크기를 구하시오.",
        "placeholder": "숫자만 입력",
        "error": "각도 입력 실패!",
        "ans_check": "ans === '135'",
        "hint": "정팔각형의 내각 총합인 180 * (8-2) = 1080도를 꼭짓점 개수인 8로 나누어 한 내각을 구합니다."
    },
    {
        "qnum": 9,
        "title": "대각선 기어",
        "story": "[아누비스-A]: \"한 내각의 크기가 150도인 정다각형의 대각선의 총 개수를 정밀하게 연산해 내라!\"",
        "qtext": "<strong>Q9. [정다각형의 내각 2]</strong><br>한 내각의 크기가 150도인 정다각형의 대각선의 총 개수를 구하시오.",
        "placeholder": "숫자만 입력",
        "error": "계산 오류!",
        "ans_check": "ans === '54'",
        "hint": "한 내각이 150도이면 한 외각은 30도입니다. 외각의 합이 360도이므로 정십이각형임을 구한 뒤 총 대각선 공식을 적용합니다."
    },
    {
        "qnum": 10,
        "title": "비율 정렬",
        "story": "[아누비스-A]: \"한 내각과 외각 크기 비율이 4:1이 되었다. 이 도면의 정다각형 이름을 적어 암호를 풀어라!\"",
        "qtext": "<strong>Q10. [내각과 외각의 비]</strong><br>한 내각과 한 외각의 크기의 비가 4:1인 정다각형의 이름을 구하시오.",
        "placeholder": "예: 정육각형",
        "error": "암호판 고정 실패!",
        "ans_check": "ans === '정십각형'",
        "hint": "한 내각과 한 외각의 합은 180도입니다. 이를 4:1로 비례배분하여 한 외각을 구하고 다각형 이름을 유추합니다."
    },
    {
        "qnum": 11,
        "title": "제3구역 석판 봉인",
        "story": "[아누비스-A]: \"자와 컴퍼스만으로 중심각을 조율하는 이 고대 기하학 도식법을 무엇이라 부르는가?\"",
        "qtext": "<strong>Q11. [호의 길이와 중심각 1]</strong><br>한 원에서 부채꼴의 호의 길이는 중심각의 크기에 어떻게 비례하는가?",
        "placeholder": "예: 정비례, 반비례",
        "error": "비례 원리 오류!",
        "ans_check": "ans === '정비례'",
        "hint": "부채꼴의 중심각이 커질 때 호의 길이도 이에 비례하여 일정하게 늘어나는 성질을 뜻합니다."
    },
    {
        "qnum": 12,
        "title": "길이 복사기",
        "story": "[아누비스-A]: \"회전 톱니에 새겨진 선분의 길이를 그대로 복사해 옮길 때 사용해야 하는 2족 기구의 명칭은?\"",
        "qtext": "<strong>Q12. [호의 길이와 중심각 2]</strong><br>중심각이 40도일 때 호의 길이가 6cm라면, 중심각이 160도일 때 호의 길이를 구하시오.",
        "placeholder": "숫자만 입력",
        "error": "호의 길이 조절 실패!",
        "ans_check": "ans === '24'",
    ...
    },
    {
        "qnum": 13,
        "title": "지지대의 평형",
        "story": "[아누비스-A]: \"삼각형 지지대 목재를 조립하려 한다. 가장 긴 변 c는 나머지 두 변의 합(a+b)보다 ( 커야 / 작아야 ) 조립이 되는지 판단하라!\"",
        "qtext": "<strong>Q13. [부채꼴의 넓이와 중심각]</strong><br>부채꼴의 넓이가 원의 넓이의 1/6일 때, 이 부채꼴의 중심각의 크기를 구하시오.",
        "placeholder": "숫자만 입력",
        "error": "각도 조절 실패!",
        "ans_check": "ans === '60'",
        "hint": "원 전체의 중심각은 360도입니다. 넓이가 원의 1/6이므로 중심각도 360도의 1/6을 차지합니다."
    },
    {
        "qnum": 14,
        "title": "나무막대 기둥",
        "story": "[아누비스-A]: \"3cm, 4cm, 7cm 길이의 거울 지지목 세 개가 있다. 이 지지목들로 삼각형 반사대를 조립할 수 있는지 답해라! (있다/없다)\"",
        "qtext": "<strong>Q14. [현의 길이]</strong><br>중심각의 크기가 같은 두 부채꼴의 현의 길이는 서로 같은가?",
        "placeholder": "예: 같다, 다르다",
        "error": "현의 길이 오류!",
        "ans_check": "ans === '같다'",
        "hint": "중심각이 같은 두 부채꼴에서 원 위의 두 점을 곧게 이은 선분(현)의 길이를 비교해 봅니다."
    },
    {
        "qnum": 15,
        "title": "작도 판정",
        "story": "[아누비스-A]: \"거울 두 변의 길이와 그 끼인각이 주어졌을 때, 완벽하게 통제된 삼각형 반사대를 단 하나로 그려낼 수 있는가? (있다/없다)\"",
        "qtext": "<strong>Q15. [현과 중심각의 비례]</strong><br>현의 길이는 중심각의 크기에 정비례하는가?",
        "placeholder": "예: 그렇다, 아니다",
        "error": "비례 관계 오류!",
        "ans_check": "ans === '아니다'",
        "hint": "중심각이 2배가 될 때 현의 길이도 정확히 2배가 되는지 원 위에 직접 그려 확인해 봅니다."
    },
    {
        "qnum": 16,
        "title": "제4구역 최종 냉각",
        "story": "[아누비스-A]: \"두 거울 패널이 모양과 크기가 완벽히 같아 겹쳤을 때 100% 일치하는 관계를 무엇이라 하는가?\"",
        "qtext": "<strong>Q16. [원주 계산]</strong><br>반지름의 길이가 5cm인 원의 둘레의 길이를 구하시오. (원주율은 π, 입력시 '파이'로 기재)",
        "placeholder": "예: 5파이",
        "error": "둘레 계산 오류!",
        "ans_check": "ans === '10파이'",
        "hint": "반지름이 r인 원의 둘레 공식은 2 * 파이 * r 입니다."
    },
    {
        "qnum": 17,
        "title": "원형 뚜껑",
        "story": "[아누비스-A]: \"반지름 5cm인 원형 수조 뚜껑의 테두리 둘레 길이를 원주율 파이를 이용해 대라! (예: 10파이)\"",
        "qtext": "<strong>Q17. [호의 길이 계산]</strong><br>반지름의 길이가 9cm이고 중심각의 크기가 120도인 부채꼴의 호의 길이를 구하시오.",
        "placeholder": "예: 3파이",
        "error": "금실 길이 부족!",
        "ans_check": "ans === '6파이'",
        "hint": "반지름이 r, 중심각이 x도인 부채꼴 호의 길이 공식은 2 * 파이 * r * (x / 360) 입니다."
    },
    {
        "qnum": 18,
        "title": "수로 조율",
        "story": "[아누비스-A]: \"반지름 9cm, 중심각 120도인 부채꼴 수로의 호의 길이를 구하여 수문 개방 조건을 만족해라! (예: 6파이)\"",
        "qtext": "<strong>Q18. [부채꼴의 넓이 계산]</strong><br>반지름의 길이가 6cm이고 중심각의 크기가 60도인 부채꼴 모양 홈의 넓이를 구하시오.",
        "placeholder": "예: 2파이",
        "error": "면적 계산 오류!",
        "ans_check": "ans === '6파이'",
        "hint": "반지름이 r, 중심각이 x도인 부채꼴 넓이 공식은 파이 * r^2 * (x / 360) 입니다."
    },
    {
        "qnum": 19,
        "title": "냉각 밸브",
        "story": "[아누비스-A]: \"반지름 6cm, 중심각 60도인 부채꼴 냉각 밸브의 단면 넓이를 계산해 송신하라! (예: 6파이)\"",
        "qtext": "<strong>Q19. [중심각 없이 넓이 구하기]</strong><br>반지름의 길이가 10cm이고 호의 길이가 5π cm인 부채꼴 모양 석문의 넓이를 계산하시오.",
        "placeholder": "예: 10파이",
        "error": "게이트 수치 오류!",
        "ans_check": "ans === '25파이'",
        "hint": "반지름 r과 호의 길이 l이 주어졌을 때의 부채꼴 넓이 공식인 (1/2) * r * l 을 활용합니다."
    },
    {
        "qnum": 20,
        "title": "최종 마스터 게이트",
        "story": "[아누비스-A]: \"반지름 10cm, 호의 길이 5파이 cm인 부채꼴 석문의 넓이를 정확히 계산하여 락을 완전히 해제하라! (예: 25파이)\"",
        "qtext": "<strong>Q20. [색칠한 부분의 넓이]</strong><br>반지름이 8cm인 반원에서 반지름이 4cm인 반원 두 개를 뺀 색칠된 부분의 넓이를 구하시오.",
        "placeholder": "예: 12파이",
        "error": "다이얼이 잠겼습니다!",
        "ans_check": "ans === '16파이'",
        "hint": "반지름 8cm인 큰 반원 넓이에서 반지름 4cm인 작은 반원 두 개(합치면 작은 원 하나)의 넓이를 뺍니다."
    }
]
