...
qs = [
    {'qnum': 1, "options": ["사인", "사인 아님", "알 수 없음", "해 없음"], 'title': '스테이지 1', 'story': '[블랙홀-B]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q1.</strong> 직각삼각형에서 빗변의 길이에 대한 높이의 비율을 나타내는 삼각비의 명칭을 구하시오. (한글로 쓰시오. 예: 사인)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '사인'", 'hint': '직각삼각형에서 빗변의 길이에 대한 높이의 비율(대변/빗변)을 나타내는 삼각비를 한글 두 글자로 대답하게 합니다.'},
    {'qnum': 2, "options": ["1/2", "-1/2", "2/2", "1"], 'title': '스테이지 2', 'story': '[블랙홀-B]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q2.</strong> \\sin 30° 의 값을 구하시오. (슬래시를 사용해 분수로 나타내시오. 예: 1/2)', 'placeholder': '수식 입력 (예: 1/2 또는 8:27=10:x)', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '1/2' || ans === '0.5'", 'hint': '특수각 30도에 대한 직각삼각형의 삼각비 표 값을 상기시키며 분수 형태를 찾게 합니다.'},
    {'qnum': 3, "options": ["√2/2", "√2/2 아님", "알 수 없음", "해 없음"], 'title': '스테이지 3', 'story': '[블랙홀-B]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q3.</strong> \\cos 45° 의 값을 구하시오. (루트와 분수를 사용해 식으로 나타내시오. 예: √2/2)', 'placeholder': '수식 입력 (예: 1/2 또는 8:27=10:x)', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '√2/2'", 'hint': '특수각 45도에 대한 코사인 값은 빗변에 대한 밑변의 비율임을 활용합니다.'},
    {'qnum': 4, "options": ["√3", "√3 아님", "알 수 없음", "해 없음"], 'title': '스테이지 4', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[아스트로-A]: \\"치지직... 들리십니까...? 블랙홀-B의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q4.</strong> \\tan 60° 의 값을 구하시오. (예: √3)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '√3'", 'hint': '특수각 60도에 대한 탄젠트 값은 밑변에 대한 높이의 비율임을 활용합니다.'},
    {'qnum': 5, "options": ["4/5", "-4/5", "5/5", "1"], 'title': '스테이지 5', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[아스트로-A]: \\"치지직... 들리십니까...? 블랙홀-B의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q5.</strong> 직각삼각형 ABC 에서 ∠ B = 90° 이고, 빗변 AC = 5, 높이 BC = 4, 밑변 AB = 3 일 때, \\sin A 의 값을 구하시오. (예: 4/5)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '4/5' || ans === '0.8'", 'hint': '사인 공식인 (높이)/(빗변) 공식을 대입하여 직각삼각형 두 변의 길이 비를 산출하도록 유도합니다.'},
    {'qnum': 6, "options": ["-1", "1", "3", "2"], 'title': '스테이지 6', 'story': '[블랙홀-B]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q6.</strong> \\sin 90° 의 값을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '1'", 'hint': '예각이 90도에 한없이 가까워질 때 사인 값의 기하학적 변화(최댓값)를 이해하게 합니다.'},
    {'qnum': 7, "options": ["-1", "1", "0", "2"], 'title': '스테이지 7', 'story': '[블랙홀-B]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q7.</strong> \\cos 90° 의 값을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '0'", 'hint': '예각이 90도에 한없이 가까워질 때 코사인 값의 기하학적 변화(최솟값)를 확인시킵니다.'},
    {'qnum': 8, "options": ["-1", "1", "3", "2"], 'title': '스테이지 8', 'story': '[블랙홀-B]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q8.</strong> \\tan 45° 의 값을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '1'", 'hint': '밑변과 높이가 같은 직각이등변삼각형에서의 탄젠트 값을 상기시킵니다.'},
    {'qnum': 9, "options": ["-1", "1", "3", "2"], 'title': '스테이지 9', 'story': '[블랙홀-B]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q9.</strong> \\cos 0° 의 값을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '1'", 'hint': '예각이 0도에 한없이 가까워질 때 코사인 값의 기하학적 변화(최댓값)를 확인시킵니다.'},
    {'qnum': 10, "options": ["√3", "√3 아님", "알 수 없음", "해 없음"], 'title': '스테이지 10', 'story': '🚨 <strong>[비상 경보: 강제 자폭 시스템 작동]</strong> 🚨<br><br>[블랙홀-B]: \\"더는 참을 수 없군! 모든 데이터를 시스템을 포맷하겠다! 5분 내로 전부 초기화 시켜주지!\\"<br><br>[아스트로-A]: \\"경고! 시스템 온도 상승 중! 제가 방화벽을 전개할 동안 긴급 수치 입력을 끝내십시오!\\"', 'qtext': '<strong>Q10.</strong> \\sin 60° + \\cos 30° 의 값을 구하시오. (예: √3)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '√3'", 'hint': '특수각 60도에 대한 사인 값과 30도에 대한 코사인 값을 각각 구하여 덧셈합니다.', "extra_class": "glitch-bg"},
    ...
    {'qnum': 14, 'title': '스테이지 14', 'story': '[아스트로-A]: \\"방어막 출력 한계 도달 중! 코드를 지속적으로 갱신해야 폭발을 유예할 수 있습니다! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q14.</strong> 직각삼각형 ABC 에서 ∠ C = 90° 이고 빗변 AB = 10, ∠ A = 30° 일 때, 높이 BC 의 길이를 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '5'", 'hint': '직각삼각형의 높이 = (빗변) × sin A 공식을 사용하여 미지의 높이를 계산합니다.'},
    {'qnum': 15, 'title': '스테이지 15', 'story': '✨ <strong><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[조력자 시스템 권한 100% 완전 복구]</span></span></span></strong> ✨<br><br>[아스트로-A]: \\"연산 데이터 대조 성공! 이제 시스템 통제권을 제가 절반 확보했습니다. 가자, 복수의 시간입니다!\\"<br><br>[블랙홀-B]: \\"크으으윽... 하찮은 인간 녀석들이 내 서버까지 잠식해 들어오다니!\\"', 'qtext': '<strong>Q15.</strong> 직각삼각형 ABC 에서 ∠ C = 90° 이고 밑변 AC = 8, ∠ A = 45° 일 때, 대변 BC 의 길이를 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '8'", 'hint': '직각삼각형의 높이 = (밑변) × tan A 공식을 사용하여 미지의 높이를 계산합니다.', "extra_class": "glitch-bg"},
    {'qnum': 16, 'title': '스테이지 16', 'story': '[블랙홀-B]: \\"아직 끝나지 않았다! 내 최고의 방해 암호를 해독해 보아라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q16.</strong> 두 변의 길이가 각각 4, 6이고 그 사잇각이 30° 인 삼각형의 넓이를 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '6'", 'hint': '일반 삼각형의 넓이 공식인 1/2 × a × b × sin C 를 적용하여 계산을 처리합니다.'},
