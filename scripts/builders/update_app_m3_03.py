...
qs = [
    ...
    {'qnum': 2, "options": ["±2", "±2 아님", "알 수 없음", "해 없음"], 'title': '스테이지 2', 'story': '[시간의-방랑자]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q2.</strong> 이차방정식 x² - 4 = 0 의 두 근을 구하시오. (± 기호를 사용하여 구하시오. 예: ±2)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '±2' || ans === '+-2' || ans === '2,-2' || ans === '-2,2'", 'hint': '미지수의 제곱이 상수항과 같음을 이용해, 제곱근의 정의를 활용해 해를 구하도록 안내합니다.'},
    {'qnum': 3, "options": ["10", "3", "7", "5"], 'title': '스테이지 3', 'story': '[시간의-방랑자]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q3.</strong> x=2 가 이차방정식 x² - ax + 6 = 0 의 한 근일 때, 상수 a의 값을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '5'", 'hint': '이차방정식의 한 근이 주어지면, 그 근의 값을 방정식의 미지수 자리에 대입하여 성립함을 활용하게 지도합니다.'},
    {'qnum': 4, "options": ["-2,3", "-2,3 아님", "알 수 없음", "해 없음"], 'title': '스테이지 4', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[크로노스-C]: \\"치지직... 들리십니까...? 시간의-방랑자의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q4.</strong> 이차방정식 (x-3)(x+2) = 0 의 두 근을 구하시오. (작은 수부터 쉼표로 구분하여 적으시오. 예: -2, 3)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '-2,3'", 'hint': '두 일차식의 곱이 0이 되기 위해서는 각각의 일차식이 0이 되어야 한다는 방정식을 세우게 합니다.'},
    {'qnum': 5, "options": ["2,3", "2,3 아님", "알 수 없음", "해 없음"], 'title': '스테이지 5', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[크로노스-C]: \\"치지직... 들리십니까...? 시간의-방랑자의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q5.</strong> 이차방정식 x² - 5x + 6 = 0 의 두 근을 구하시오. (작은 수부터 적으시오. 예: 2, 3)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '2,3'", 'hint': '우변을 0으로 만든 뒤 좌변을 인수분해하여 두 일차식의 곱이 0이 되는 원리로 해를 구하게 유도합니다.'},
    {'qnum': 6, "options": ["4", "6", "2", "8"], 'title': '스테이지 6', 'story': '[시간의-방랑자]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q6.</strong> 이차방정식 x² - 8x + 16 = 0 의 근을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '4'", 'hint': '좌변이 동일한 두 일차식의 곱(완전제곱식)으로 인수분해될 때 발생하는 중복된 근(중근)의 성질을 설명합니다.'},
    {'qnum': 7, "options": ["4", "6", "8", "12"], 'title': '스테이지 7', 'story': '[시간의-방랑자]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q7.</strong> 이차방정식 x² + ax + 9 = 0 이 중근을 가질 때, 양수 a의 값을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '6'", 'hint': '이차방정식이 중근을 가질 조건은 상수항이 1차항 계수의 반의 제곱과 같아야 한다는 공식을 적용하게 합니다.'},
    {'qnum': 8, "options": ["±2√5", "±2√5 아님", "알 수 없음", "해 없음"], 'title': '스테이지 8', 'story': '[시간의-방랑자]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q8.</strong> 이차방정식 (x-2)² = 5 의 근을 구하시오. (기호 ±와 루트를 사용하여 나타내시오. 예: 2±√5)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '±2√5' || ans === '+-2√5' || ans === '2√5,-2√5' || ans === '-2√5,2√5'", 'hint': '완전제곱식을 이용해 제곱근의 정의를 활용하여 미지수 값의 범위를 구하도록 지도합니다.'},
    {'qnum': 9, "options": ["16", "6", "8", "10"], 'title': '스테이지 9', 'story': '[시간의-방랑자]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q9.</strong> 이차방정식 x² - 6x + 2 = 0 을 (x-p)² = q 꼴로 고칠 때, 두 상수 p, q에 대하여 p+q의 값을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '8'", 'hint': '상수항을 먼저 우변으로 이항한 후, 좌변을 완전제곱식으로 만들기 위해 양변에 필요한 상수를 더해주는 과정을 안내합니다.'},
    {'qnum': 10, "options": ["4", "2", "0", "10"], 'title': '스테이지 10', 'story': '🚨 <strong>[비상 경보: 강제 자폭 시스템 작동]</strong> 🚨<br><br>[시간의-방랑자]: \\"더는 참을 수 없군! 모든 데이터를 시스템을 포맷하겠다! 5분 내로 전부 초기화 시켜주지!\\"<br><br>[크로노스-C]: \\"경고! 시스템 온도 상승 중! 제가 방화벽을 전개할 동안 긴급 수치 입력을 끝내십시오!\\"', 'qtext': '<strong>Q10.</strong> 근의 공식을 사용하여 이차방정식 x² - 3x + 1 = 0 의 근을 구할 때, 분모에 들어갈 값을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '2'", 'hint': '이차방정식의 근의 공식 분모 부분을 구하는 문제로, 분모는 x² 계수의 2배가 됨을 상기시킵니다.', "extra_class": "glitch-bg"},
