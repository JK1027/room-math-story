...
qs = [
    {'qnum': 1, 'title': '스테이지 1', 'story': '[시계탑 태엽장치 크로노스-C]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q1.</strong> 다음 보기 중 이차방정식인 것의 번호를 쓰시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === ''", 'hint': '주어진 등식을 모두 한 변(좌변)으로 이항하여 정리했을 때, (x에 대한 2차식) = 0 꼴이 되는 식을 찾게 합니다.'},
    {'qnum': 2, 'title': '스테이지 2', 'story': '[시계탑 태엽장치 크로노스-C]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q2.</strong> 이차방정식 x² - 4 = 0 의 두 근을 구하시오. (± 기호를 사용하여 구하시오. 예: ±2)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '±2' || ans === '+-2' || ans === '2,-2' || ans === '-2,2'", 'hint': '미지수의 제곱이 상수항과 같음을 이용해, 제곱근의 정의를 활용해 해를 구하도록 안내합니다.'},
    {'qnum': 3, 'title': '스테이지 3', 'story': '[시계탑 태엽장치 크로노스-C]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q3.</strong> x=2 가 이차방정식 x² - ax + 6 = 0 의 한 근일 때, 상수 a의 값을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '5'", 'hint': '이차방정식의 한 근이 주어지면, 그 근의 값을 방정식의 미지수 자리에 대입하여 성립함을 활용하게 지도합니다.'},
    {'qnum': 4, 'title': '스테이지 4', 'story': '[시계탑 태엽장치 크로노스-C]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q4.</strong> 이차방정식 (x-3)(x+2) = 0 의 두 근을 구하시오. (작은 수부터 쉼표로 구분하여 적으시오. 예: -2, 3)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '-2,3'", 'hint': '두 일차식의 곱이 0이 되기 위해서는 각각의 일차식이 0이 되어야 한다는 방정식을 세우게 합니다.'},
    {'qnum': 5, 'title': '스테이지 5', 'story': '[시계탑 태엽장치 크로노스-C]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q5.</strong> 이차방정식 x² - 5x + 6 = 0 의 두 근을 구하시오. (작은 수부터 적으시오. 예: 2, 3)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '2,3'", 'hint': '우변을 0으로 만든 뒤 좌변을 인수분해하여 두 일차식의 곱이 0이 되는 원리로 해를 구하게 유도합니다.'},
    {'qnum': 6, 'title': '스테이지 6', 'story': '[시계탑 태엽장치 크로노스-C]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q6.</strong> 이차방정식 x² - 8x + 16 = 0 의 근을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '4'", 'hint': '좌변이 동일한 두 일차식의 곱(완전제곱식)으로 인수분해될 때 발생하는 중복된 근(중근)의 성질을 설명합니다.'},
    {'qnum': 7, 'title': '스테이지 7', 'story': '[시계탑 태엽장치 크로노스-C]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q7.</strong> 이차방정식 x² + ax + 9 = 0 이 중근을 가질 때, 양수 a의 값을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '6'", 'hint': '이차방정식이 중근을 가질 조건은 상수항이 1차항 계수의 반의 제곱과 같아야 한다는 공식을 적용하게 합니다.'},
    {'qnum': 8, 'title': '스테이지 8', 'story': '[시계탑 태엽장치 크로노스-C]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q8.</strong> 이차방정식 (x-2)² = 5 의 근을 구하시오. (기호 ±와 루트를 사용하여 나타내시오. 예: 2±√5)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '±2√5' || ans === '+-2√5' || ans === '2√5,-2√5' || ans === '-2√5,2√5'", 'hint': '완전제곱식을 이용해 제곱근의 정의를 활용하여 미지수 값의 범위를 구하도록 지도합니다.'},
    {'qnum': 9, 'title': '스테이지 9', 'story': '[시계탑 태엽장치 크로노스-C]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q9.</strong> 이차방정식 x² - 6x + 2 = 0 을 (x-p)² = q 꼴로 고칠 때, 두 상수 p, q에 대하여 p+q의 값을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '8'", 'hint': '상수항을 먼저 우변으로 이항한 후, 좌변을 완전제곱식으로 만들기 위해 양변에 필요한 상수를 더해주는 과정을 안내합니다.'},
    {'qnum': 10, 'title': '스테이지 10', 'story': '[시계탑 태엽장치 크로노스-C]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q10.</strong> 근의 공식을 사용하여 이차방정식 x² - 3x + 1 = 0 의 근을 구할 때, 분모에 들어갈 값을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '2'", 'hint': '이차방정식의 근의 공식 분모 부분을 구하는 문제로, 분모는 x² 계수의 2배가 됨을 상기시킵니다.'},
    {'qnum': 11, 'title': '스테이지 11', 'story': '[시계탑 태엽장치 크로노스-C]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q11.</strong> 이차방정식 x² - 4x - 1 = 0 의 근을 구하시오. (근의 공식을 활용하여 나타내시오. 예: 2±√5)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '±2√5' || ans === '+-2√5' || ans === '2√5,-2√5' || ans === '-2√5,2√5'", 'hint': '인수분해가 되지 않는 경우 근의 공식을 사용하여 해를 대입하여 계산하게 가이드합니다.'},
    {'qnum': 12, 'title': '스테이지 12', 'story': '[시계탑 태엽장치 크로노스-C]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q12.</strong> 이차방정식 2x² + 5x - 3 = 0 의 두 근을 구하시오. (작은 수부터 적으시오. 분수는 슬래시로 표현하시오. 예: -3, 1/2)', 'placeholder': '수식 입력 (예: 1/2 또는 8:27=10:x)', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '-3,1/2'", 'hint': '대각선 곱셈 인수분해 기법을 활용해 좌변을 두 일차식의 곱으로 유도한 후 해를 구하게 합니다.'},
    {'qnum': 13, 'title': '스테이지 13', 'story': '[시계탑 태엽장치 크로노스-C]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q13.</strong> 이차방정식 (x-1)(x-2) = 6 의 두 근을 구하시오. (작은 수부터 적으시오. 예: -1, 4)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '-1,4'", 'hint': '괄호 식을 먼저 모두 전개한 후 모든 항을 한 변으로 이항해 정리하여 이차방정식 기본 형태로 바꾸어 풀게 합니다.'},
    {'qnum': 14, 'title': '스테이지 14', 'story': '[시계탑 태엽장치 크로노스-C]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q14.</strong> 두 근이 -2와 5 이고 x²의 계수가 1인 이차방정식을 구하시오. (예: x²-3x-10=0)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === 'X²-3X-10=0'", 'hint': '두 근이 주어졌을 때 이차방정식의 작성 공식인 (x-a)(x-b) = 0 을 이용하여 전개하도록 지도합니다.'},
    {'qnum': 15, 'title': '스테이지 15', 'story': '[시계탑 태엽장치 크로노스-C]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q15.</strong> 이차방정식 x² + 4x - 5 = 0 의 두 근 중 양수인 근을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '1'", 'hint': '방정식의 해를 구한 후 얻어진 근 중에서 조건에 부합하는 양수 값을 선택하게 안내합니다.'},
    {'qnum': 16, 'title': '스테이지 16', 'story': '[시계탑 태엽장치 크로노스-C]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q16.</strong> 이차방정식 x² - 2x = 0 의 두 근을 구하시오. (작은 수부터 적으시오. 예: 0, 2)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '0,2'", 'hint': '상수항이 0인 경우, 공통인수 x를 묶어내어 간단히 인수분해하여 해를 구하게 유도합니다.'},
    {'qnum': 17, 'title': '스테이지 17', 'story': '[시계탑 태엽장치 크로노스-C]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q17.</strong> 이차방정식 3x² - 7x + 2 = 0 의 두 근 중 정수인 근을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '2'", 'hint': '인수분해를 통해 근을 도출하고, 그 중에서 정수 형태를 가진 근만 선별하도록 가이드합니다.'},
    {'qnum': 18, 'title': '스테이지 18', 'story': '[시계탑 태엽장치 크로노스-C]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q18.</strong> 이차방정식 x² - 6x + 9 = 0 의 중근을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '3'", 'hint': '좌변이 완전제곱식이 되어 한 개의 중근을 가지게 되는 식을 판별하게 유도합니다.'},
    {'qnum': 19, 'title': '스테이지 19', 'story': '[시계탑 태엽장치 크로노스-C]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q19.</strong> 연속하는 두 자연수의 곱이 56일 때, 두 자연수 중 큰 수를 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '8'", 'hint': '두 연속하는 자연수를 x와 x+1 로 두고 곱을 나타내는 방정식을 세워 이차방정식으로 해결하게 유도합니다.'},
    {'qnum': 20, 'title': '스테이지 20', 'story': '[시계탑 태엽장치 크로노스-C]: \\"주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q20.</strong> 지면에서 초속 30m로 똑바로 쏘아 올린 물체의 t초 후의 높이가 30t - 5t² (m)이다. 이 물체의 높이가 40m가 되는 시점은 몇 초 후인지 모두 구하시오. (오름차순으로 적으시오. 예: 2, 4)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '2,4'", 'hint': '높이 식과 목표 수치가 같다는 방정식을 세운 뒤 최고차항의 계수를 간단히 정리하여 해를 구하도록 안내합니다.'}
]
