...
qs = [
    {'qnum': 1, 'title': '딜러의 주사위 분석 1', 'story': '[리퍼-R]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 잭팟의 딜러가 사용하는 6면 주사위가 테이블에 놓여 있습니다. 짝수의 눈이 나와 잭팟의 첫 베팅을 무너뜨리는 경우의 수를 계산해 입력하세요.\\"', 'qtext': '<strong>Q1.</strong> 1에서 6까지 있는 주사위 한 개를 던질 때, 짝수의 눈이 나오는 경우의 수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '틀렸습니다. 짝수는 2, 4, 6입니다.', 'ans_check': "ans === '3'"},
    {'qnum': 2, 'title': '쌍주사위의 전수 조합', 'story': '[리퍼-R]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 잭팟이 두 개의 주사위를 컵에 넣어 흔듭니다. 컵을 열었을 때 발생할 수 있는 전체 눈의 경우의 수(모든 조합)를 구하세요.\\"', 'qtext': '<strong>Q2.</strong> 서로 다른 두 개의 주사위를 동시에 던질 때, 일어날 수 있는 모든 경우의 수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '틀렸습니다. 각 주사위당 6가지씩 동시에 일어나는 경우입니다.', 'ans_check': "ans === '36'"},
    {'qnum': 3, 'title': '동전과 주사위의 링크', 'story': '[리퍼-R]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 동전 1개와 주사위 1개를 룰렛 머신에 동시에 던집니다. 시스템 룰렛 판에 기록될 수 있는 모든 경우의 수는 몇 가지입니까?\\"', 'qtext': '<strong>Q3.</strong> 동전 1개와 주사위 1개를 동시에 던질 때 일어나는 모든 경우의 수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '틀렸습니다. 동전의 경우의 수와 주사위의 경우의 수를 곱해보세요.', 'ans_check': "ans === '12'"},
    {'qnum': 4, 'title': '잭팟의 히든카드 추적', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[잭팟-D]: \\"치지직... 들리십니까...? 리퍼-R의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q4.</strong> 1에서 10까지 적힌 10장의 카드에서 1장을 뽑을 때, 3의 배수가 나오는 경우의 수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '틀렸습니다. 10 이하의 수 중 3의 배수들의 개수입니다.', 'ans_check': "ans === '3'"},
    {'qnum': 5, 'title': '주사위 합의 조작선', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[잭팟-D]: \\"치지직... 들리십니까...? 리퍼-R의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q5.</strong> 두 개의 주사위를 동시에 던질 때, 눈의 합이 4가 되는 경우의 수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '틀렸습니다. 합이 4가 되는 순서쌍 (x, y)의 개수를 구하세요.', 'ans_check': "ans === '3'"},
    {'qnum': 6, 'title': '딜러의 위장 복장', 'story': '[리퍼-R]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 제 2구역: 딜러의 선택입니다. 카지노 딜러의 단상에 상의 3벌과 하의 4벌의 제복이 있습니다. 딜러가 매칭해서 입을 수 있는 총 의상 조합의 수는?\\"', 'qtext': '<strong>Q6.</strong> 상의 3벌, 하의 4벌이 있을 때, 짝을 지어 입는 경우의 수는?', 'placeholder': '숫자만 입력', 'error': '틀렸습니다. 상의 선택과 하의 선택은 연달아 일어나므로 곱의 법칙을 적용합니다.', 'ans_check': "ans === '12'"},
