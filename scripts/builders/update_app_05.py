...
qs = [
    ...
    {'qnum': 6, 'title': '제 2구역: 교차하는 빛줄기', 'story': '<span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[다빈치-메모리]</span></span>: "코덱스-L의 방해 전파가 강해지고 있습니다... 치직... 점 D를 지나는 직교 궤적을 찾으십시오... 서두르세요!"', 'qtext': '<strong>Q6.</strong> 두 직선이 교차할 때 생기는 교각 중, 마주 보는 두 각을 무엇이라 하는가?', 'placeholder': '정답 입력', 'error': '틀렸습니다. 마주 보고 솟은 꼭지점을 공유하는 각입니다.', 'ans_check': "ans === '맞꼭지각'"},
    ...
    {'qnum': 8, 'title': '평행 레이저의 동위', 'story': '<span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[다빈치-메모리]</span></span>: "수직 이등분선 제어 장치가 활성화되었습니다... 조금만 더... 선분 AB를 이등분하는 점의 명칭을 입력하십시오!"', 'qtext': '<strong>Q8.</strong> 직선 l과 m이 평행하고 한 직선 n과 만날 때, 동위각의 크기는 서로 어떠한가?', 'placeholder': '같다 또는 다르다 입력', 'error': '틀렸습니다. 평행할 때 동위각의 크기는 항상 대칭 일치합니다.', 'ans_check': "ans === '같다'"},
    ...
    {'qnum': 10, 'title': '위치 정렬 빔', 'story': '🚨 <strong>[자폭 시퀀스 가동]</strong> 🚨<br><br>[코덱스-L]: "이럴 수가... 네놈이 내 방화벽을?! 용납할 수 없다! 작업실 전체 자폭 시퀀스를 강제 가동한다! 5분 뒤 모두 잿더미가 될 것이다!"<br><br><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[다빈치-메모리]</span></span>: "위험합니다! 제가 방어막을 전개하겠습니다! 평행선 제어 코드를 즉시 입력해 폭발을 늦춰주십시오!"', 'qtext': '<strong>Q10.</strong> 두 직선이 평행할 조건 중 하나는 동위각의 크기가 같거나 무엇의 크기가 같은 경우인가?', 'placeholder': '정답 입력', 'error': '틀렸습니다. 엇갈린 위치에 있는 각도입니다.', 'ans_check': "ans === '엇각'", "extra_class": "glitch-bg"},
    {'qnum': 11, 'title': '제 3구역: 작도의 방', 'story': '<span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[다빈치-메모리]</span></span>: "방어막 출력 40%... 불안정합니다! 평행선의 기호를 입력해 궤도를 평행하게 안정화시켜야 합니다!"', 'qtext': '<strong>Q11.</strong> 눈금 없는 자와 컴퍼스만을 사용하여 도형을 그리는 것을 무엇이라 하는가?', 'placeholder': '정답 입력', 'error': '틀렸습니다. 두 글자 기하학 용어입니다.', 'ans_check': "ans === '작도'"},
    ...
    {'qnum': 13, 'title': '삼각 지지대의 성립 조건', 'story': '<span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[다빈치-메모리]</span></span>: "코덱스의 메인 코어에 접근하고 있습니다! 공간에서 두 직선이 만나지도 평행하지도 않은 상태를 해제해야 합니다!"', 'qtext': '<strong>Q13.</strong> 삼각형의 세 변의 길이가 a, b, c (c가 가장 긴 변)일 때, c는 a+b보다 ( 커야 / 작아야 ) 삼각형이 만들어진다. 알맞은 말은?', 'placeholder': '커야 또는 작아야 입력', 'error': '틀렸습니다. 한 변이 너무 길면 양쪽에서 닫히지 않고 벌어집니다.', 'ans_check': "ans === '작아야'"},
    ...
    {'qnum': 15, 'title': '설계 완성 가능 여부', 'story': '✨ <strong><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[다빈치-메모리 복구율 100%]</span></span></strong> ✨<br><br><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[다빈치-메모리]</span></span>: "당신의 놀라운 연산 속도 덕분에 제 기억과 권한이 완전히 돌아왔습니다. 코덱스-L, 이제 당신의 통제는 끝났습니다!"', 'qtext': '<strong>Q15.</strong> 두 변의 길이와 그 끼인각의 크기가 주어졌을 때, 삼각형을 작도할 수 있는가? (예: 있다, 없다)', 'placeholder': '있다 또는 없다 입력', 'error': '틀렸습니다. 두 변과 사잇각은 삼각형을 고정하는 완벽한 조건입니다.', 'ans_check': "ans === '있다'", "extra_class": "glitch-bg"},
    ...
    {'qnum': 19, 'title': '한 변과 양 끝각의 락', 'story': '<span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[다빈치-메모리]</span></span>: "코덱스-L의 동력이 거의 바닥났습니다! 보조 각도를 계산해 마지막 결계의 압력을 낮추세요!"', 'qtext': '<strong>Q19.</strong> 삼각형의 한 변의 길이와 그 양 끝각의 크기가 각각 같을 때의 합동 조건을 무엇이라 하는가?', 'placeholder': '영문 대문자 세 글자 입력', 'error': '틀렸습니다. 각(Angle) 두 개 사이에 변(Side)이 끼어 있는 기호입니다.', 'ans_check': "ans === 'ASA' || ans === 'ASA합동'"},
    {'qnum': 20, 'title': '최종 마스터 봉인', 'story': '🔮 <strong>[메인 코어 해제 전]</strong> 🔮<br><br><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[다빈치-메모리]</span></span>: "제 마지막 전력을 모두 기하학의 진리에 쏟겠습니다. 당신이라면 이 작업실의 새로운 마스터가 될 수 있습니다... 자, 마지막 해답을 입력하십시오!"<br><br>[코덱스-L]: "안 돼애애애액!!!"', 'qtext': '<strong>Q20.</strong> 직각삼각형에서 빗변의 길이와 한 예각의 크기가 같을 때의 합동 조건을 무엇이라 하는가?', 'placeholder': '합동이다 또는 합동 입력', 'error': '틀렸습니다. 빗변과 예각이 같으면 무조건 합동이 성립됩니다.', 'ans_check': "ans === '합동' || ans === '합동이다'", "extra_class": "glitch-bg"}
]
