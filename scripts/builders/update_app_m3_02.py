...
qs = [
    {'qnum': 1, "options": ["10", "3", "7", "5"], 'title': '스테이지 1', 'story': '[흑마법사-M]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q1.</strong> (x+2)(x+3) 을 전개했을 때, x의 계수를 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '5'", 'hint': '(x+a)(x+b) = x² + (a+b)x + ab 공식을 이용하여 x항의 계수가 두 상수의 합과 같음을 인지시킵니다.'},
    {'qnum': 2, "options": ["X²+6X+9", "X²+6X+9 아님", "알 수 없음", "해 없음"], 'title': '스테이지 2', 'story': '[흑마법사-M]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q2.</strong> (x+3)² 을 전개한 식을 구하시오. (예: x²+6x+9)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === 'X²+6X+9'", 'hint': '완전제곱식 공식 (a+b)² = a² + 2ab + b² 을 적용하여 전개하도록 지도합니다.'},
    {'qnum': 3, "options": ["4A²-4AB+B²", "4A²-4AB+B² 아님", "알 수 없음", "해 없음"], 'title': '스테이지 3', 'story': '[흑마법사-M]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q3.</strong> (2a-b)² 을 전개한 식을 구하시오. (예: 4a²-4ab+b²)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '4A²-4AB+B²'", 'hint': '완전제곱식 공식 (a-b)² = a² - 2ab + b² 을 적용하되 앞 항의 계수 제곱에 주의하도록 가이드합니다.'},
    {'qnum': 4, "options": ["X²-16", "X²-16 아님", "알 수 없음", "해 없음"], 'title': '스테이지 4', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[알케미-H]: \\"치지직... 들리십니까...? 흑마법사-M의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q4.</strong> (x+4)(x-4) 을 전개한 식을 구하시오. (예: x²-16)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === 'X²-16'", 'hint': '합차 공식 (a+b)(a-b) = a² - b² 을 적용하도록 안내합니다.'},
    {'qnum': 5, "options": ["-17", "-30", "-13", "-15"], 'title': '스테이지 5', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[알케미-H]: \\"치지직... 들리십니까...? 흑마법사-M의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q5.</strong> (x-3)(x+5) 을 전개했을 때, 상수항의 값을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '-15'", 'hint': '다항식 전개 시 상수항은 두 일차식의 상수항끼리의 곱과 같음을 설명합니다.'},
    {'qnum': 6, "options": ["-3", "-1", "1", "-2"], 'title': '스테이지 6', 'story': '[흑마법사-M]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q6.</strong> (2x+1)(3x-2) 을 전개했을 때, x의 계수를 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '-1'", 'hint': '(ax+b)(cx+d) = acx² + (ad+bc)x + bd 공식을 적용하여 x항의 계수를 대각선 곱셈의 합으로 구하게 합니다.'},
    ...
    {'qnum': 8, "options": ["2AB", "2AB 아님", "알 수 없음", "해 없음"], 'title': '스테이지 8', 'story': '[흑마법사-M]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q8.</strong> 다항식 2a²b - 4ab² 을 인수분해할 때, 꺼내야 할 가장 큰 공통인수를 구하시오. (예: 2ab)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '2AB'", 'hint': '두 항에 공통으로 곱해진 약수(인수)를 계수와 문자별로 쪼개어 가장 큰 형태로 묶어내게 가이드합니다.'},
    ...
    {'qnum': 16, "options": ["6", "1", "3", "5"], 'title': '스테이지 16', 'story': '[흑마법사-M]: \\"아직 끝나지 않았다! 내 최고의 방해 암호를 해독해 보아라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q16.</strong> 다항식 3x² - 12 를 인수분해한 식을 구하시오. (공통인수를 먼저 묶어내어 계산하시오. 예: 3(x+2)(x-2))', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '3'", 'hint': '먼저 모든 항에 공통으로 곱해져 있는 공통인수를 밖으로 완전히 묶어낸 후, 남은 다항식을 추가로 인수분해합니다.'},
