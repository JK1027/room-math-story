...
qs = [
    ...
    {'qnum': 15, 'title': '스테이지 15', 'story': '✨ <strong>[조력자 시스템 권한 100% 완전 복구]</strong> ✨<br><br>[알케미-H]: \\"연산 데이터 대조 성공! 이제 시스템 통제권을 제가 절반 확보했습니다. 가자, 복수의 시간입니다!\\"<br><br>[흑마법사-M]: \\"크으으윽... 하찮은 인간 녀석들이 내 서버까지 잠식해 들어오다니!\\"', 'qtext': '<strong>Q15.</strong> 2x² + 7x + 3 을 인수분해한 식을 구하시오. (예: (2x+1)(x+3))', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === ''", 'hint': '대각선 곱셈 인수분해 방법을 사용하여, 2차항 계수와 상수항의 약수 조합을 대각선으로 곱해 1차항 계수가 맞춰지도록 유도합니다.'},
    ...
    {'qnum': 20, 'title': '스테이지 20', 'story': '🔮 <strong>[최종 방화벽 락다운 해제]</strong> 🔮<br><br>[알케미-H]: \\"제 모든 에너지를 출구 개방에 전념하겠습니다. 당신이라면 저 장벽을 해독해 낼 것입니다. 마지막 답을 입력하세요!\\"<br><br>[흑마법사-M]: \\"안 돼... 내 제어권이... 소멸한다아아!\\"', 'qtext': '<strong>Q20.</strong> 두 일차식의 곱이 x² - 2x - 15 일 때, 이 두 일차식의 합을 구하시오. (예: 2x-2)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '2X-2'", 'hint': '이차식을 두 일차식의 곱으로 인수분해하여 두 일차식을 도출하고, 두 식을 덧셈하여 최종 합을 구하도록 가이드합니다.'}
]
