...
qs = [
    {'qnum': 1, 'title': '스테이지 1', 'story': '[재머-J]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q1.</strong> 다음 보기 중 y가 x에 대한 이차함수인 것의 번호를 쓰시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === ''", 'hint': 'y = ax² + bx + c (a ≠ 0) 형태로 우변이 x에 대한 2차식인 함수를 고르게 유도합니다.'},
    {'qnum': 2, 'title': '스테이지 2', 'story': '[재머-J]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q2.</strong> 이차함수 y=3x² 그래프의 꼭짓점 좌표를 구하시오. (괄호를 포함하여 적으시오. 예: (0,0))', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === ''", 'hint': '기본형 y = ax² 의 꼭짓점 좌표는 항상 원점 (0,0)임을 설명합니다.'},
    {'qnum': 3, "options": ["X=0", "X=0 아님", "알 수 없음", "해 없음"], 'title': '스테이지 3', 'story': '[재머-J]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q3.</strong> 이차함수 y=-2x² 그래프의 대칭축(축의 방정식)을 구하시오. (예: x=0)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === 'X=0'", 'hint': '기본형 y = ax² 그래프의 대칭축은 y축이며, 그 직선의 방정식을 식으로 표현하게 가이드합니다.'},
    {'qnum': 4, "options": ["4", "2", "0", "10"], 'title': '스테이지 4', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[이글-E]: \\"치지직... 들리십니까...? 재머-J의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q4.</strong> 이차함수 y=ax² 의 그래프가 점 (2,8) 을 지날 때, 상수 a의 값을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '2'", 'hint': '함수식의 x와 y 자리에 주어진 좌표값을 대입하여 미지수 a를 구합니다.'},
    {'qnum': 5, "options": ["Y=X²+3", "Y=X²+3 아님", "알 수 없음", "해 없음"], 'title': '스테이지 5', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[이글-E]: \\"치지직... 들리십니까...? 재머-J의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q5.</strong> 이차함수 y=x² 의 그래프를 y축의 양의 방향으로 3만큼 평행이동한 그래프의 식을 구하시오. (예: y=x²+3)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === 'Y=X²+3'", 'hint': 'y = ax² 그래프를 y축 방향으로 q만큼 평행이동하면 식은 y = ax² + q 가 됨을 상기시킵니다.'},
    {'qnum': 6, 'title': '스테이지 6', 'story': '[재머-J]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q6.</strong> 이차함수 y=3(x-1)² 그래프의 꼭짓점 좌표를 구하시오. (예: (1,0))', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === ''", 'hint': 'y = a(x-p)² 형태의 꼭짓점은 x축 위에 위치하게 됨을 설명합니다.'},
    ...
    {'qnum': 8, "options": ["X=-3", "X=-3 아님", "알 수 없음", "해 없음"], 'title': '스테이지 8', 'story': '[재머-J]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q8.</strong> 이차함수 y=2(x+3)² - 5 그래프의 대칭축의 방정식을 구하시오. (예: x=-3)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === 'X=-3'", 'hint': '표준형 y = a(x-p)² + q 의 대칭축 방정식은 꼭짓점의 x좌표 값과 같음을 상기시킵니다.'},
    {'qnum': 9, "options": ["6", "1", "3", "5"], 'title': '스테이지 9', 'story': '[재머-J]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q9.</strong> 이차함수 y=(x-1)² + 2 그래프가 y축과 만나는 점의 y좌표를 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '3'", 'hint': '그래프가 y축과 만나는 점(y절편)은 x = 0 일 때의 y값이므로 x 자리에 0을 대입하여 계산합니다.'},
    {'qnum': 10, "options": ["Y=X²", "Y=X² 아님", "알 수 없음", "해 없음"], 'title': '스테이지 10', 'story': '🚨 <strong>[비상 경보: 강제 자폭 시스템 작동]</strong> 🚨<br><br>[재머-J]: \\"더는 참을 수 없군! 모든 데이터를 시스템을 포맷하겠다! 5분 내로 전부 초기화 시켜주지!\\"<br><br>[이글-E]: \\"경고! 시스템 온도 상승 중! 제가 방화벽을 전개할 동안 긴급 수치 입력을 끝내십시오!\\"', 'qtext': '<strong>Q10.</strong> 이차함수 y=-x² 의 그래프와 x축에 대하여 서로 대칭인 그래프의 식을 구하시오. (예: y=x²)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === 'Y=X²'", 'hint': '두 그래프가 x축 대칭이려면 x²의 계수인 a의 부호만 반대가 되어야 함을 인지시킵니다.', "extra_class": "glitch-bg"},
    {'qnum': 11, "options": ["4", "6", "8", "12"], 'title': '스테이지 11', 'story': '[이글-E]: \\"방어막 출력 한계 도달 중! 코드를 지속적으로 갱신해야 폭발을 유예할 수 있습니다! 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q11.</strong> 이차함수 y=x² - 4x + 7 을 표준형 y=a(x-p)²+q 꼴로 나타낼 때, 세 상수 a, p, q에 대하여 a+p+q의 값을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '6'", 'hint': '이차식을 완전제곱식 y = a(x-p)² + q 형태로 변형하여 꼭짓점의 정보(p, q)와 최고차항 계수 a의 합을 구합니다.'},
