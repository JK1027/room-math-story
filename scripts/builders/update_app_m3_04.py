...
qs = [
    ...
    {'qnum': 3, 'title': '스테이지 3', 'story': '[재머-J]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 주어진 단서를 해결하여 방의 봉인을 해제하세요.\\"', 'qtext': '<strong>Q3.</strong> 이차함수 y=-2x² 그래프의 대칭축(축의 방정식)을 구하시오. (예: x=0)', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === 'X=0'", 'hint': '기본형 y = ax² 그래프의 대칭축은 y축이며, 그 직선의 방정식을 식으로 표현하게 가이드합니다.'},
    {'qnum': 4, 'title': '스테이지 4', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[이글-E]: \\"치지직... 들리십니까...? 재머-J의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q4.</strong> 이차함수 y=ax² 의 그래프가 점 (2,8) 을 지날 때, 상수 a의 값을 구하시오.', 'placeholder': '정답 입력', 'error': '정답이 올바르지 않습니다. 다시 계산해보세요.', 'ans_check': "ans === '2'", 'hint': '함수식의 x와 y 자리에 주어진 좌표값을 대입하여 미지수 a를 구합니다.'},
