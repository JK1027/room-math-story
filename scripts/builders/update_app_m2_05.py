...
<body>
    ...
    <div class="container">
        ...
        <div id="outro" class="glass-panel">
            ...
            <div class="story-box">
                <div class="story-text" id="outro-dynamic-text">
                [자율주행 관제 로봇 루트-R]: "정확히 10분을 입력하자 내비게이션이 정상 궤도를 회복했습니다! 택시가 절벽을 아슬아슬하게 피하며 네오 서울 중앙역에 부드럽게 멈춰 섭니다. 일차함수의 <span class="dynamic-captain-name">마법사</span> 여러분, 무사 생환을 축하합니다!"
                </div>
            </div>
            <div class="btn-group">
