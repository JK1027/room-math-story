...
qs = [
    {'qnum': 1, "options": ["함수", "함수 아님", "알 수 없음", "해 없음"], 'title': '시스템 함수 정의', 'story': '[시스템-에러]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 자율주행 택시의 제어 콘솔이 겨우 켜졌습니다. 시스템 복구의 첫 단계로, 독립 변수 $x$에 따른 종속 변수 $y$의 기본 연결 관계인 함수의 개념을 규정해야 합니다.\\"', 'qtext': '<strong>Q1.</strong> 두 변수 $x, y$ 에 대하여 $x$의 값이 정해짐에 따라 $y$의 값이 오직 하나씩 정해지는 관계가 있을 때, $y$를 $x$의 무엇이라 하는가?', 'placeholder': '두 글자 입력', 'error': '시스템 용어가 올바르지 않습니다. 두 글자 명사입니다.', 'ans_check': "ans === '함수'"},
    {'qnum': 2, "options": ["10", "3", "7", "5"], 'title': '기본 궤적 연산', 'story': '[시스템-에러]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 기본 주행 함수 $f(x)=2x-3$이 활성화되었습니다. 입력 신호 $x=4$에 도달했을 때 출력 전압(함숫값)의 세기를 계산하여 장치를 구동시키세요.\\"', 'qtext': '<strong>Q2.</strong> 함수 $f(x) = 2x - 3$ 에서 $x=4$ 일 때의 함숫값 $f(4)$ 를 구하시오.', 'placeholder': '숫자만 입력', 'error': '연산 결과가 올바르지 않습니다. $2 \\times 4 - 3$을 다시 계산해보세요.', 'ans_check': "ans === '5'"},
    {'qnum': 3, "options": ["10", "3", "7", "5"], 'title': '속도 제어 밸브', 'story': '[시스템-에러]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 엔진의 안전 속도를 계산하는 시스템 함수 식을 점검합니다. 입력값이 2일 때 제어 장치의 밸브 값 $f(2)$를 정확하게 입력창에 전송하세요.\\"', 'qtext': '<strong>Q3.</strong> 함수 $f(x) = \\frac{10}{x}$ 에서 $f(2)$ 의 값을 구하시오.', 'placeholder': '숫자만 입력', 'error': '출력 전압이 맞지 않습니다. 10을 2로 나누어보세요.', 'ans_check': "ans === '5'"},
    {'qnum': 4, "options": ["$y"], 'title': '일차함수 판별', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[루트-R]: \\"치지직... 들리십니까...? 시스템-에러의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q4.</strong> 다음 중 일차함수인 것은? (1) $y = \\frac{3}{x}$ (2) $y = x^2$ (3) $y = 3x - 1$ (4) $y = 5$', 'placeholder': '번호만 입력 (예: 3)', 'error': '오류 패킷입니다. $y = ax + b$ (단, $a \\neq 0$) 형태의 식을 찾으세요.', 'ans_check': "ans === '3' || ans === '(3)'"},
    {'qnum': 5, "options": ["Y=4X-2", "Y=4X-2 아님", "알 수 없음", "해 없음"], 'title': '궤적 평행이동', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[루트-R]: \\"치지직... 들리십니까...? 시스템-에러의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q5.</strong> 일차함수 $y = 4x$ 의 그래프를 $y$축의 방향으로 -2만큼 평행이동한 그래프의 식을 구하시오.', 'placeholder': '예: y = 4x - 2', 'error': '수식이 올바르지 않습니다. 평행이동한 만큼 상수항을 붙여 완성하세요.', 'ans_check': "ans.replace(/\\s+/g, '') === 'Y=4X-2'"},
    {'qnum': 6, "options": ["X절편", "X절편 아님", "알 수 없음", "해 없음"], 'title': '축 교점 분석', 'story': '[시스템-에러]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 택시 궤적이 모니터의 중심축인 $x$축과 정확히 만나는 지점을 계측해야 우회 도로에 안착합니다. 그래프가 $x$축과 만나는 교점의 $x$좌표를 일컫는 수학적 명칭을 찾아내세요.\\"', 'qtext': '<strong>Q6.</strong> 일차함수의 그래프가 $x$축과 만나는 점의 $x$좌표를 무엇이라 하는가?', 'placeholder': '세 글자 입력', 'error': '올바른 명칭이 아닙니다. x...?', 'ans_check': "ans === 'X절편' || ans === '엑스절편'"},
