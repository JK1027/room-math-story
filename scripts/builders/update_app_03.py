...
custom_hints = {
    ...
    20: "추가할 희석수(물)의 양을 x g으로 둡니다. 연료 희석 전과 희석 후의 원액(소금)의 양은 보존됩니다. 처음 10% 연료 300g에 포함된 연료 원액의 양(300 × 0.1)과, 물을 섞어 6%가 된 연료 (300 + x)g에 포함된 원액의 양이 같다는 식을 세워 해결해 보세요."
}
for q in qs:
