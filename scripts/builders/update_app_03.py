...
qs = [
    {'qnum': 1, "options": ["3a^2b", "3a^2b 아님", "알 수 없음", "해 없음"], 'title': '단순화 코드 전송', 'story': '[바이러스-V]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? <span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[오라클-X]</span></span></span>: "전송 코드가 복잡해 병목 현상이 발생합니다. 곱셈 기호를 생략하고 거듭제곱으로 간결하게 압축하십시오."\\"', 'qtext': '<strong>Q1. [문자의 사용]</strong><br>a × b × a × 3 을 곱셈 기호를 생략하고 거듭제곱을 사용하여 간단히 나타내시오.', 'placeholder': '예: 5x^2y', 'error': '구문 오류! 시스템 연결 실패!', 'ans_check': "ans === '3a^2b' || ans === '3ba^2'"},
    {'qnum': 2, "options": ["5x+1000", "5x+1000 아님", "알 수 없음", "해 없음"], 'title': '전력 요구 식 세우기', 'story': '[바이러스-V]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? <span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[오라클-X]</span></span></span>: "소형 포드 5개, 대형 포드 1개의 총 에너지 요구량을 미지수 x를 사용해 정확한 다항식으로 산출하십시오."\\"', 'qtext': '<strong>Q2. [식 세우기]</strong><br>소형 포드 1개 작동에 x kW, 대형 포드 1개 작동에 1000 kW가 듭니다. 소형 포드 5개와 대형 포드 1개를 동시에 작동할 때 필요한 총 전력량을 x에 대한 식으로 나타내시오.', 'placeholder': '예: 3x+500', 'error': '에너지 초과 경고!', 'ans_check': "ans === '5x+1000' || ans === '1000+5x'"},
    {'qnum': 3, "options": ["-3", "-1", "1", "-2"], 'title': '냉각수 계수 대입', 'story': '[바이러스-V]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? <span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[오라클-X]</span></span></span>: "현재 엔진 온도 x = -2입니다. 3x + 5 식에 대입해 냉각 시스템 계수를 계산하십시오."\\"', 'qtext': '<strong>Q3. [식의 값]</strong><br>x = -2 일 때, 대입 식 3x + 5 의 값을 구하시오.', 'placeholder': '숫자만 입력', 'error': '냉각수 부족! 온도가 상승합니다!', 'ans_check': "ans === '-1'"},
    {'qnum': 4, "options": ["-3", "-10", "-7", "-5"], 'title': '증폭 계수 추출', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[오라클-X]</span></span></span>: \\"치지직... 들리십니까...? 바이러스-V의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q4. [다항식과 일차식]</strong><br>다항식 2x² - 5x + 3 에서 x의 계수를 구하시오. (부호 포함)', 'placeholder': '숫자만 입력', 'error': '증폭 계수 불일치! 차단벽 가동!', 'ans_check': "ans === '-5'"},
    {'qnum': 5, "options": ["8x-12", "8x-12 아님", "알 수 없음", "해 없음"], 'title': '예비 회로 분배 결합', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[오라클-X]</span></span></span>: \\"치지직... 들리십니까...? 바이러스-V의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q5. [일차식의 계산 1]</strong><br>식 3(2x - 4) + 2x 를 분배법칙을 활용해 간단히 정리한 식을 입력하시오.', 'placeholder': '예: 5x-7', 'error': '회로 쇼트 경고! 전력 누출!', 'ans_check': "ans === '8x-12'"},
    {'qnum': 6, "options": ["3x-2", "3x-2 아님", "알 수 없음", "해 없음"], 'title': '서브 전압 분배기', 'story': '[바이러스-V]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! <span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[오라클-X]</span></span></span>: "전력 노드의 전압 (6x - 4)를 2로 나누어 서브 배터리에 과부하 없이 분배하십시오."\\"', 'qtext': '<strong>Q6. [일차식의 나눗셈]</strong><br>식 (6x - 4) ÷ 2 를 간단히 한 식을 입력하시오.', 'placeholder': '예: 2x-5', 'error': '배터리 과부하! 전력이 역류합니다!', 'ans_check': "ans === '3x-2'"},
    {'qnum': 7, "options": ["x-6", "x-6 아님", "알 수 없음", "해 없음"], 'title': '주파수 대역 통분 동기화', 'story': '[바이러스-V]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! <span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[오라클-X]</span></span></span>: "분수 형태의 두 전파 동기화 신호를 통분 계산해 최적의 통신 주파수 식을 찾아내십시오."\\"', 'qtext': '<strong>Q7. [일차식의 계산 2]</strong><br>식 1/2(4x - 6) - 1/3(3x + 9) 를 계산하여 간단히 하시오.', 'placeholder': '예: 2x-8', 'error': '주파수 왜곡! 동기화 실패!', 'ans_check': "ans === 'x-6'"},
    ...
    {'qnum': 14, 'title': '미지수/상수 이항 격리', 'story': '<span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[오라클-X]</span></span></span>: \\"방어막 출력 한계 도달 중! 코드를 지속적으로 갱신해야 폭발을 유예할 수 있습니다! <span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[오라클-X]</span></span></span>: "미지수 항과 상수 항을 각 변으로 완벽히 격리하여 3x - 2 = x + 6 방정식의 해를 연산하십시오."\\"', 'qtext': '<strong>Q14. [일차방정식 3]</strong><br>방정식 3x - 2 = x + 6 의 해를 구하시오.', 'placeholder': '숫자만 입력', 'error': '격리 실패! 동력원 손상!', 'ans_check': "ans === '4'"},
    {'qnum': 15, 'title': '비례식 펌프 동력비', 'story': '✨ <strong><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[조력자 시스템 권한 100% 완전 복구]</span></span></span></strong> ✨<br><br><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[오라클-X]</span></span></span>: \\"연산 데이터 대조 성공! 이제 시스템 통제권을 제가 절반 확보했습니다. 가자, 복수의 시간입니다!\\"<br><br>[바이러스-V]: \\"크으으윽... 하찮은 인간 녀석들이 내 서버까지 잠식해 들어오다니!\\"', 'qtext': '<strong>Q15. [비례식 풀이]</strong><br>비례식 (x - 1) : 2 = (2x + 1) : 5 을 만족하는 해 x의 값을 구하시오.', 'placeholder': '숫자만 입력', 'error': '비율 붕괴! 기어 훼손 경고!', 'ans_check': "ans === '7'", "extra_class": "glitch-bg"},
    {'qnum': 16, 'title': '사출 궤도 충돌 방지', 'story': '[바이러스-V]: \\"아직 끝나지 않았다! 내 최고의 방해 암호를 해독해 보아라! <span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[오라클-X]</span></span></span>: "연속하는 세 자연수의 합이 36입니다. 포드 충돌을 막기 위해 가장 큰 자연수 번호를 계산하십시오."\\"', 'qtext': '<strong>Q16. [연속하는 세 수]</strong><br>연속하는 세 자연수의 합이 36일 때, 세 자연수 중 가장 큰 자연수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '궤도 겹침 감지! 발사 중단!', 'ans_check': "ans === '13'"},
