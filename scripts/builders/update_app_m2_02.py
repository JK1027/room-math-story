...
qs = [
    ...
    {'qnum': 2, "options": ["X^10", "X^10 아님", "알 수 없음", "해 없음"], 'title': '제어 축 부스트', 'story': '[바이러스-K]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? ⚙️ <strong>[동력 증폭]</strong><br><br>[도시 관제 AI 기어즈-C]: \\"기어가 회전하면서 지수 증폭이 일어납니다. $(x^2)^5$ 의 팽창 수치를 계산해 다음 동력 축으로 연결하십시오.\\"\\"', 'qtext': '<strong>Q2. [지수의 거듭제곱]</strong><br>$(x^2)^5$ 를 간단히 하시오.', 'placeholder': '예: x^10', 'error': '축 토크 부족! 기어가 공전합니다.', 'ans_check': "ans === 'X^10' || ans === 'X**10'"},
