...
qs = [
    ...
    {'qnum': 5, "options": ["21", "23", "46", "25"], 'title': '경미 지역 추적', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[왓슨-X]: \\"치지직... 들리십니까...? 모리아티-AI의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q5. [순위 데이터]</strong><br>소매치기 발생 건수가 적은 쪽에서 3번째인 지역의 건수는 얼마인가?', 'placeholder': '숫자 또는 건 입력', 'error': '수치 불일치! 정렬 순서가 꼬였습니다.', 'ans_check': "ans === '23' || ans === '23건'", 'hint': '데이터를 크기 순서대로 정렬했을 때 세 번째로 작은 건수 값을 찾습니다.'},
    {'qnum': 6, "options": ["계급", "계급 아님", "알 수 없음", "해 없음"], 'title': '제2구역: 계급 분류', 'story': '[모리아티-AI]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! [왓슨-X]: "20명의 용의자 나이 변량을 일정한 간격으로 나눈 이 구간들을 무엇이라 합니까?"\\"', 'qtext': '<strong>Q6. [계급의 정의]</strong><br>자료를 몇 개의 구간으로 나눌 때, 이 구간을 무엇이라 하는가?', 'placeholder': '한글 단어 입력', 'error': '기초 통계 용어 오류! 결계가 열리지 않습니다.', 'ans_check': "ans === '계급'", 'hint': '수집된 변량을 일정한 간격으로 나눈 구간을 가리키는 통계 용어입니다.'},
    {'qnum': 7, "options": ["도수", "도수 아님", "알 수 없음", "해 없음"], 'title': '도수의 정의', 'story': '[모리아티-AI]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! [왓슨-X]: "그 나이 구간(계급) 각각에 할당 분류된 인원수(자료의 수)를 일컫는 통계 용어는?"\\"', 'qtext': '<strong>Q7. [도수의 정의]</strong><br>각 계급에 속하는 변량의 개수를 무엇이라 하는가?', 'placeholder': '한글 단어 입력', 'error': '마나 입력 오류! 올바른 한글 용어를 쓰십시오.', 'ans_check': "ans === '도수'", 'hint': '각 계급 구간에 속해 있는 자료(변량)의 개수를 의미하는 용어입니다.'},
    {'qnum': 8, "options": ["8", "10", "20", "12"], 'title': '계급의 폭', 'story': '[모리아티-AI]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! [왓슨-X]: "나이 분류표 상 10대, 20대 등으로 나뉘어 있을 때, 이 각 나이 구간 너비(계급의 크기)는 얼마인가요?"\\"', 'qtext': '<strong>Q8. [계급의 크기]</strong><br>계급의 너비(크기)는 얼마인가? (자료: 10대, 20대 식일 때의 너비)', 'placeholder': '숫자만 입력', 'error': '너비 부조화! 구간 세그먼트가 틀어졌습니다.', 'ans_check': "ans === '10' || ans === '10세'", 'hint': '한 계급 구간의 너비(끝값 - 시작값)를 계산하여 단위를 포함하지 않은 값을 적습니다.'},
    {'qnum': 9, "options": ["20대", "20대 아님", "알 수 없음", "해 없음"], 'title': '최대 나이 도수', 'story': '[모리아티-AI]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! [왓슨-X]: "용의자 분포 중, 도수가 8명으로 가장 높은 도수를 보이는 용의자 나이 계급은? (예: 20대)"\\"', 'qtext': '<strong>Q9. [최대 도수 계급]</strong><br>도수가 가장 큰 계급은 어느 연령대인가? (자료: 10대: 4명, 20대: 8명, 30대: 5명, 40대: 3명)', 'placeholder': '예: 20대', 'error': '용의자 타겟팅 오류!', 'ans_check': "ans === '20대'", 'hint': '도수(인원수)가 8명으로 가장 많이 몰려 있는 나이대 계급을 찾습니다.'},
