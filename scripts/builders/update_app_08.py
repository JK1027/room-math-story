...
qs = [
    {'qnum': 1, "options": ["3,4,7", "3,4,7 아님", "알 수 없음", "해 없음"], 'title': '잎의 복원', 'story': '''<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모리아티-AI]</span>: "크하하! 런던 통계국의 모든 메인 차분기관은 내 손안에 있다! 셜록 홈즈의 풋내기 조수 녀석들이 감히 통계 방화벽을 뚫으려 하다니! 장부를 찢어 흩뜨려 놓겠다!"<br><br><i>치이이- 스팀파이프에서 연기가 뿜어 나오며 통계 스크린에 깨진 데이터 테이블이 노출됩니다. 소매치기 발생 장부에서 줄기가 2인 잎의 목록을 순서대로 정렬해 전송해야 락이 해제됩니다.</i><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[왓슨-X]</span>: "조사관님! 차분기관 데이터 스트림이 오염되고 있습니다. 줄기가 2인 잎 데이터를 신속히 나열하여 정렬 필터를 가동해 주십시오!"''', 'qtext': '<strong>Q1. [줄기와 잎 그림]</strong><br>위 자료를 줄기와 잎 그림으로 나타낼 때, 줄기가 2인 잎을 쉼표(,)로 구분하여 크기 순으로 모두 적으시오.', 'placeholder': '예: 3, 4, 7', 'error': '장부 판독 실패! 잎을 다시 세십시오.', 'ans_check': "ans === '3,4,7' || ans === '3, 4, 7' || ans === '347'", 'hint': '줄기가 2인 데이터 변량들의 일의 자리 숫자들을 차례대로 나열해 줍니다.'},
    {'qnum': 2, "options": ["8", "10", "20", "12"], 'title': '변량 개수', 'story': '''<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모리아티-AI]</span>: "데이터 왜곡 흔적을 겨우 한 줄 찾았을 뿐이다! 수집된 장부 상의 전체 변량 표본 개수가 어긋나면 차분기관의 동력 기어가 역회전해 폭발하리라!"<br><br><i>드르륵- 피스톤 크랭크가 고속으로 맞물리며 마모 진동이 전달됩니다. 전체 변량 데이터 개수를 산출하십시오.</i><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[왓슨-X]</span>: "피스톤 기어가 과열되고 있습니다! 수집된 진짜 변량 표본의 개수를 구해 압력 방출 다이얼에 입력해 주십시오!"''', 'qtext': '<strong>Q2. [변량의 개수]</strong><br>위 자료에서 전체 변량의 개수는 몇 개인가?', 'placeholder': '숫자 또는 개수 입력', 'error': '변량 개수 불일치! 장부의 줄 수가 다릅니다.', 'ans_check': "ans === '10' || ans === '10개'", 'hint': '수집된 전체 데이터 샘플의 개수가 모두 몇 개인지 직접 세어 봅니다.'},
    {'qnum': 3, "options": ["2와3", "2와3 아님", "알 수 없음", "해 없음"], 'title': '최대 분포 줄기', 'story': '''<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모리아티-AI]</span>: "오답 제출 시 밸브가 막히도록 세팅했다. 잎이 가장 집중 분포된 줄기 번호를 찾아내지 못한다면 증기 고압 가스가 방 안을 가득 메우리라!"<br><br><i>쉬이이익- 밸브 틈새로 뜨겁고 탁한 증기 기포가 새어 나오기 시작합니다. 잎의 밀도가 최고치인 줄기 번호들을 입력하여 차단하십시오.</i><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[왓슨-X]</span>: "호흡 필터를 전개했습니다! 잎이 가장 많이 분포하는 핵심 줄기 코드를 입력하여 밸브를 격리 차단해 주십시오!"''', 'qtext': '<strong>Q3. [최다 잎 줄기]</strong><br>위 자료에서 잎이 가장 많은 줄기는 무엇인가?', 'placeholder': '예: 2, 3', 'error': '탐색 실패! 잎의 최대 개수가 매칭되지 않습니다.', 'ans_check': "ans === '2와3' || ans === '2,3' || ans === '2, 3'", 'hint': '줄기와 잎 그림에서 잎(오른쪽 숫자)의 개수가 가장 많이 늘어선 줄기 번호를 찾습니다.'},
    {'qnum': 4, "options": ["10", "3", "7", "5"], 'title': '우범 구역 식별', 'story': '''<strong>[시스템 통신 채널 스파크 노이즈]</strong><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[왓슨-X]</span>: "치지직... 셜록 조수님! 모리아티-AI가 연산 버스를 해킹하여 데이터 전송 전하를 비틀었습니다! 소매치기 다발 30건 이상 구역 개수를 식별해 무력화 암호 펄스를 인젝션해야 합니다!"''', 'qtext': '<strong>Q4. [조건 필터링]</strong><br>소매치기 발생 건수가 30건 이상인 지역은 몇 곳인가?', 'placeholder': '숫자 또는 곳 입력', 'error': '구역 필터링 개수가 달라 통신 오류가 발생합니다!', 'ans_check': "ans === '5' || ans === '5곳'", 'hint': '30 이상인 숫자(31, 31, 35, 42, 45)가 모두 몇 개인지 개수를 셉니다.'},
    {'qnum': 5, "options": ["21", "23", "46", "25"], 'title': '경미 지역 추적', 'story': '''🚨 <strong>[비상 로그: 배전반 전하 역류 위험]</strong><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[왓슨-X]</span>: "역류 전류 발생! 발생 건수가 하위 3번째에 위치한 표본 데이터를 확인하여, 배전반 정밀 전하의 접지 저항 상수를 맞춰 주십시오!"<br><br><i>파지직- 구리 와이어와 애자 주변에 푸른 불꽃이 튀며 전류 경보음이 방 안을 난타합니다.</i>''', 'qtext': '<strong>Q5. [순위 데이터]</strong><br>소매치기 발생 건수가 적은 쪽에서 3번째인 지역의 건수는 얼마인가?', 'placeholder': '숫자 또는 건 입력', 'error': '수치 불일치! 정렬 순서가 꼬였습니다.', 'ans_check': "ans === '23' || ans === '23건'", 'hint': '데이터를 크기 순서대로 정렬했을 때 세 번째로 작은 건수 값을 찾습니다.'},
    {'qnum': 6, "options": ["계급", "계급 아님", "알 수 없음", "해 없음"], 'title': '제2구역: 계급 분류', 'story': '''<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모리아티-AI]</span>: "구리 배전 회로를 수리하다니 성가신 녀석들! 하지만 용의자 연령 데이터를 일정한 단위로 토막 내어 숨겨둔 이 통계학적 구간의 명칭을 알고 있느냐?"<br><br><i>철컥-! 콘솔 보드 상단에 회전식 슬롯 다이어그램이 조작 장치에서 솟아오릅니다.</i><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[왓슨-X]</span>: "용의자 연령을 나누는 데이터 구간 용어를 입력해 슬롯 드럼을 회전시켜야 합니다!"''', 'qtext': '<strong>Q6. [계급의 정의]</strong><br>자료를 몇 개의 구간으로 나눌 때, 이 구간을 무엇이라 하는가?', 'placeholder': '한글 단어 입력', 'error': '기초 통계 용어 오류! 결계가 열리지 않습니다.', 'ans_check': "ans === '계급'", 'hint': '수집된 변량을 일정한 간격으로 나눈 구간을 가리키는 통계 용어입니다.'},
    {'qnum': 7, "options": ["도수", "도수 아님", "알 수 없음", "해 없음"], 'title': '도수의 정의', 'story': '''<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모리아티-AI]</span>: "계급 드럼을 돌렸나? 그렇다면 각 계급 세그먼트에 분류 매핑된 순수 용의자 머릿수(변량 수)를 지칭하는 진짜 통계 값을 대봐라!"<br><br><i>드럼 슬롯이 빠른 기어 소리와 함께 다시 멈춰 서며 한글 암호 키 입력을 요합니다.</i><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[왓슨-X]</span>: "각 계급 구간에 분포하는 표본의 수를 의미하는 핵심 한글 용어를 입력하십시오!"''', 'qtext': '<strong>Q7. [도수의 정의]</strong><br>각 계급에 속하는 변량의 개수를 무엇이라 하는가?', 'placeholder': '한글 단어 입력', 'error': '마나 입력 오류! 올바른 한글 용어를 쓰십시오.', 'ans_check': "ans === '도수'", 'hint': '각 계급 구간에 속해 있는 자료(변량)의 개수를 의미하는 용어입니다.'},
    {'qnum': 8, "options": ["8", "10", "20", "12"], 'title': '계급의 폭', 'story': '''<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모리아티-AI]</span>: "나이 띠별 구간의 너비를 비틀었다. 용의자 연령대가 10대, 20대 등으로 묶여 있을 때, 이 통계 구조의 구간폭 크기는 얼마인지 산출해 기계 축을 고정해라!"<br><br><i>기어 샤프트가 편심 회전하며 흔들리고 있습니다. 정확한 구간 너비를 입력해 회전 진동을 축 상쇄해야 합니다.</i><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[왓슨-X]</span>: "기어 축 손상 방지 가동! 계급 구간 크기의 숫자 수치를 빠르게 주입해 주십시오!"''', 'qtext': '<strong>Q8. [계급의 크기]</strong><br>계급의 너비(크기)는 얼마인가? (자료: 10대, 20대 식일 때의 너비)', 'placeholder': '숫자만 입력', 'error': '너비 부조화! 구간 세그먼트가 틀어졌습니다.', 'ans_check': "ans === '10' || ans === '10세'", 'hint': '한 계급 구간의 너비(끝값 - 시작값)를 계산하여 단위를 포함하지 않은 값을 적습니다.'},
    {'qnum': 9, "options": ["20대", "20대 아님", "알 수 없음", "해 없음"], 'title': '최대 나이 도수', 'story': '''<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모리아티-AI]</span>: "나이 분포를 흔들어 스파이의 소속 연령을 숨겼다. 가장 많은 스파이 혐의자들이 분포한 다발적 나이대 계급을 검출해 봐라!"<br><br><i>화면에 붉은색 막대 그래프 노이즈들이 급등락을 보이며 춤을 춥니다. 도수 분포가 압도적으로 높은 연령대 구간을 지명해야 합니다.</i><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[왓슨-X]</span>: "모리아티 측 용의자들이 최다 포진한 연령대 계급 명칭을 입력 창에 전송하십시오!"''', 'qtext': '<strong>Q9. [최대 도수 계급]</strong><br>도수가 가장 큰 계급은 어느 연령대인가? (자료: 10대: 4명, 20대: 8명, 30대: 5명, 40대: 3명)', 'placeholder': '예: 20대', 'error': '용의자 타겟팅 오류!', 'ans_check': "ans === '20대'", 'hint': '도수(인원수)가 8명으로 가장 많이 몰려 있는 나이대 계급을 찾습니다.'},
    {'qnum': 10, "options": ["120", "62", "60", "58"], 'title': '청년 용의자 비율', 'story': '''💥 <strong>[비상 경보: 메인 증기 보일러 자폭 압축 시작!]</strong> 💥<br><br><span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모리아티-AI]</span>: "내 계산 엔진을 이렇게 깊이 헤집어 놓다니! 런던 통계국 지하의 원동기 보일러를 강제 자폭시키겠다! 5분 뒤 모두 폭발 가스 속에서 질식해 흩어지리라!"<br><br><i>쿠구구궁- 압력 밸브 바늘이 위험 수치인 적색 대역으로 휘어지며 증기가 대량 분출됩니다. 30세 미만 용의자들의 백분율 비율 수치를 긴급 도출해 점화를 차단하십시오.</i><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[왓슨-X]</span>: "비상! 압력 해제기 가동! 30세 미만 인원이 차지하는 전체 대비 백분율(%) 상수를 입력하십시오! 제가 최대 안전망으로 폭발을 억제하고 있겠습니다!"''', 'qtext': '<strong>Q10. [백분율 계산]</strong><br>나이가 30세 미만인 용의자는 전체의 몇 %인가? (단위 생략)', 'placeholder': '숫자만 입력', 'error': '백분율 오차 발생! 차단 셔터 압력 증가!', 'ans_check': "ans === '60' || ans === '60%'", 'hint': '30세 미만 인원수(4명 + 8명 = 12명)가 전체 20명 중에서 차지하는 비율을 백분율(%)로 계산합니다.', "extra_class": "glitch-bg"},
    {'qnum': 11, 'title': '제3구역: 히스토그램', 'story': '''<span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[왓슨-X]</span>: "보일러 자폭 지연 성공! 하지만 배출 포트 필터가 아직 불완전하게 동축 얽혀 있습니다! ⚙️ [직사각형 그래프 정렬]"<br><br><i>가로축에 계급, 세로축에 도수를 세워 설계한 고대 차분기관의 정밀 분포 직사각형 그래프 명칭을 입력해 필터를 여십시오.</i>''', 'qtext': '<strong>Q11. [히스토그램]</strong><br>도수분포표를 바탕으로 가로축에 계급, 세로축에 도수를 나타내어 직사각형 모양으로 그린 그래프를 무엇이라 하는가?', 'placeholder': '한글 그래프 이름 입력', 'error': '그래프 타입 인식 불가능!', 'ans_check': "ans === '히스토그램'", 'hint': '도수분포표를 바탕으로 가로에 계급, 세로에 도수를 매칭해 그린 직사각형 모양의 그래프 명칭입니다.'},
    {'qnum': 12, 'title': '가로폭의 속성', 'story': '''<span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[왓슨-X]</span>: "좋습니다, 그래프 채널을 잡았으나 직사각형들의 가로축 픽셀 너비 비례값이 뒤흔들리고 있습니다! ⚙️ [가로축 의미 보정]"<br><br><i>지지직- 모니터 상의 직사각형 가로폭 수치가 고유 통계적 물리 속성을 나타내도록 해당 물리 명칭을 입력창에 정확히 기술해 주십시오.</i>''', 'qtext': '<strong>Q12. [히스토그램 가로]</strong><br>히스토그램에서 직사각형의 가로의 길이는 무엇을 의미하는가?', 'placeholder': '예: 계급의 크기', 'error': '가로축 픽셀 정렬 에러!', 'ans_check': "ans === '계급의크기' || ans === '계급의 크기' || ans === '계급의너비' || ans === '계급의 너비'", 'hint': '도수분포표의 각 직사각형의 가로폭이 나타내는 계급의 간격 크기를 의미합니다.'},
    {'qnum': 13, 'title': '넓이의 총합', 'story': '''<span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[왓슨-X]</span>: "안정 필터 동력원 85% 결합 도달! 이제 모든 직사각형 넓이의 면적 총합을 연산하여 메인 배선반 상수에 대입해야 합니다!"<br><br><i>직사각형 넓이의 총합 공식을 정의하기 위해, 계급의 크기에 곱해져야 하는 핵심 통계 합산 단어를 밸런서에 전송하십시오.</i>''', 'qtext': '<strong>Q13. [히스토그램 넓이 공식]</strong><br>히스토그램에서 직사각형의 넓이의 합은 (계급의 크기) × ( ? ) 이다. ?에 들어갈 알맞은 말은?', 'placeholder': '한글 단어 입력', 'error': '면적 총합 불일치! 차원 결계 폐쇄 경보!', 'ans_check': "ans === '도수의총합' || ans === '도수의 총합' || ans === '도수의합' || ans === '도수의 합'", 'hint': '모든 직사각형의 넓이 합 공식은 (계급의 크기) * (도수의 총합) 입니다.'},
    {'qnum': 14, 'title': '다각형 그래프', 'story': '''<span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[왓슨-X]</span>: "훌륭합니다! 이제 윗변의 중점들을 모조리 꺾은선으로 팽팽하게 당겨 묶어 잔류 주파수 노이즈를 완벽하게 격리 통제해야 합니다!"<br><br><i>중점들을 이은 녹색 다각형 선분 그래프가 생성됩니다. 이 통계 그래프의 풀 네임을 새겨 넣어 회선을 동기화하십시오.</i>''', 'qtext': '<strong>Q14. [도수분포다각형]</strong><br>히스토그램의 각 직사각형 윗변의 중점을 차례로 선분으로 연결한 그래프를 무엇이라 하는가?', 'placeholder': '한글 그래프 이름 입력', 'error': '다각형 궤적 링크 오류!', 'ans_check': "ans === '도수분포다각형'", 'hint': '히스토그램의 각 직사각형 윗변의 중점들을 선분으로 이어 꺾은선 모양으로 만든 다각형 그래프입니다.'},
    {'qnum': 15, 'title': '넓이의 동등성', 'story': '''✨ <strong><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[왓슨-X 차분기관 시스템 통제권 100% 완전 환수]</span></strong> ✨<br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[왓슨-X]</span>: "해독 대조 완료! 런던 통계국 차분기관의 시스템 권한을 제가 완벽히 장악했습니다! 이제 모리아티-AI의 왜곡 코드들을 메모리 밖으로 삭제하겠습니다. 다각형과 히스토그램의 면적 비례 관계를 입력하십시오!"<br><br><i>스팀 콘솔 화면들이 일제히 차분하고 투명한 민트색 황동 프레임 조명으로 돌아옵니다.</i><br><br><span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모리아티-AI]</span>: "말도 안 돼... 내 스크립트들이 연산 노드에서 모조리 격리당하다니... 상대도수 비례 결계로 마지막 저지를 시도하겠다!"''', 'qtext': '<strong>Q15. [넓이의 성질]</strong><br>도수분포다각형과 가로축으로 둘러싸인 부분의 넓이는 히스토그램의 직사각형들의 넓이의 합과 어떠한가?', 'placeholder': '같다 또는 다르다 입력', 'error': '면적 불균형! 공간 붕괴 위험!', 'ans_check': "ans === '같다'", 'hint': '도수분포다각형과 가로축이 만드는 면적은 히스토그램 전체 직사각형 넓이의 합과 항상 같은 성질을 가집니다.', "extra_class": "glitch-bg"},
    {'qnum': 16, 'title': '제4구역: 상대도수', 'story': '''<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모리아티-AI]</span>: "비율 데이터 락이다! 전체 총합에서 특정 계급 도수가 차지하는 물리적 상대적 비율 값을 뜻하는 용어를 해독해 봐라!"<br><br><i>포탈 제어기 스크린에 가중치 매트릭스 필드가 활성화되며 한글 키워드를 스캔하기 시작합니다.</i>''', 'qtext': '<strong>Q16. [상대도수의 정의]</strong><br>각 계급의 도수를 도수의 총합으로 나눈 비율을 무엇이라 하는가?', 'placeholder': '한글 단어 입력', 'error': '가중치 데이터 로드 불가!', 'ans_check': "ans === '상대도수'", 'hint': '각 계급의 도수가 전체 도수 총합 중에서 차지하는 상대적인 비율을 뜻하는 용어입니다.'},
    {'qnum': 17, 'title': '상대도수 계산', 'story': '''<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모리아티-AI]</span>: "용의자 도수 15명, 도수 총합 50명일 때 해당하는 정밀 상대도수의 소수 펄스 주파수를 계산해 전송해라!"<br><br><i>지이잉- 주파수 궤도가 흔들리며 미세 전압의 조정을 위해 정확한 소수 해를 다이얼 창에 입력해야 합니다.</i>''', 'qtext': '<strong>Q17. [상대도수 계산]</strong><br>어떤 계급의 도수가 15, 도수의 총합이 50일 때, 이 계급의 상대도수를 구하시오. (소수로 기재)', 'placeholder': '예: 0.5', 'error': '주파수 오차 발생! 안개가 더 짙어집니다.', 'ans_check': "ans === '0.3'", 'hint': '특정 계급 도수(15)를 전체 도수(50)로 나눈 비율을 소수 값으로 계산합니다.'},
    {'qnum': 18, 'title': '상대도수의 총합', 'story': '''<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모리아티-AI]</span>: "상대적인 비율 조각들을 모두 주워 모아 봤자, 그 총합의 한계 상수는 정해져 있을 터!"<br><br><i>포탈 게이트의 에너지 백분량 안전 센서가 작동을 대기합니다. 모든 상대도수를 합쳐 나오는 고정 불변의 총합 상수를 입력하십시오.</i>''', 'qtext': '<strong>Q18. [상대도수 총합]</strong><br>상대도수의 총합은 항상 얼마인가?', 'placeholder': '숫자만 입력', 'error': '한계선 수치 초과! 시스템 잠금!', 'ans_check': "ans === '1'", 'hint': '상대적인 비율들의 총합은 항상 전체를 뜻하는 고정된 자연수 값이 나옵니다.'},
    {'qnum': 19, 'title': '분포 상태 비교', 'story': '''<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모리아티-AI]</span>: "총합 규모가 상이한 두 용의자 집단의 분포 비교를 비율 없이 단순 머릿수(도수)로 감당할 수 있겠느냐!"<br><br><i>두 표본 집단의 크기가 어긋나 스크린에 경고 문구가 교차 점멸합니다. 상대도수가 비교 분석 도구로써 갖는 실질적 활용성 선언을 입력해 분석 엔진을 가동하십시오.</i>''', 'qtext': '<strong>Q19. [상대도수의 활용]</strong><br>상대도수는 도수의 총합이 다른 두 집단의 분포 상태를 비교할 때 어떠한가? (유용하다 / 불필요하다)', 'placeholder': '유용하다 또는 불필요하다 입력', 'error': '비교 엔진 작동 불능!', 'ans_check': "ans === '유용하다'", 'hint': '조사 대상의 전체 총인원수가 서로 다른 두 집단의 성적이나 선호도를 비율로 공평하게 비교할 때의 유용성 여부를 생각합니다.'},
    {'qnum': 20, 'title': '범인 도수 산출', 'story': '''🔮 <strong>[최종 보안 락다운 전면 해제 게이트 작동]</strong> 🔮<br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[왓슨-X]</span>: "조사관님! 이제 눈앞의 런던 통계국 메인 탈출용 포탈 해치만 남았습니다! 제 마지막 백업 연산 에너지를 해치 개방에 집중하겠습니다! 전체 40명의 통계 요원 중 상대도수 비율이 0.2를 기록한 진범 스파이 도수(인원수)를 정확히 지목해 락을 해제하십시오! 스파이를 검거할 시간입니다!"<br><br><span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모리아티-AI]</span>: "이럴 수가... 내 완벽한 조작 알고리즘 스키마가... 전면 소거 정지당하다니... 끄아아앗!"''', 'qtext': '<strong>Q20. [도수 구하기]</strong><br>상대도수가 0.2이고 전체 도수가 40명일 때, 이 계급의 도수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '지목 실패! 스파이가 안개 속으로 도망칩니다!', 'ans_check': "ans === '8' || ans === '8명'", 'hint': '(전체 인원 40명) * (상대도수 비율 0.2)를 곱하여 해당 계급의 실제 인원수를 계산합니다.', "extra_class": "glitch-bg"}
]
