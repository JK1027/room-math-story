...
qs = [
    {'qnum': 1, "options": ["각기둥", "각기둥 아님", "알 수 없음", "해 없음"], 'title': '기둥의 성질', 'story': '''<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모래의 침입자 - 도굴꾼]</span>: "크하하! 이 피라미드 지하의 천문 기단은 내가 차지했다! 감히 이 입체도형 봉인을 뚫고 나갈 수 있을 것 같으냐? 기하학의 무덤에 갇힌 것을 환영한다!"<br><br><i>쿠구구궁- 돌문 너머로 모래 톱니 기계 장치가 돌출되며 첫 번째 다면체 봉인 락이 드러납니다. 옆면이 모두 직사각형으로 일치하는 고대 다면체의 가문명을 새겨 넣어야 격벽이 올라갑니다.</i>''', 'qtext': '<strong>Q1. [다면체의 이해]</strong><br>옆면이 모두 직사각형인 다면체를 무엇이라 부르는가? (힌트: 기둥)', 'placeholder': '예: 각뿔', 'error': '도형 이름 오류!', 'ans_check': "ans === '각기둥'", 'hint': '옆면의 모양이 모두 직사각형인 입체도형 계열의 명칭을 떠올려 봅니다.'},
    {'qnum': 2, "options": ["8", "10", "20", "12"], 'title': '오각기둥 락', 'story': '''<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모래의 침입자 - 도굴꾼]</span>: "함정의 천장이 천천히 내려앉기 시작하는군! 오각기둥 밑판을 고정하는 꼭짓점의 총개수만큼 황동 레버를 당기지 않으면 완전히 짓눌려 뭉개지리라!"<br><br><i>쩍쩍- 소리를 내며 천장의 육중한 돌판이 미궁 바닥 높이까지 하강하기 시작합니다. 오각기둥의 꼭짓점 개수만큼 레버를 고정시켜 압축을 저지하십시오!</i>''', 'qtext': '<strong>Q2. [꼭짓점의 개수]</strong><br>밑면이 오각형인 오각기둥의 꼭짓점의 개수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '개수 오류!', 'ans_check': "ans === '10'", 'hint': 'n각기둥의 꼭짓점 개수 공식은 2n 입니다.'},
    {'qnum': 3, "options": ["14", "24", "10", "12"], 'title': '육각뿔 모서리', 'story': '''<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모래의 침입자 - 도굴꾼]</span>: "사방에서 솟구치는 육각뿔 형태의 창날 함정이다! 육각뿔 장치의 모든 날카로운 모서리 개수를 맞춰야만 창날이 다시 바닥으로 들어가리라!"<br><br><i>슈슉- 바닥의 석판 틈새로 은빛 금속 침을 지닌 육각뿔 장치들이 날카롭게 튀어나옵니다.</i>''', 'qtext': '<strong>Q3. [모서리의 개수]</strong><br>밑면이 육각형인 육각뿔의 모서리의 개수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '개수 오류!', 'ans_check': "ans === '12'", 'hint': 'n각뿔의 모서리 개수 공식은 2n 입니다.'},
    {'qnum': 4, "options": ["4", "6", "8", "12"], 'title': '뿔대 봉인', 'story': '''<strong>[수로의 먼지 폭풍 및 모래바람 차단]</strong><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[신전의 사제 - 임호텝]</span>: "치지직... 조사관님! 피라미드의 바람 통풍 기단이 멈추었습니다! 도굴꾼의 사악한 흑마법 기운이 회로를 차단하고 있습니다! 사각뿔대 모양 정화 부적의 면 개수를 연산해 비상 배출 장치를 긴급 구동하십시오!"''', 'qtext': '<strong>Q4. [면의 개수]</strong><br>사각뿔대의 면의 개수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '개수 오류!', 'ans_check': "ans === '6'", 'hint': 'n각뿔대의 면의 개수는 밑면 2개와 옆면 n개를 더해 n+2 개입니다.'},
    {'qnum': 5, "options": ["정사면체", "정사면체 아님", "알 수 없음", "해 없음"], 'title': '성스러운 다면체', 'story': '''🚨 <strong>[비상 로그: 이집트 왕의 방 수은 압력 폭발 위기]</strong> 🚨<br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[신전의 사제 - 임호텝]</span>: "수은 수조의 물길 높이가 급격히 차오릅니다! 정삼각형 4개로 결합된 고대 성스러운 정다면체 이름을 입력해 배수 놋쇠 빗장의 기운을 조화롭게 정렬해 주십시오! 빨리!"<br><br><i>구리 파이프 내부의 은빛 수은 액체가 붉은색 파이프라인을 타고 무섭게 격동하기 시작합니다.</i>''', 'qtext': '<strong>Q5. [정다면체]</strong><br>각 면이 모두 합동인 정삼각형이고 한 꼭짓점에 모이는 면의 개수가 3개인 정다면체의 이름을 구하시오.', 'placeholder': '예: 정육면체', 'error': '정다면체 이름 오류!', 'ans_check': "ans === '정사면체'", 'hint': '면이 정삼각형인 정다면체 중 한 꼭짓점에 모이는 면의 개수가 3개인 첫 번째 도형입니다.'},
    {'qnum': 6, "options": ["회전체", "회전체 아님", "알 수 없음", "해 없음"], 'title': '제2구역: 도자기 방', 'story': '''<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모래의 침입자 - 도굴꾼]</span>: "제2구역 도자기 방에 들어왔군. 회전의 기둥 축을 한 바퀴 돌려 입체적인 도자기를 빚어내는 고대 연금술의 도형 범주명을 알고 있느냐?"<br><br><i>방 한가운데 거대한 돌판 물레가 회전하기 시작하고, 공중에 입체 형상 아지랑이들이 요동치며 모래 장벽을 형성합니다.</i><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[신전의 사제 - 임호텝]</span>: "조사관님! 회전축을 기준으로 1회전하여 만들어지는 모든 입체도형의 통합 분류명을 입력해 봉인을 해제해 주십시오!"''', 'qtext': '<strong>Q6. [회전체의 이해]</strong><br>평면도형을 한 직선을 축으로 하여 1회전 시킬 때 생기는 입체도형을 무엇이라 부르는가?', 'placeholder': '예: 다면체', 'error': '도형 종류 오류!', 'ans_check': "ans === '회전체'", 'hint': '평면도형을 한 직선을 축으로 하여 1회전 시킬 때 생기는 입체도형의 총칭입니다.'},
    {'qnum': 7, "options": ["직사각형", "직사각형 아님", "알 수 없음", "해 없음"], 'title': '세로 절단면', 'story': '''<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모래의 침입자 - 도굴꾼]</span>: "원기둥 결계의 회전축을 세로로 쪼갰을 때 드러나는 단면의 모양을 정의해라. 잘못된 모형을 제출하는 순간 톱니바퀴 칼날이 작동하리라!"<br><br><i>천장에 매달린 거대한 칼날들이 회전을 대기하며 차갑게 번뜩입니다. 세로 절단했을 때의 정확한 단면 형상 이름을 대십시오.</i><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[신전의 사제 - 임호텝]</span>: "조사관님! 원기둥을 회전축을 포함하는 세로 평면으로 잘랐을 때 나타나는 직관적인 사각형 명칭을 입력창에 전송하십시오!"''', 'qtext': '<strong>Q7. [회전축과 단면 1]</strong><br>원기둥을 회전축을 포함하는 평면으로 자를 때 생기는 단면의 모양은 무엇인가?', 'placeholder': '예: 사각형', 'error': '단면 모양 오류!', 'ans_check': "ans === '직사각형'", 'hint': '원기둥의 가운데 회전축을 포함하도록 위에서 아래로 세로로 자른 단면의 평면 모양을 생각합니다.'},
    {'qnum': 8, "options": ["원", "원 아님", "알 수 없음", "해 없음"], 'title': '가로 절단면', 'story': '''<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모래의 침입자 - 도굴꾼]</span>: "축에 수직인 수평 방향으로 가로 쪼개기를 실행하면 어떨까? 원뿔 모양의 장벽 단면이 어떤 기하학 무늬를 이루겠나?"<br><br><i>가로 방향으로 푸른 신화의 화염이 원뿔 봉인을 관통하여 잘림을 작동시킵니다.</i><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[신전의 사제 - 임호텝]</span>: "밑면에 평행하게 수평으로 가로 자른 단면의 완벽한 원형 형태 명칭을 한 글자로 입력해 빗장을 푸십시오!"''', 'qtext': '<strong>Q8. [회전축과 단면 2]</strong><br>원뿔을 회전축에 수직인 평면으로 자를 때 생기는 단면의 모양은 무엇인가?', 'placeholder': '예: 타원', 'error': '단면 모양 오류!', 'ans_check': "ans === '원'", 'hint': '원뿔을 밑면에 평행하게(회전축에 수직으로) 가로로 자를 때 나타나는 단면의 모양을 생각합니다.'},
    {'qnum': 9, "options": ["원뿔", "원뿔 아님", "알 수 없음", "해 없음"], 'title': '직각삼각형 회전', 'story': '''<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모래의 침입자 - 도굴꾼]</span>: "회전 궤적의 형태마저 맞출 수 있겠느냐? 직각삼각형 석판의 한 모서리를 기준으로 원심 회전을 시키면 나타나는 모형은?"<br><br><i>연단 위의 황동 물레에 고정된 직각삼각형 기어가 거칠게 회전하기 시작합니다. 완성되는 3차원 입체 모형의 이름을 맞추십시오.</i><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[신전의 사제 - 임호텝]</span>: "기어의 마찰로 불꽃이 튀고 있습니다! 회전 기어 모형인 고깔 모양의 입체도형 이름을 전송하십시오!"''', 'qtext': '<strong>Q9. [회전체의 종류]</strong><br>직각삼각형을 직각을 낀 한 변을 축으로 하여 1회전 시킬 때 생기는 도형은 무엇인가?', 'placeholder': '예: 원기둥', 'error': '도형 이름 오류!', 'ans_check': "ans === '원뿔'", 'hint': '직각삼각형을 한 변을 축으로 돌리면 고깔모자나 고깔콘 형태의 입체도형이 만들어집니다.'},
    {'qnum': 10, "options": ["원", "원 아님", "알 수 없음", "해 없음"], 'title': '구의 단면', 'story': '''💥 <strong>[비상: 신전 기단의 마력 폭주 및 신전 붕괴 작동!]</strong> 💥<br><br><span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모래의 침입자 - 도굴꾼]</span>: "쥐새끼 같은 파편 코드가 내 핵심 제단을 잠식하다니...! 이집트 신전의 붕괴 주술을 기동한다! 5분 뒤 전부 모래바람 속에 폭파 소멸되리라!"<br><br><i>경보 굉음이 요란하게 울려 퍼지며 기단 중앙 뒤쪽의 원형 마나 보석이 붉은색으로 불타오릅니다. 구를 어느 평면으로 잘라도 불변하는 단면의 명칭을 입력해 붕괴를 억제하십시오.</i><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[신전의 사제 - 임호텝]</span>: "조사관님! 마력 온도가 임계점에 임박했습니다! 완벽한 대칭 구의 단면 형상 이름을 즉시 주입해 정화의 결계로 폭주를 방어해 주십시오!"''', 'qtext': '<strong>Q10. [구의 성질]</strong><br>구를 어떤 평면으로 자르더라도 그 단면은 항상 어떤 모양인가?', 'placeholder': '예: 타원', 'error': '단면 오류!', 'ans_check': "ans === '원'", 'hint': '구를 어떤 방향으로 자르더라도 그 단면의 평면 모양은 항상 완벽한 원이 됩니다.', "extra_class": "glitch-bg"},
    {'qnum': 11, 'title': '제3구역: 각기둥 도금', 'story': '''<span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[신전의 사제 - 임호텝]</span>: "휴... 유예 시간 3분 확보! 하지만 각기둥 방열판의 금도금 면적이 어긋나 온도가 다시 치솟습니다! ⚙️ [겉넓이 표면 정렬]"<br><br><i>가로 3cm, 세로 4cm, 높이 5cm인 각기둥 황금 챔버의 총 표면 겉넓이 상수를 계산해 방열판 전류 동조 장치에 입력하십시오.</i>''', 'qtext': '<strong>Q11. [각기둥의 겉넓이]</strong><br>밑면이 가로 3cm, 세로 4cm인 직사각형이고, 높이가 5cm인 직육면체의 겉넓이를 구하시오.', 'placeholder': '숫자만 입력', 'error': '도금 면적 오류!', 'ans_check': "ans === '94'", 'hint': '세 모서리가 a, b, c인 직육면체의 겉넓이는 모든 면의 넓이 합이므로 2(ab + bc + ca) 입니다.'},
    {'qnum': 12, 'title': '원기둥 겉넓이', 'story': '''<span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[신전의 사제 - 임호텝]</span>: "안정화 수치를 전송했으나, 이번엔 보조 원기둥 히터의 겉넓이 압력 밸브가 밀리고 있습니다! ⚙️ [원기둥 겉넓이 동조]"<br><br><i>쉿-! 하는 마찰 연기와 함께 반지름 2cm, 높이 6cm 원기둥 파이프 표면이 붉게 달아오릅니다. 파이를 이용해 겉넓이 해를 구해 주입하십시오.</i>''', 'qtext': '<strong>Q12. [원기둥의 겉넓이]</strong><br>밑면의 반지름이 2cm이고 높이가 6cm인 원기둥의 겉넓이를 구하시오.', 'placeholder': '예: 10파이', 'error': '도금 면적 오류!', 'ans_check': "ans === '32파이'", 'hint': '원기둥의 밑면 2개의 넓이(2 * 파이 * r^2)와 옆면 펼친 직사각형 넓이(2 * 파이 * r * h)를 더합니다.'},
    {'qnum': 13, 'title': '정사각뿔 상자', 'story': '''<span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[신전의 사제 - 임호텝]</span>: "엔진 열교환기 80% 가동 중! 중앙 제어 장치의 사각뿔 덮개 내부 압력을 제어하기 위해 덮개 겉넓이를 계산해야 합니다!"<br><br><i>중앙 콘솔의 유리 돔 내부에 밑면 한 변 4cm, 옆면 삼각형 높이 5cm인 정사각뿔 모형이 은은하게 발광합니다. 겉넓이 수치를 산출하십시오.</i>''', 'qtext': '<strong>Q13. [사각뿔의 겉넓이]</strong><br>밑면이 한 변의 길이가 4cm인 정사각형이고, 옆면의 삼각형의 높이가 5cm인 정사각뿔의 겉넓이를 구하시오.', 'placeholder': '숫자만 입력', 'error': '도금 면적 오류!', 'ans_check': "ans === '56'", 'hint': '밑면 정사각형의 넓이(4*4)와 합동인 옆면 삼각형 4개의 넓이 합을 더합니다.'},
    {'qnum': 14, 'title': '원뿔 제단', 'story': '''<span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[신전의 사제 - 임호텝]</span>: "거의 완료되었습니다! 마지막으로 원뿔 조준대의 겉넓이 위상을 매칭해 레이저 필터를 활성화해 주십시오!"<br><br><i>반지름 3cm, 모선 길이 5cm인 원뿔 전자기 필터의 표면 겉넓이 수치(파이 포함)를 계산해 제어 노드에 입력하십시오.</i>''', 'qtext': '<strong>Q14. [원뿔의 겉넓이]</strong><br>밑면의 반지름이 3cm이고, 모선의 길이가 5cm인 원뿔의 겉넓이를 구하시오.', 'placeholder': '예: 10파이', 'error': '도금 면적 오류!', 'ans_check': "ans === '24파이'", 'hint': '원뿔의 겉넓이 공식인 (밑면 원 넓이) + (옆면 부채꼴 넓이) = 파이*r^2 + 파이*r*l 을 적용합니다.'},
    {'qnum': 15, 'title': '구의 표면적', 'story': '''✨ <strong><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[임호텝 메인 통제권 100% 완전 복구]</span></strong> ✨<br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[신전의 사제 - 임호텝]</span>: "조사관님! 마법의 모래시계 제어권이 저희에게 완전히 복귀되었습니다! 이제 도굴꾼의 탁한 기운을 완전히 격리합니다. 마지막 구형 코어의 겉넓이를 산출하십시오!"<br><br><i>콘솔 중앙에 반지름 3cm인 황금빛 마나 구형 구체가 환하게 떠오르며 안정적으로 돌아가기 시작합니다.</i><br><br><span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모래의 침입자 - 도굴꾼]</span>: "이럴 수가... 내 제단 중심의 황동 빗장이 차단되다니... 최종 생명의 수조 부피 봉인으로 가둬 주마!"''', 'qtext': '<strong>Q15. [구의 겉넓이]</strong><br>반지름의 길이가 3cm인 구의 겉넓이를 구하시오.', 'placeholder': '예: 10파이', 'error': '도금 면적 오류!', 'ans_check': "ans === '36파이'", 'hint': '반지름이 r인 구의 겉넓이 공식은 4 * 파이 * r^2 입니다.', "extra_class": "glitch-bg"},
    {'qnum': 16, 'title': '제4구역: 생명의 수조', 'story': '''<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모래의 침입자 - 도굴꾼]</span>: "출구를 차단한 거대 수조의 수압을 이기지 못할 것이다. 수조의 부피 수량을 정확히 입력하지 못하면 물폭탄이 신전을 집어삼키리라!"<br><br><i>철컹-! 바닥이 열리며 거대 각기둥 수조가 드러나고, 밸브가 물소리를 내며 작동을 대기합니다. 밑면 넓이 20cm², 높이 8cm인 수조의 총 부피(용량)를 구하여 동기화하십시오.</i>''', 'qtext': '<strong>Q16. [각기둥의 부피]</strong><br>밑면의 넓이가 20cm²이고 높이가 8cm인 각기둥의 부피를 구하시오.', 'placeholder': '숫자만 입력', 'error': '수압 조절 실패!', 'ans_check': "ans === '160'", 'hint': '모든 기둥의 부피는 (밑넓이) * (높이)로 일정하게 구합니다.'},
    {'qnum': 17, 'title': '원기둥 부피', 'story': '''<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모래의 침입자 - 도굴꾼]</span>: "수압을 고정했나? 하지만 원기둥형 메인 필터 수량이 불일치하면 여과 배관이 터져 역류할 것이다!"<br><br><i>지이잉- 반지름 4cm, 높이 5cm인 원기둥 정밀 여과 필터 챔버에 물이 유입되기 시작합니다. 파이를 이용해 필터 내부 부피를 계산해 주입하십시오!</i>''', 'qtext': '<strong>Q17. [원기둥의 부피]</strong><br>밑면의 반지름이 4cm이고 높이가 5cm인 원기둥의 부피를 구하시오.', 'placeholder': '예: 10파이', 'error': '물이 넘칩니다!', 'ans_check': "ans === '80파이'", 'hint': '원기둥의 부피 공식인 (밑면 원 넓이) * (높이) = 파이 * r^2 * h 를 적용합니다.'},
    {'qnum': 18, 'title': '원뿔 여과기', 'story': '''<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모래의 침입자 - 도굴꾼]</span>: "아직이다! 원뿔 모양 배출 노즐의 3분의 1 부피 평형비를 통과해야만 출구 배관의 압력이 열릴 것이다!"<br><br><i>반지름 3cm, 높이 4cm 원뿔 모양 배출 여과 장치 부피 수치를 산출해 제어 압력 상수로 전송하십시오.</i>''', 'qtext': '<strong>Q18. [원뿔의 부피]</strong><br>밑면의 반지름이 3cm이고 높이가 4cm인 원뿔의 부피를 구하시오.', 'placeholder': '예: 10파이', 'error': '물이 넘칩니다!', 'ans_check': "ans === '12파이'", 'hint': '모든 뿔의 부피는 동일한 기둥 부피의 1/3을 차지하므로, (1/3) * 파이 * r^2 * h 입니다.'},
    {'qnum': 19, 'title': '구형 물탱크', 'story': '''<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모래의 침입자 - 도굴꾼]</span>: "마지막 대피 펌프 압축 구체의 부피를 계산해 내라! 물탱크 내부 부피가 오차 없이 동기화되어야 게이트 실린더가 후퇴하리라!"<br><br><i>반지름 3cm인 완벽한 구형 마력 구체가 연단 위에서 푸르게 요동칩니다. 구의 정밀 부피를 입력해 주십시오.</i>''', 'qtext': '<strong>Q19. [구의 부피]</strong><br>반지름의 길이가 3cm인 구의 부피를 구하시오.', 'placeholder': '예: 10파이', 'error': '물이 부족합니다!', 'ans_check': "ans === '36파이'", 'hint': '반지름이 r인 구의 부피 공식은 (4/3) * 파이 * r^3 입니다.'},
    {'qnum': 20, 'title': '부피의 비례', 'story': '''🔮 <strong>[최종 봉인의 차단막 해제 게이트 작동]</strong> 🔮<br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[신전의 사제 - 임호텝]</span>: "조사관님! 이제 눈앞의 사막 지상으로 이어지는 최후의 석문 게이트만 남았습니다! 제 마지막 영적 에너지를 집중하겠습니다! 밑면 반지름과 높이가 모두 일치하는 원뿔, 구, 원기둥의 황금 부피 비율 상수를 입력하십시오! 이제 지상으로 나갈 시간입니다!"<br><br><span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[모래의 침입자 - 도굴꾼]</span>: "이럴 수가... 내 핵심 봉인의 주술 데이터가... 정지해 소멸한다아앗!"''', 'qtext': '<strong>Q20. [부피의 비]</strong><br>밑면의 반지름과 높이가 모두 같은 원뿔, 구, 원기둥의 부피의 비를 구하시오.', 'placeholder': '예: 1:2:3', 'error': '코드가 틀렸습니다!', 'ans_check': "ans === '1:2:3'", 'hint': '높이와 밑면이 같은 원뿔, 구, 원기둥의 부피의 비를 가장 간단한 자연수의 비로 나타내 봅니다.', "extra_class": "glitch-bg"}
]
