...
qs = [
    {'qnum': 1, "options": ["각기둥", "각기둥 아님", "알 수 없음", "해 없음"], 'title': '기둥의 성질', 'story': '[도굴꾼 봇-T]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? [아누비스-T]: "첫 다면체 트랩이다. 옆면이 모두 직사각형인 다면체를 대라!"\\"', 'qtext': '<strong>Q1. [다면체의 이해]</strong><br>옆면이 모두 직사각형인 다면체를 무엇이라 부르는가? (힌트: 기둥)', 'placeholder': '예: 각뿔', 'error': '도형 이름 오류!', 'ans_check': "ans === '각기둥'", 'hint': '옆면의 모양이 모두 직사각형인 입체도형 계열의 명칭을 떠올려 봅니다.'},
    {'qnum': 2, "options": ["8", "10", "20", "12"], 'title': '오각기둥 락', 'story': '[도굴꾼 봇-T]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? [아누비스-T]: "함정 벽면이 조여온다! 오각기둥 밑판 꼭짓점의 총개수만큼 탈출 제어 핀을 당겨라!"\\"', 'qtext': '<strong>Q2. [꼭짓점의 개수]</strong><br>밑면이 오각형인 오각기둥의 꼭짓점의 개수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '개수 오류!', 'ans_check': "ans === '10'", 'hint': 'n각기둥의 꼭짓점 개수 공식은 2n 입니다.'},
    {'qnum': 3, "options": ["14", "24", "10", "12"], 'title': '육각뿔 모서리', 'story': '[도굴꾼 봇-T]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? [아누비스-T]: "날카로운 육각뿔 트랩이다. 육각뿔 장치의 모서리 총개수를 세어 락을 무력화해라!"\\"', 'qtext': '<strong>Q3. [모서리의 개수]</strong><br>밑면이 육각형인 육각뿔의 모서리의 개수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '개수 오류!', 'ans_check': "ans === '12'", 'hint': 'n각뿔의 모서리 개수 공식은 2n 입니다.'},
    {'qnum': 4, "options": ["4", "6", "8", "12"], 'title': '뿔대 락다운', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[임호텝-P]: \\"치지직... 들리십니까...? 도굴꾼 봇-T의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q4. [면의 개수]</strong><br>사각뿔대의 면의 개수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '개수 오류!', 'ans_check': "ans === '6'", 'hint': 'n각뿔대의 면의 개수는 밑면 2개와 옆면 n개를 더해 n+2 개입니다.'},
