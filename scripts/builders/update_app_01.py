...
qs = [
    {'qnum': 1, 'title': '공방 서랍 열기', 'story': '[블랙-기어]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 🕰️ <strong>[공방 비밀 서랍]</strong><br><br>장영실의 공방 서랍장에 낡은 놋쇠 자물쇠가 걸려 있습니다. 10 이하의 소수 개수를 입력해야만 열릴 것 같습니다.\\"', 'qtext': '<strong>Q1. [소수와 합성수]</strong><br>10 이하의 자연수 중 소수는 모두 몇 개인가?', 'placeholder': '숫자 또는 개수 입력', 'error': '자물쇠가 굳게 닫혀 있습니다! 숫자를 다시 세어 보십시오.', 'ans_check': "ans === '4' || ans === '4개'"},
    {'qnum': 2, 'title': '비밀 금고 수색', 'story': '[블랙-기어]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 🕰️ <strong>[두 번째 상자]</strong><br><br>서랍을 열자 상패 형태의 나무 금고가 보입니다. 15 이하의 소수들을 모두 합한 값을 맞춰야만 덮개가 열립니다.\\"', 'qtext': '<strong>Q2. [소수의 합]</strong><br>15 이하의 소수의 합을 구하시오.', 'placeholder': '숫자만 입력', 'error': '금고에서 불길한 경고음이 납니다!', 'ans_check': "ans === '41'"},
    {'qnum': 3, 'title': '벽면 문양 해독', 'story': '[블랙-기어]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 🕰️ <strong>[벽면의 한지 조각]</strong><br><br>벽에 비스듬히 붙어 있는 한지에 네 개의 수가 적혀 있습니다. 합성수가 아닌 수를 골라 아래 받침대를 누르십시오.\\"', 'qtext': '<strong>Q3. [합성수 판별]</strong><br>다음 중 합성수가 아닌 것은?<br>(1) 9 &nbsp;&nbsp;(2) 15 &nbsp;&nbsp;(3) 17 &nbsp;&nbsp;(4) 21', 'placeholder': '보기 번호 또는 숫자 입력', 'error': '벽에서 먼지가 떨어집니다! 잘못 선택했습니다.', 'ans_check': "ans === '3' || ans === '17' || ans === '(3)'"},
    {'qnum': 4, 'title': '비밀 통로 개방', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[자격-M]: \\"치지직... 들리십니까...? 블랙-기어의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q4. [소수와 합성수의 성질]</strong><br>가장 작은 소수와 가장 작은 합성수의 합을 구하시오.', 'placeholder': '숫자만 입력', 'error': '계단이 흔들립니다! 함정이 작동하기 전 정답을 입력하세요.', 'ans_check': "ans === '6'"},
    {'qnum': 5, 'title': '수은 장치 활성화', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[자격-M]: \\"치지직... 들리십니까...? 블랙-기어의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q5. [소수 찾기]</strong><br>20 이상 30 이하의 소수는 모두 몇 개인가?', 'placeholder': '숫자 또는 개수 입력', 'error': '수은이 역류하려고 합니다! 신속하게 개수를 맞추십시오.', 'ans_check': "ans === '2' || ans === '2개'"},
    {'qnum': 6, 'title': '앙부일구 암호판', 'story': '[블랙-기어]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 🔐 <strong>[영침 정렬]</strong><br><br>암실 중앙에 빛나는 앙부일구(해시계) 영침 제어판이 드러납니다. 60의 소인수분해 값에서 2의 지수만큼 영침을 틀어야 조준이 맞습니다.\\"', 'qtext': '<strong>Q6. [지수 구하기]</strong><br>60을 소인수분해할 때, 2의 지수는 얼마인가?', 'placeholder': '숫자만 입력', 'error': '조준 실패! 그림자가 어긋납니다.', 'ans_check': "ans === '2'"},
    {'qnum': 7, 'title': '앙부일구 암호판', 'story': '[블랙-기어]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 🔐 <strong>[빛의 굴절 판독]</strong><br><br>영침 끝에서 레이저처럼 반사된 빛이 천장을 비춥니다. 식의 거듭제곱 계산값을 구해야 다음 거울을 회전시킵니다.\\"', 'qtext': '<strong>Q7. [거듭제곱의 계산]</strong><br>$2^3 \\times 3^2$ 의 값을 구하시오.', 'placeholder': '숫자만 입력', 'error': '거울 각도가 틀렸습니다! 빛이 소멸합니다.', 'ans_check': "ans === '72'"},
    {'qnum': 8, 'title': '앙부일구 암호판', 'story': '[블랙-기어]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 🔐 <strong>[소인수 정렬]</strong><br><br>두 번째 광선이 황동 암호판으로 유도됩니다. 180의 소인수들의 합을 입력하여 록(Lock)을 푸십시오.\\"', 'qtext': '<strong>Q8. [소인수의 합]</strong><br>180의 소인수를 모두 더한 값을 구하시오.', 'placeholder': '숫자만 입력', 'error': '암호판이 잠겨 움직이지 않습니다!', 'ans_check': "ans === '10'"},
    {'qnum': 9, 'title': '앙부일구 암호판', 'story': '[블랙-기어]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 🔐 <strong>[약수 기어 작동]</strong><br><br>암호판의 톱니들이 돌아가기 시작합니다. 72의 약수의 개수를 구하여 톱니 조절판에 입력해야 정상 동기화됩니다.\\"', 'qtext': '<strong>Q9. [약수의 개수 1]</strong><br>72의 약수의 개수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '기어 맞물림 이상! 톱니 개수가 맞지 않습니다.', 'ans_check': "ans === '12'"},
    {'qnum': 10, 'title': '앙부일구 암호판', 'story': '🚨 <strong>[비상 경보: 강제 자폭 시스템 작동]</strong> 🚨<br><br>[블랙-기어]: \\"더는 참을 수 없군! 모든 데이터를 자폭 폭파하겠다! 5분 내로 전부 잿더미로 만들어주지!\\"<br><br>[자격-M]: \\"경고! 시스템 온도 상승 중! 제가 방화벽을 전개할 동안 긴급 수치 입력을 끝내십시오!\\"', 'qtext': '<strong>Q10. [약수의 개수 2]</strong><br>$3^4 \\times 5^a$ 의 약수의 개수가 15개일 때, a의 값을 구하시오.', 'placeholder': '숫자만 입력', 'error': '동기화 실패! 시간이 어긋납니다.', 'ans_check': "ans === '2'"},
    {'qnum': 11, 'title': '자격루 동력 복구', 'story': '[자격-M]: \\"방어막 출력 한계 도달 중! 코드를 지속적으로 갱신해야 폭발을 유예할 수 있습니다! ⚙️ <strong>[물통 수압 동기]</strong><br><br>쿵- 하는 소리와 함께 지하 거대 물시계(자격루)의 실린더가 노출됩니다. 24와 36의 최대공약수를 구해 수압 밸브를 개방하십시오.\\"', 'qtext': '<strong>Q11. [최대공약수]</strong><br>24와 36의 최대공약수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '수압 이상! 물통이 파열될 위험이 있습니다!', 'ans_check': "ans === '12'"},
    {'qnum': 12, 'title': '자격루 동력 복구', 'story': '[자격-M]: \\"방어막 출력 한계 도달 중! 코드를 지속적으로 갱신해야 폭발을 유예할 수 있습니다! ⚙️ <strong>[동력 톱니 동기]</strong><br><br>물이 흘러가며 물레바퀴가 돌기 시작합니다. 두 동력 톱니바퀴 15와 25의 최소공배수를 구하여 속도를 매칭하십시오.\\"', 'qtext': '<strong>Q12. [최소공배수]</strong><br>15와 25의 최소공배수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '속도 불일치! 기어가 헛돕니다.', 'ans_check': "ans === '75'"},
    {'qnum': 13, 'title': '자격루 동력 복구', 'story': '[자격-M]: \\"방어막 출력 한계 도달 중! 코드를 지속적으로 갱신해야 폭발을 유예할 수 있습니다! ⚙️ <strong>[압축 실린더 평형]</strong><br><br>피스톤 압축기가 상하 운동을 개시합니다. 두 거듭제곱 수의 최대공약수를 구하여 피스톤 높이를 통제하십시오.\\"', 'qtext': '<strong>Q13. [거듭제곱의 최대공약수]</strong><br>두 수 $2^2 \\times 3$, $2 \\times 3^2 \\times 5$ 의 최대공약수를 구하시오. (숫자로 환산)', 'placeholder': '숫자만 입력', 'error': '압축 피스톤 불균형! 진동이 커집니다.', 'ans_check': "ans === '6'"},
    {'qnum': 14, 'title': '자격루 동력 복구', 'story': '[자격-M]: \\"방어막 출력 한계 도달 중! 코드를 지속적으로 갱신해야 폭발을 유예할 수 있습니다! ⚙️ <strong>[배수 구멍 청소]</strong><br><br>자격루 배수 배관에 슬러지가 꼈습니다. 12와 18의 공약수 개수만큼 메인 밸브를 순간 방출하여 배수관을 청소하십시오.\\"', 'qtext': '<strong>Q14. [공약수의 개수]</strong><br>두 수 12, 18의 공약수의 개수는 모두 몇 개인가?', 'placeholder': '숫자 또는 개수 입력', 'error': '배수가 막혔습니다! 수조가 넘치려 합니다.', 'ans_check': "ans === '4' || ans === '4개'"},
    {'qnum': 15, 'title': '자격루 동력 복구', 'story': '✨ <strong>[조력자 시스템 권한 100% 완전 복구]</strong> ✨<br><br>[자격-M]: \\"연산 데이터 대조 성공! 이제 시스템 통제권을 제가 절반 확보했습니다. 가자, 복수의 시간입니다!\\"<br><br>[블랙-기어]: \\"크으으윽... 하찮은 인간 녀석들이 내 서버까지 잠식해 들어오다니!\\"', 'qtext': '<strong>Q15. [최소공배수의 성질]</strong><br>두 수의 곱이 300이고 최대공약수가 5일 때, 이 두 수의 최소공배수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '부력 균형 붕괴! 부표가 가라앉습니다.', 'ans_check': "ans === '60'"},
    {'qnum': 16, 'title': '일식 관측과 시간 톱니', 'story': '[블랙-기어]: \\"아직 끝나지 않았다! 내 최고의 방해 암호를 해독해 보아라! ⏱️ <strong>[정사각형 황동판 타일]</strong><br><br>천장을 바라볼 수 있는 망원경(일식 관측 의기) 관측 대를 복구합니다. 벽면 가로 18, 세로 24를 가장 큰 정사각형 타일로 빈틈없이 채우기 위해 타일 한 변의 길이를 결정하세요.\\"', 'qtext': '<strong>Q16. [최대공약수 활용]</strong><br>가로 18cm, 세로 24cm인 직사각형 벽을 가능한 큰 정사각형 타일로 빈틈없이 채우려 한다. 타일 한 변의 길이를 구하시오. (단위 생략)', 'placeholder': '숫자 또는 cm 입력', 'error': '타일 배치 실패! 벽면이 무너집니다.', 'ans_check': "ans === '6' || ans === '6cm'"},
    {'qnum': 17, 'title': '일식 관측과 시간 톱니', 'story': '[블랙-기어]: \\"아직 끝나지 않았다! 내 최고의 방해 암호를 해독해 보아라! ⏱️ <strong>[톱니바퀴 맞물림]</strong><br><br>관측 회전 기어를 조절합니다. 톱니수 12개와 18개인 A, B 기어가 처음으로 다시 만날 때까지 기어 A가 몇 바퀴를 돌아야 합니까?\\"', 'qtext': '<strong>Q17. [최소공배수 활용 1]</strong><br>톱니수가 각각 12개, 18개인 두 톱니바퀴 A, B가 맞물려 돌 때, 처음으로 다시 같은 톱니에서 맞물리려면 A는 몇 바퀴를 돌아야 하는가?', 'placeholder': '숫자 또는 바퀴 수 입력', 'error': '기어 스펙이 안 맞습니다! 회전이 멈춥니다.', 'ans_check': "ans === '3' || ans === '3바퀴'"},
    {'qnum': 18, 'title': '일식 관측과 시간 톱니', 'story': '[블랙-기어]: \\"아직 끝나지 않았다! 내 최고의 방해 암호를 해독해 보아라! ⏱️ <strong>[관측 거울 간격]</strong><br><br>햇빛을 적절히 차단할 렌즈 간격을 연산해야 합니다. 나눗셈의 나머지를 역이용하여 최고 간격 수치를 구하세요.\\"', 'qtext': '<strong>Q18. [최대공약수 활용 2]</strong><br>어떤 수로 37을 나누면 1이 남고, 46을 나누면 2가 남는다. 이러한 수 중 가장 큰 수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '렌즈 초점이 맞지 않아 일식이 보이지 않습니다!', 'ans_check': "ans === '4'"},
    {'qnum': 19, 'title': '일식 관측과 시간 톱니', 'story': '[블랙-기어]: \\"아직 끝나지 않았다! 내 최고의 방해 암호를 해독해 보아라! ⏱️ <strong>[신호용 북 타이머]</strong><br><br>일식의 시작을 전 궁궐에 알릴 두 대고의 북 연타 타이머를 맞춥니다. 10분, 15분 간격으로 치는 북이 오전 9시 이후 처음 동시 작동하는 시간을 구하세요.\\"', 'qtext': '<strong>Q19. [최소공배수 활용 2]</strong><br>버스 A는 10분, 버스 B는 15분 간격으로 출발한다. 오전 9시에 동시에 출발했다면, 다음으로 처음 동시에 출발하는 시각은 9시 몇 분인가? (분만 입력)', 'placeholder': '숫자 또는 분 입력', 'error': '북 신호가 어긋나 백성들이 혼란에 빠집니다!', 'ans_check': "ans === '30' || ans === '30분'"},
    {'qnum': 20, 'title': '일식 관측과 시간 톱니', 'story': '🔮 <strong>[최종 방화벽 락다운 해제]</strong> 🔮<br><br>[자격-M]: \\"제 모든 에너지를 출구 개방에 전념하겠습니다. 당신이라면 저 장벽을 해독해 낼 것입니다. 마지막 답을 입력하세요!\\"<br><br>[블랙-기어]: \\"안 돼... 내 제어권이... 소멸한다아아!\\"', 'qtext': '<strong>Q20. [최소공배수 활용 3]</strong><br>3, 4, 5 어느 수로 나누어도 2가 남는 가장 작은 세 자리 자연수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '암호 실패! 일식 예측 보고가 불가능합니다!', 'ans_check': "ans === '122'"}
]
