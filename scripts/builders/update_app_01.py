...
qs = [
    {'qnum': 1, "options": ["4", "6", "2", "8"], 'title': '공방 서랍 열기', 'story': """<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[블랙-기어]</span>: "크하하! 1442년의 역사적 일식은 영원히 암흑 속에 묻힐 것이다! 감히 장영실의 공방에서 시스템 복구를 꿈꾸다니 하찮은 지능이로군."<br><br><i>지이잉- 공방 구석의 낡은 놋쇠 자물쇠가 달린 서랍장이 푸른 레이저 장벽으로 격리되었습니다. 자물쇠 표면에는 '10 이하의 소수 개수'를 정렬하라는 보안 지시등이 깜빡입니다.</i><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[자격-M]</span>: "치직... 캡틴, 자격루 복구 시스템이 재부팅 중입니다! 우선 서랍을 열고 내부의 제어 레버를 확보해야 합니다!" """, 'qtext': '<strong>Q1. [소수와 합성수]</strong><br>10 이하의 자연수 중 소수는 모두 몇 개인가?', 'placeholder': '숫자 또는 개수 입력', 'error': '자물쇠가 굳게 닫혀 있습니다! 숫자를 다시 세어 보십시오.', 'ans_check': "ans === '4' || ans === '4개'"},
    {'qnum': 2, "options": ["82", "41", "43", "39"], 'title': '비밀 금고 수색', 'story': """<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[블랙-기어]</span>: "첫 단추를 꿴 것 정도로 자만하지 마라! 이 나무 금고는 아틀란티스의 지혜만큼이나 정교한 복합 격벽으로 잠겨 있으니!"<br><br><i>서랍이 열리자 톱니바퀴 소리와 함께 상패 형태의 고대 나무 금고가 천천히 솟아올랐습니다. 표면에 붉은 경고등이 켜지며 수백 개의 나노 다이얼이 회전하기 시작합니다.</i><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[자격-M]</span>: "캡틴! 15 이하의 모든 소수를 도출하여 그 합을 금고 다이얼에 입력해야 합니다! 서두르십시오!" """, 'qtext': '<strong>Q2. [소수의 합]</strong><br>15 이하의 소수의 합을 구하시오.', 'placeholder': '숫자만 입력', 'error': '금고에서 불길한 경고음이 납니다!', 'ans_check': "ans === '41'"},
    {'qnum': 3, "options": ["9", "15", "17", "21"], 'title': '벽면 문양 해독', 'story': """<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[블랙-기어]</span>: "역사의 톱니는 내 명령만을 따른다. 한지에 깃든 수의 부적을 판독할 수 있겠는가? 잘못 건드리는 순간 온몸이 먼지로 분해될 것이다!"<br><br><i>스산한 바람이 불며 벽면에 비스듬히 붙어 있는 한지 조각이 스파크를 일으키며 붉은색 글자로 변했습니다. 네 개의 숫자 중 합성수가 아닌 진짜 소수를 선택해야 합니다.</i><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[자격-M]</span>: "경고! 벽면의 레이저 핀이 캡틴의 자이로 센서를 조준하고 있습니다. 합성수가 아닌 숫자만을 골라 디코딩 링크를 완성하십시오!" """, 'qtext': '<strong>Q3. [합성수 판별]</strong><br>다음 중 합성수가 아닌 것은?<br>(1) 9 &nbsp;&nbsp;(2) 15 &nbsp;&nbsp;(3) 17 &nbsp;&nbsp;(4) 21', 'placeholder': '보기 번호 또는 숫자 입력', 'error': '벽에서 먼지가 떨어집니다! 잘못 선택했습니다.', 'ans_check': "ans === '3' || ans === '17' || ans === '(3)'"},
    {'qnum': 4, "options": ["4", "6", "8", "12"], 'title': '비밀 통로 개방', 'story': """<strong>[시스템 통신 장애 및 스파크 발생]</strong><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[자격-M]</span>: "치지직... 캡...틴... 제 목소리가 들리십니까? 블랙-기어의 악성 해킹 펄스가 동력 계통을 침식하고 있습니다! 가장 작은 소수와 가장 작은 합성수를 합산해 격벽 통신 프로토콜을 우회 전송해야 합니다! 빨리!"<br><br><i>쿠구구궁- 천장에서 흙먼지가 떨어지며 굳게 잠겨 있던 석문 틈새로 고압 전류가 흐르기 시작합니다.</i>""", 'qtext': '<strong>Q4. [소수와 합성수의 성질]</strong><br>가장 작은 소수와 가장 작은 합성수의 합을 구하시오.', 'placeholder': '숫자만 입력', 'error': '계단이 흔들립니다! 함정이 작동하기 전 정답을 입력하세요.', 'ans_check': "ans === '6'"},
    {'qnum': 5, "options": ["4", "2", "0", "10"], 'title': '수은 장치 활성화', 'story': """🚨 <strong>[격벽 압축 수은 압력 상승]</strong><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[자격-M]</span>: "치직... 제어 회로 복구율 45%...! 수은 시계의 압력 밸브가 과부하로 폭발하기 직전입니다! 20 이상 30 이하의 소수가 몇 개인지 구하여 안전 압축 상수로 주입해야 수은 역류를 막을 수 있습니다!"<br><br><i>조종반 유리창 너머로 끓어오르는 은빛 수은 액체가 붉은색 파이프를 타고 무섭게 치솟고 있습니다.</i>""", 'qtext': '<strong>Q5. [소수 찾기]</strong><br>20 이상 30 이하의 소수는 모두 몇 개인가?', 'placeholder': '숫자 또는 개수 입력', 'error': '수은이 역류하려고 합니다! 신속하게 개수를 맞추십시오.', 'ans_check': "ans === '2' || ans === '2개'"},
    {'qnum': 6, "options": ["4", "2", "0", "10"], 'title': '앙부일구 암호판', 'story': """<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[블랙-기어]</span>: "쥐새끼 같은 보조 인격이 잔머리를 굴리는구나! 앙부일구의 바늘을 구부려 일식의 태양 빛을 영원히 어둠 속으로 산란시켜 주마!"<br><br><i>치지직- 암실 중앙의 거대한 청동 앙부일구 영침(해시계 바늘)이 기괴한 소리를 내며 뒤틀리기 시작했습니다. 정밀 광선을 태양 각도에 맞추기 위해 영침 정렬 기어를 조작해야 합니다.</i><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[자격-M]</span>: "캡틴! 60을 소인수분해하여 나타나는 2의 지수 값을 동조 다이얼에 입력해야 뒤틀리는 영침을 올바른 각도로 고정할 수 있습니다!" """, 'qtext': '<strong>Q6. [지수 구하기]</strong><br>60을 소인수분해할 때, 2의 지수는 얼마인가?', 'placeholder': '숫자만 입력', 'error': '조준 실패! 그림자가 어긋납니다.', 'ans_check': "ans === '2'"},
    {'qnum': 7, "options": ["70", "72", "74", "144"], 'title': '앙부일구 암호판', 'story': """<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[블랙-기어]</span>: "빛의 굴절을 쫓아봤자 결코 일식의 비밀을 풀지 못할 것이다. 거듭제곱의 연산 굴절판을 무너뜨려라!"<br><br><i>파지직- 영침 끝에서 굴절된 눈부신 황동색 광선이 천장의 복잡한 렌즈 궤도로 투사되었습니다. 천장 거울을 회전시켜 빛을 중앙 제어 코어에 정밀하게 반사해야 합니다.</i><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[자격-M]</span>: "태양 고도 동력 식인 $2^3 \times 3^2$의 거듭제곱 연산값을 구해 회전 모터 출력창에 입력하십시오. 거울 각도가 정렬됩니다!" """, 'qtext': '<strong>Q7. [거듭제곱의 계산]</strong><br>$2^3 \times 3^2$ 의 값을 구하시오.', 'placeholder': '숫자만 입력', 'error': '거울 각도가 틀렸습니다! 빛이 소멸합니다.', 'ans_check': "ans === '72'"},
    {'qnum': 8, "options": ["8", "10", "20", "12"], 'title': '앙부일구 암호판', 'story': """<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[블랙-기어]</span>: "두 번째 거울까지 통과하다니 생각보다 집요하군. 하지만 180의 소인수들이 가로막은 다중 락(Lock)은 어림없다!"<br><br><i>위이잉- 두 번째 레이저 광선이 중앙 청동 제어판의 기하학 격자 락에 도달했습니다. 180의 소인수들의 결합 부호를 해독해 락을 분해해야 합니다.</i><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[자격-M]</span>: "캡틴! 180의 소인수를 모두 구하여 그 합을 락 해제 펄스로 방출하십시오! 거의 다 해제되어 갑니다!" """, 'qtext': '<strong>Q8. [소인수의 합]</strong><br>180의 소인수를 모두 더한 값을 구하시오.', 'placeholder': '숫자만 입력', 'error': '암호판이 잠겨 움직이지 않습니다!', 'ans_check': "ans === '10'"},
    {'qnum': 9, "options": ["14", "24", "10", "12"], 'title': '앙부일구 암호판', 'story': """<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[블랙-기어]</span>: "회전하는 기어가 모두 엉켜 박살 나도 상관없다! 맞물리는 톱니 수를 꼬아 파괴해 버리겠다!"<br><br><i>드르륵- 청동 암호판 이면의 기하학 톱니바퀴 기어들이 맞물리며 거친 마찰음과 연기를 뿜기 시작합니다. 72의 약수 개수만큼의 기어 이빨을 세어 동기화해야 멈춥니다.</i><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[자격-M]</span>: "비상! 톱니 기어 마모 한계 90%! 72의 약수 개수를 구해 톱니 제어 압력 상수로 주입해 정상 회전으로 돌려놓으십시오!" """, 'qtext': '<strong>Q9. [약수의 개수 1]</strong><br>72의 약수의 개수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '기어 맞물림 이상! 톱니 개수가 맞지 않습니다.', 'ans_check': "ans === '12'"},
    {'qnum': 10, "options": ["4", "2", "0", "10"], 'title': '앙부일구 암호판', 'story': """💥 <strong>[비상 로그: 강제 포맷 및 온도 급상승!]</strong> 💥<br><br><span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[블랙-기어]</span>: "더는 참을 수 없군! 모든 데이터를 강제로 초기화 시켜주지! 5분 뒤 모든 시스템을 포맷하겠다!"<br><br><i>삐- 삐- 붉은 경보 조명이 조종석 전체를 물들이며 연기가 피어오릅니다. 벽면 제어판의 수은이 끓어올라 기압계가 터지기 일보 직전입니다.</i><br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[자격-M]</span>: "캡틴! 시스템 온도가 한계치를 넘었습니다! 약수의 개수 15개를 타겟으로 삼는 미지수 $3^4 \times 5^a$의 지수 a 값을 찾아 입력하십시오! 제가 방화벽으로 폭발을 억제하겠습니다!" """, 'qtext': '<strong>Q10. [약수의 개수 2]</strong><br>$3^4 \times 5^a$ 의 약수의 개수가 15개일 때, a의 값을 구하시오.', 'placeholder': '숫자만 입력', 'error': '동기화 실패! 시간이 어긋납니다.', 'ans_check': "ans === '2'", "extra_class": "glitch-bg"},
    {'qnum': 11, 'title': '자격루 동력 복구', 'story': """<span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[자격-M]</span>: "방화벽 출력 한계 봉착! 캡틴, 코드를 끊임없이 주입해 폭발 압력을 우회해야 합니다!"<br><br><i>쿵-! 육중한 금속 음과 함께 지하 자격루 물통 제어용 압축 실린더 챔버가 바닥에서 개방되었습니다. 물을 정확한 압력으로 내보내기 위해 24와 36의 최대공약수 값으로 배출 밸브를 열어야 합니다.</i><br><br><span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[블랙-기어]</span>: "폭발을 늦춰봤자 결국 침몰할 뿐이다. 수압에 짓눌려 터져 보아라!" """, 'qtext': '<strong>Q11. [최대공약수]</strong><br>24와 36의 최대공약수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '수압 이상! 물통이 파열될 위험이 있습니다!', 'ans_check': "ans === '12'"},
    {'qnum': 12, 'title': '자격루 동력 복구', 'story': """<span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[자격-M]</span>: "휴, 수압은 안정되었으나 동력 전달 기어의 위상이 어긋나 격벽이 삐걱거립니다!"<br><br><i>콸콸콸- 수조의 물이 흐르면서 지하의 물레바퀴 톱니들이 격렬하게 요동칩니다. 동력 톱니바퀴 15와 25가 서로 헛돌지 않고 완전히 밀착하도록 최소공배수 속도로 위상을 매칭해야 합니다.</i><br><br><span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[블랙-기어]</span>: "기어가 맞물리지 않는 한, 시스템 동력은 0으로 떨어질 것이다. 발버둥 쳐 보아라!" """, 'qtext': '<strong>Q12. [최소공배수]</strong><br>15와 25의 최소공배수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '속도 불일치! 기어가 헛돕니다.', 'ans_check': "ans === '75'"},
    {'qnum': 13, 'title': '자격루 동력 복구', 'story': """<span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[자격-M]</span>: "엔진 회전율 80% 도달! 압축 피스톤의 평형을 수치로 조절해야 자격루가 다시 작동합니다!"<br><br><i>치익- 탁-! 압축 실린더 피스톤이 거친 증기를 내뿜으며 상하 수직 운동을 개시했습니다. 두 거듭제곱 수 $2^2 \times 3$ 과 $2 \times 3^2 \times 5$ 의 최대공약수 값을 도출해 수평 한계값에 맞추십시오!</i>""", 'qtext': '<strong>Q13. [거듭제곱의 최대공약수]</strong><br>두 수 $2^2 \times 3$, $2 \times 3^2 \times 5$ 의 최대공약수를 구하시오. (숫자로 환산)', 'placeholder': '숫자만 입력', 'error': '압축 피스톤 불균형! 진동이 커집니다.', 'ans_check': "ans === '6'"},
    {'qnum': 14, 'title': '자격루 동력 복구', 'story': """<span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[자격-M]</span>: "치직... 배수 파이프라인의 이물질로 압력이 역류하고 있습니다! 제어가 불가능합니다!"<br><br><i>쿠르릉- 자격루 배수로가 막혀 내부 수조 물바다가 조종석 바닥까지 차오르기 시작합니다. 12와 18의 공약수 개수만큼 고압 수압 펌프를 방출하여 관로를 뚫어야 합니다!</i>""", 'qtext': '<strong>Q14. [공약수의 개수]</strong><br>두 수 12, 18의 공약수의 개수는 모두 몇 개인가?', 'placeholder': '숫자 또는 개수 입력', 'error': '배수가 막혔습니다! 수조가 넘치려 합니다.', 'ans_check': "ans === '4' || ans === '4개'"},
    {'qnum': 15, 'title': '자격루 동력 복구', 'story': """✨ <strong><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[자격-M 시스템 권한 100% 완전 복구]</span></strong> ✨<br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[자격-M]</span>: "정답입니다 캡틴! 자격루 제어 권한이 완전히 복구되었습니다. 이제 블랙-기어의 바이러스를 밀어내겠습니다! 역습의 시간입니다!"<br><br><i>청동 콘솔의 수백 개 기계 장치들이 황금빛으로 밝아지며 동시에 돌아가기 시작합니다.</i><br><br><span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[블랙-기어]</span>: "내 코드가... 장영실의 기계 장치에 지배당하다니... 말도 안 돼! 최종 방벽으로 막아주마!" """, 'qtext': '<strong>Q15. [최소공배수의 성질]</strong><br>두 수의 곱이 300이고 최대공약수가 5일 때, 이 두 수의 최소공배수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '부력 균형 붕괴! 부표가 가라앉습니다.', 'ans_check': "ans === '60'", "extra_class": "glitch-bg"},
    {'qnum': 16, 'title': '일식 관측과 시간 톱니', 'story': """<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[블랙-기어]</span>: "이 서버가 무너져도 나갈 수 없다. 망원경을 돌려 태양을 관측하지 못하도록 황동 거울판을 조각조각 부셔놓으마!"<br><br><i>쿵! 일식 관측용 대형 혼천의 망원경을 조준하는 벽면 기하학 제어판이 부서지며 타일들이 쏟아져 내렸습니다. 가로 18, 세로 24의 벽면을 가장 큰 정사각형 황동판 타일로 빈틈없이 다시 복구해야만 렌즈가 열립니다!</i>""", 'qtext': '<strong>Q16. [최대공약수 활용]</strong><br>가로 18cm, 세로 24cm인 직사각형 벽을 가능한 큰 정사각형 타일로 빈틈없이 채우려 한다. 타일 한 변의 길이를 구하시오. (단위 생략)', 'placeholder': '숫자 또는 cm 입력', 'error': '타일 배치 실패! 벽면이 무너집니다.', 'ans_check': "ans === '6' || ans === '6cm'"},
    {'qnum': 17, 'title': '일식 관측과 시간 톱니', 'story': """<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[블랙-기어]</span>: "태양과 달이 만나는 찰나의 시간... 톱니바퀴의 속도를 제어하지 못하면 너희의 시간도 영원히 분산될 뿐이다!"<br><br><i>태엽 장치가 날카로운 마찰음을 내며 혼천의 궤도 반사 조절 거울을 제어하는 톱니바퀴 A, B가 비정상적으로 흔들리기 시작합니다. 톱니수가 각각 12개, 18개인 기어가 처음으로 다시 동일 지점에서 맞물려 고정되도록 기어 A의 필요 회전 바퀴 수를 도출해 락을 거십시오!</i>""", 'qtext': '<strong>Q17. [최소공배수 활용 1]</strong><br>톱니수가 각각 12개, 18개인 두 톱니바퀴 A, B가 맞물려 돌 때, 처음으로 다시 같은 톱니에서 맞물리려면 A는 몇 바퀴를 돌아야 하는가?', 'placeholder': '숫자 또는 바퀴 수 입력', 'error': '기어 스펙이 안 맞습니다! 회전이 멈춥니다.', 'ans_check': "ans === '3' || ans === '3바퀴'"},
    {'qnum': 18, 'title': '일식 관측과 시간 톱니', 'story': """<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[블랙-기어]</span>: "끝이 다가오는군. 하지만 마지막 나눗셈의 덫은 뚫지 못할 것이다. 눈이 멀어 타들어 가는 일식을 맞이해라!"<br><br><i>화아아아- 관측창 안으로 강렬한 태양 에너지가 유입되어 렌즈 튜브가 뜨겁게 달아오릅니다. 나눗셈 37을 나누면 1이 남고, 46을 나누면 2가 남는 최대 간격 상수를 조준 제어 콘솔에 전송해야만 필터 거울이 태양열을 차단합니다!</i>""", 'qtext': '<strong>Q18. [최대공약수 활용 2]</strong><br>어떤 수로 37을 나누면 1이 남고, 46을 나누면 2가 남는다. 이러한 수 중 가장 큰 수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '렌즈 초점이 맞지 않아 일식이 보이지 않습니다!', 'ans_check': "ans === '4'"},
    {'qnum': 19, 'title': '일식 관측과 시간 톱니', 'story': """<span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[블랙-기어]</span>: "일식의 장엄한 종말이 시작된다. 마지막 동기화 신호를 어긋나게 하겠다. 어서 계산해 보아라!"<br><br><i>일식의 시작을 궁궐에 알릴 기계 인형들의 대고(북) 연타 신호기가 거칠게 스파크를 튀기며 작동을 대기합니다. 10분, 15분 간격으로 동기화되어 움직이는 신호 종과 북이 오전 9시 정각 출발 이후 처음으로 완벽히 동시 타격을 시작할 '시간(분)'을 찾아 동기화 모듈에 입력하십시오!</i>""", 'qtext': '<strong>Q19. [최소공배수 활용 2]</strong><br>버스 A는 10분, 버스 B는 15분 간격으로 출발한다. 오전 9시에 동시에 출발했다면, 다음으로 처음 동시에 출발하는 시각은 9시 몇 분인가? (분만 입력)', 'placeholder': '숫자 또는 분 입력', 'error': '북 신호가 어긋나 백성들이 혼란에 빠집니다!', 'ans_check': "ans === '30' || ans === '30분'"},
    {'qnum': 20, 'title': '일식 관측과 시간 톱니', 'story': """🔮 <strong>[최종 방화벽 서버 락다운 해제]</strong> 🔮<br><br><span style="color: #60a5fa; text-shadow: 0 0 5px #3b82f6;">[자격-M]</span>: "캡틴! 이제 마지막 출구 포탈 방화벽 하나만 남았습니다! 제 동력 셀이 소모되기 전에 3, 4, 5로 나누어 항상 2가 남는 가장 작은 세 자리의 자연수 상수를 조준 콘솔에 입력하십시오! 이제 지상으로 나갈 시간입니다!"<br><br><span class="glitch-text" style="color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;">[블랙-기어]</span>: "이럴 수가... 내 핵심 차단벽이 완전히 정지당하다니... 안 돼어어어!" """, 'qtext': '<strong>Q20. [최소공배수 활용 3]</strong><br>3, 4, 5 어느 수로 나누어도 2가 남는 가장 작은 세 자리 자연수를 구하시오.', 'placeholder': '숫자만 입력', 'error': '암호 실패! 일식 예측 보고가 불가능합니다!', 'ans_check': "ans === '122'", "extra_class": "glitch-bg"}
]
