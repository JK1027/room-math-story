...
qs = [
    {'qnum': 1, 'title': '공방 서랍 열기', 'story': '<span class=\"glitch-text\" style=\"color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;\"><span class=\"glitch-text\" style=\"color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;\"><span class=\"glitch-text\" style=\"color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;\">[블랙-기어]</span></span></span>: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 🕰️ <strong>[공방 비밀 서랍]</strong><br><br>장영실의 공방 서랍장에 낡은 놋쇠 자물쇠가 걸려 있습니다. 10 이하의 소수 개수를 입력해야만 열릴 것 같습니다.\\"', 'qtext': '<strong>Q1. [소수와 합성수]</strong><br>10 이하의 자연수 중 소수는 모두 몇 개인가?', 'placeholder': '숫자 또는 개수 입력', 'error': '자물쇠가 굳게 닫혀 있습니다! 숫자를 다시 세어 보십시오.', 'ans_check': "ans === '4' || ans === '4개'"},
    {'qnum': 2, 'title': '비밀 금고 수색', 'story': '<span class=\"glitch-text\" style=\"color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;\"><span class=\"glitch-text\" style=\"color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;\"><span class=\"glitch-text\" style=\"color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;\">[블랙-기어]</span></span></span>: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 🕰️ <strong>[두 번째 상자]</strong><br><br>서랍을 열자 상패 형태의 나무 금고가 보입니다. 15 이하의 소수들을 모두 합한 값을 맞춰야만 덮개가 열립니다.\\"', 'qtext': '<strong>Q2. [소수의 합]</strong><br>15 이하의 소수의 합을 구하시오.', 'placeholder': '숫자만 입력', 'error': '금고에서 불길한 경고음이 납니다!', 'ans_check': "ans === '41'"},
    {'qnum': 3, 'title': '벽면 문양 해독', 'story': '<span class=\"glitch-text\" style=\"color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;\"><span class=\"glitch-text\" style=\"color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;\"><span class=\"glitch-text\" style=\"color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;\">[블랙-기어]</span></span></span>: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 🕰️ <strong>[벽면의 한지 조각]</strong><br><br>벽에 비스듬히 붙어 있는 한지에 네 개의 수가 적혀 있습니다. 합성수가 아닌 수를 골라 아래 받침대를 누르십시오.\\"', 'qtext': '<strong>Q3. [합성수 판별]</strong><br>다음 중 합성수가 아닌 것은?<br>(1) 9 &nbsp;&nbsp;(2) 15 &nbsp;&nbsp;(3) 17 &nbsp;&nbsp;(4) 21', 'placeholder': '보기 번호 또는 숫자 입력', 'error': '벽에서 먼지가 떨어집니다! 잘못 선택했습니다.', 'ans_check': "ans === '3' || ans === '17' || ans === '(3)'"},
    ...
    {'qnum': 6, 'title': '앙부일구 암호판', 'story': '<span class=\"glitch-text\" style=\"color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;\"><span class=\"glitch-text\" style=\"color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;\"><span class=\"glitch-text\" style=\"color: #ef4444; font-weight: bold; text-shadow: 0 0 5px #ef4444;\">[블랙-기어]</span></span></span>: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 🔐 <strong>[영침 정렬]</strong><br><br>암실 중앙에 빛나는 앙부일구(해시계) 영침 제어판이 드러납니다. 60의 소인수분해 값에서 2의 지수만큼 영침을 틀어야 조준이 맞습니다.\\"', 'qtext': '<strong>Q6. [지수 구하기]</strong><br>60을 소인수분해할 때, 2의 지수는 얼마인가?', 'placeholder': '숫자만 입력', 'error': '조준 실패! 그림자가 어긋납니다.', 'ans_check': "ans === '2'"},
