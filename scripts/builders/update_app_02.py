...
qs = [
    ...
    {'qnum': 2, "options": ["-3", "0", "1.5", "7"], 'title': '정수의 조건', 'story': '[보이드-마스터]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 🔮 <strong>[마법 스크롤 선별]</strong><br><br>다양한 수가 적힌 종이 중 정수가 아닌 속성을 골라내어 마법진에서 소거해야 문이 열립니다.\\"', 'qtext': '<strong>Q2. [정수의 판별]</strong><br>다음 중 정수가 아닌 것의 번호를 쓰시오.<br>(1) -3 &nbsp;&nbsp;(2) 0 &nbsp;&nbsp;(3) 1.5 &nbsp;&nbsp;(4) 7', 'placeholder': '보기 번호 입력', 'error': '스파크가 튑니다! 정수가 아닌 수를 다시 골라 보십시오.', 'ans_check': "ans === '3' || ans === '1.5' || ans === '(3)'"},
    {'qnum': 3, "options": ["원점", "y축", "x축", "좌표평면"], 'title': '수직선의 기점', 'story': '[보이드-마스터]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 🔮 <strong>[마력 수직선의 기점]</strong><br><br>공중에 투사된 마력선 위의 눈금 0을 가리키는 한글 단어를 묻는 단어 퀴즈 자물쇠입니다.\\"', 'qtext': '<strong>Q3. [원점]</strong><br>수직선에서 0을 나타내는 점을 무엇이라 하는가?', 'placeholder': '한글 단어 입력', 'error': '수직선 기점이 정렬되지 않습니다!', 'ans_check': "ans === '원점'"},
    {'qnum': 4, "options": ["5", "14", "7", "9"], 'title': '정수의 개수', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[그리무어-G]</span></span></span>: \\"치지직... 들리십니까...? 보이드-마스터의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q4. [두 수 사이의 정수]</strong><br>-5와 3 사이에 있는 정수는 모두 몇 개인가?', 'placeholder': '숫자 또는 개수 입력', 'error': '수치가 맞지 않아 문이 닫힙니다!', 'ans_check': "ans === '7' || ans === '7개'"},
    {'qnum': 5, "options": ["10", "3", "7", "5"], 'title': '속성 에너지 융합', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\"><span style=\"color: #60a5fa; text-shadow: 0 0 5px #3b82f6;\">[그리무어-G]</span></span></span>: \\"치지직... 들리십니까...? 보이드-마스터의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q5. [수직선 위의 점]</strong><br>두 정수 a, b에 대하여 a는 원점으로부터의 거리가 4이고, b는 -2보다 3만큼 큰 수이다. a가 양수일 때 a+b의 값을 구하시오.', 'placeholder': '숫자만 입력', 'error': '융합 실패! 에너지 폭발 조짐이 보입니다.', 'ans_check': "ans === '5'"},
    {'qnum': 6, "options": ["8", "10", "20", "12"], 'title': '마법 절댓값 장벽', 'story': '[보이드-마스터]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 📜 <strong>[절댓값 연산 장벽]</strong><br><br>두 수의 절댓값 합을 맞춰야만 계단을 막고 있는 마법 보라색 장벽이 걷힙니다.\\"', 'qtext': '<strong>Q6. [절댓값 계산]</strong><br>|-7| + |3| 의 값을 구하시오.', 'placeholder': '숫자만 입력', 'error': '장벽의 절댓값이 꿈쩍도 하지 않습니다!', 'ans_check': "ans === '10'"},
    {'qnum': 7, "options": ["16", "6", "8", "10"], 'title': '상반되는 속성의 거리', 'story': '[보이드-마스터]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 📜 <strong>[최대 거리 추출]</strong><br><br>절댓값이 4인 두 상반된 지점 사이의 실제 물리적 거리를 계산하여 동력선에 입력하십시오.\\"', 'qtext': '<strong>Q7. [절댓값의 성질]</strong><br>절댓값이 4인 두 수의 차를 구하시오. (큰 수에서 작은 수를 뺌)', 'placeholder': '숫자만 입력', 'error': '수치 동조 실패! 축의 거리가 맞지 않습니다.', 'ans_check': "ans === '8'"},
    {'qnum': 8, "options": ["-8", "-6", "-4", "-2"], 'title': '최강의 절댓값 보석', 'story': '[보이드-마스터]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 📜 <strong>[크기 비교 홀로그램]</strong><br><br>나열된 다섯 개의 오라클 마력석 중 절댓값 힘이 가장 거대한 원석을 제단에 올리십시오.\\"', 'qtext': '<strong>Q8. [절댓값의 대소]</strong><br>다음 수 중 절댓값이 가장 큰 수를 쓰시오.<br>[-2.5, 3, -4, 0, 1.5]', 'placeholder': '해당 수 입력 (부호 포함)', 'error': '제단이 보석을 밀어냅니다!', 'ans_check': "ans === '-4'"},
    {'qnum': 9, "options": ["10", "3", "7", "5"], 'title': '부등식과 영역', 'story': '[보이드-마스터]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 📜 <strong>[영역 격리 밸브]</strong><br><br>조건식 -3 < x <= 2 에 속하는 모든 정수 마나 노드의 개수를 찾아 밸브 압력을 맞추세요.\\"', 'qtext': '<strong>Q9. [부등호의 이해]</strong><br>-3 < x <= 2 를 만족하는 정수 x의 개수를 구하시오.', 'placeholder': '숫자 또는 개수 입력', 'error': '압력이 새어나갑니다! 다시 계산하십시오.', 'ans_check': "ans === '5' || ans === '5개'"},
