...
qs = [
    {'qnum': 1, 'title': '스테이지 1', 'story': '[괴도-루팡]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 단서를 찾아 문제를 해결하세요.\\"', 'qtext': '<strong>Q1.</strong> 방정식 $2x + y - 5 = 0$ 은 미지수가 몇 개인 일차방정식인가?', 'placeholder': '정답 입력', 'error': '틀렸습니다. 다시 시도해보세요.', 'ans_check': "ans === '2개'"},
    {'qnum': 2, 'title': '스테이지 2', 'story': '[괴도-루팡]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 단서를 찾아 문제를 해결하세요.\\"', 'qtext': '<strong>Q2.</strong> 다음 중 미지수가 2개인 일차방정식은? (1) $x + 2 = 3$ (2) $x + y = 5$ (3) $x^2 + y = 1$', 'placeholder': '정답 입력', 'error': '틀렸습니다. 다시 시도해보세요.', 'ans_check': "ans === '2'"},
    {'qnum': 3, 'title': '스테이지 3', 'story': '[괴도-루팡]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 단서를 찾아 문제를 해결하세요.\\"', 'qtext': '<strong>Q3.</strong> $x, y$가 자연수일 때, $x + y = 3$ 을 만족하는 순서쌍 $(x, y)$를 모두 구하시오.', 'placeholder': '정답 입력', 'error': '틀렸습니다. 다시 시도해보세요.', 'ans_check': "ans === '1'"},
    {'qnum': 4, 'title': '스테이지 4', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[가드-X]: \\"치지직... 들리십니까...? 괴도-루팡의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q4.</strong> $x, y$가 자연수일 때, $2x + y = 5$ 를 만족하는 순서쌍 $(x, y)$의 개수는 몇 개인가?', 'placeholder': '정답 입력', 'error': '틀렸습니다. 다시 시도해보세요.', 'ans_check': "ans === '2개'"},
    {'qnum': 5, 'title': '스테이지 5', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[가드-X]: \\"치지직... 들리십니까...? 괴도-루팡의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q5.</strong> $x=1, y=2$ 가 방정식 $3x - ay = -1$ 의 해일 때, 상수 $a$의 값을 구하시오.', 'placeholder': '정답 입력', 'error': '틀렸습니다. 다시 시도해보세요.', 'ans_check': "ans === '2'"},
    {'qnum': 6, 'title': '스테이지 6', 'story': '[괴도-루팡]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 단서를 찾아 문제를 해결하세요.\\"', 'qtext': '<strong>Q6.</strong> 두 일차방정식을 한 쌍으로 묶어 놓은 것을 무엇이라 하는가?', 'placeholder': '정답 입력', 'error': '틀렸습니다. 다시 시도해보세요.', 'ans_check': "ans === '연립일차방정식'"},
