...
qs = [
    {'qnum': 1, "options": ["2개", "2개 아님", "알 수 없음", "해 없음"], 'title': '스테이지 1', 'story': '[괴도-루팡]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 단서를 찾아 문제를 해결하세요.\\"', 'qtext': '<strong>Q1.</strong> 방정식 $2x + y - 5 = 0$ 은 미지수가 몇 개인 일차방정식인가?', 'placeholder': '정답 입력', 'error': '틀렸습니다. 다시 시도해보세요.', 'ans_check': "ans === '2개'"},
    {'qnum': 2, "options": ["$x", "$x^2"], 'title': '스테이지 2', 'story': '[괴도-루팡]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 단서를 찾아 문제를 해결하세요.\\"', 'qtext': '<strong>Q2.</strong> 다음 중 미지수가 2개인 일차방정식은? (1) $x + 2 = 3$ (2) $x + y = 5$ (3) $x^2 + y = 1$', 'placeholder': '정답 입력', 'error': '틀렸습니다. 다시 시도해보세요.', 'ans_check': "ans === '2'"},
    {'qnum': 3, "options": ["-1", "1", "3", "2"], 'title': '스테이지 3', 'story': '[괴도-루팡]: \\"크하하! 이 시스템은 나의 지배하에 있다! 감히 보안 구역을 돌파하겠다고? 단서를 찾아 문제를 해결하세요.\\"', 'qtext': '<strong>Q3.</strong> $x, y$가 자연수일 때, $x + y = 3$ 을 만족하는 순서쌍 $(x, y)$를 모두 구하시오.', 'placeholder': '정답 입력', 'error': '틀렸습니다. 다시 시도해보세요.', 'ans_check': "ans === '1'"},
    {'qnum': 4, "options": ["2개", "2개 아님", "알 수 없음", "해 없음"], 'title': '스테이지 4', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[가드-X]: \\"치지직... 들리십니까...? 괴도-루팡의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q4.</strong> $x, y$가 자연수일 때, $2x + y = 5$ 를 만족하는 순서쌍 $(x, y)$의 개수는 몇 개인가?', 'placeholder': '정답 입력', 'error': '틀렸습니다. 다시 시도해보세요.', 'ans_check': "ans === '2개'"},
    {'qnum': 5, "options": ["4", "2", "0", "10"], 'title': '스테이지 5', 'story': '<strong>[시스템 통신 장애 발생]</strong><br><br>[가드-X]: \\"치지직... 들리십니까...? 괴도-루팡의 코드를 무력화하기 위해 계산값을 전송해야 합니다...\\"', 'qtext': '<strong>Q5.</strong> $x=1, y=2$ 가 방정식 $3x - ay = -1$ 의 해일 때, 상수 $a$의 값을 구하시오.', 'placeholder': '정답 입력', 'error': '틀렸습니다. 다시 시도해보세요.', 'ans_check': "ans === '2'"},
    {'qnum': 6, "options": ["연립일차방정식", "연립일차방정식 아님", "알 수 없음", "해 없음"], 'title': '스테이지 6', 'story': '[괴도-루팡]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 단서를 찾아 문제를 해결하세요.\\"', 'qtext': '<strong>Q6.</strong> 두 일차방정식을 한 쌍으로 묶어 놓은 것을 무엇이라 하는가?', 'placeholder': '정답 입력', 'error': '틀렸습니다. 다시 시도해보세요.', 'ans_check': "ans === '연립일차방정식'"},
    {'qnum': 7, "options": ["4", "2", "0", "10"], 'title': '스테이지 7', 'story': '[괴도-루팡]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 단서를 찾아 문제를 해결하세요.\\"', 'qtext': '<strong>Q7.</strong> $(x=2, y=1)$ 이 연립방정식 $\x08egin{cases} x+y=3 \\ ax-y=3 \\end{cases}$ 의 해일 때, $a$의 값을 구하시오.', 'placeholder': '정답 입력', 'error': '틀렸습니다. 다시 시도해보세요.', 'ans_check': "ans === '2'"},
    {'qnum': 8, "options": ["6", "1", "3", "5"], 'title': '스테이지 8', 'story': '[괴도-루팡]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 단서를 찾아 문제를 해결하세요.\\"', 'qtext': '<strong>Q8.</strong> $\x08egin{cases} x+y=5 \\ x-y=1 \\end{cases}$ 의 해를 직관적으로 구해보시오. (순서쌍으로)', 'placeholder': '정답 입력', 'error': '틀렸습니다. 다시 시도해보세요.', 'ans_check': "ans === '3'"},
    {'qnum': 9, "options": ["교점", "교점 아님", "알 수 없음", "해 없음"], 'title': '스테이지 9', 'story': '[괴도-루팡]: \\"쥐새끼 같은 보조 인격이 끼어들었군! 쓸데없는 발악은 그만둬라! 단서를 찾아 문제를 해결하세요.\\"', 'qtext': '<strong>Q9.</strong> 연립방정식의 해는 두 일차방정식의 그래프가 만나는 ( ? )의 좌표와 같다. ?에 들어갈 말은? (힌트: 두 직선이 만나는 점)', 'placeholder': '정답 입력', 'error': '틀렸습니다. 다시 시도해보세요.', 'ans_check': "ans === '교점'"},
    {'qnum': 10, "options": ["대입법", "대입법 아님", "알 수 없음", "해 없음"], 'title': '스테이지 10', 'story': '🚨 <strong>[비상 경보: 강제 자폭 시스템 작동]</strong> 🚨<br><br>[괴도-루팡]: \\"더는 참을 수 없군! 모든 데이터를 시스템을 포맷하겠다! 5분 내로 전부 초기화 시켜주지!\\"<br><br>[가드-X]: \\"경고! 시스템 온도 상승 중! 제가 방화벽을 전개할 동안 긴급 수치 입력을 끝내십시오!\\"', 'qtext': '<strong>Q10.</strong> 연립방정식을 풀 때 한 방정식을 다른 방정식에 대입하여 미지수를 없애는 방법을 무엇이라 하는가?', 'placeholder': '정답 입력', 'error': '틀렸습니다. 다시 시도해보세요.', 'ans_check': "ans === '대입법'", "extra_class": "glitch-bg"},
    ...
    {'qnum': 20, 'title': '스테이지 20', 'story': '🔮 <strong>[최종 방화벽 락다운 해제]</strong> 🔮<br><br>[가드-X]: \\"제 모든 에너지를 출구 개방에 전념하겠습니다. 당신이라면 저 장벽을 해독해 낼 것입니다. 마지막 답을 입력하세요!\\"<br><br>[괴도-루팡]: \\"안 돼... 내 제어권이... 정지한다아아!\\"', 'qtext': '<strong>Q20.</strong> 현재 아버지와 아들의 나이의 합은 50세이고, 5년 후에는 아버지의 나이가 아들의 나이의 3배가 된다. 현재 아들의 나이를 구하시오.', 'placeholder': '정답 입력', 'error': '틀렸습니다. 다시 시도해보세요.', 'ans_check': "ans === '10세'", "extra_class": "glitch-bg"}
]
